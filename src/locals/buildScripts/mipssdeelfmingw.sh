...
echo "----------------# task [1/4] /i686-pc-linux-gnu/toolchain/jz/extend_0/copy\n"
pushenv
prepend_path PATH $WORKPATH/install/bin
...
echo "----------------# task [2/4] /i686-pc-linux-gnu/toolchain/jz/extend_0/install\n"
pushenv
prepend_path PATH $WORKPATH/install/bin
...
echo "----------------# task [3/4] /i686-pc-linux-gnu/toolchain/jz/extend_1/copy\n"
pushenv
prepend_path PATH $WORKPATH/install/bin
...
echo "----------------# task [4/4] /i686-pc-linux-gnu/toolchain/jz/extend_1/install\n"
pushenv
prepend_path PATH $WORKPATH/install/bin
...
echo "----------------# task [124/209] /i586-mingw32msvc/host_cleanup\n"
pushenv
pushenvvar CC_FOR_BUILD gcc
pushenvvar CXX_FOR_BUILD g++
pushenvvar CC i586-mingw32msvc-gcc
pushenvvar CXX i586-mingw32msvc-g++
pushenvvar AR i586-mingw32msvc-ar
pushenvvar RANLIB i586-mingw32msvc-ranlib
prepend_path PATH $WORKPATH/obj/tools-i686-pc-linux-gnu-2012.09-98-mips-sde-elf-i586-mingw32msvc/bin
popenv

echo "----------------# task [125/209] /i586-mingw32msvc/host_unpack\n"
pushenv
pushenvvar CC_FOR_BUILD gcc
pushenvvar CXX_FOR_BUILD g++
pushenvvar CC i586-mingw32msvc-gcc
...
pushenvvar RANLIB i586-mingw32msvc-ranlib
prepend_path PATH $WORKPATH/obj/tools-i686-pc-linux-gnu-2012.09-98-mips-sde-elf-i586-mingw32msvc/bin
rm -rf $WORKPATH/obj/tools-i686-pc-linux-gnu-2012.09-98-mips-sde-elf-i586-mingw32msvc
mkdir $WORKPATH/obj/tools-i686-pc-linux-gnu-2012.09-98-mips-sde-elf-i586-mingw32msvc
pushd $WORKPATH/obj/tools-i686-pc-linux-gnu-2012.09-98-mips-sde-elf-i586-mingw32msvc
ln -s . mips-2012.09
tar xf $WORKPATH/pkg/mips-2012.09-98-mips-sde-elf-i686-pc-linux-gnu.tar.bz2 --bzip2
rm mips-2012.09
popd
popenv

if [ "" == "x" ];then # Don't compile
echo "----------------# task [126/209] /i586-mingw32msvc/libiconv/0/configure\n"
pushenv
pushenvvar CC_FOR_BUILD gcc
pushenvvar CXX_FOR_BUILD g++
pushenvvar CC i586-mingw32msvc-gcc
...
pushenv
pushenv
rm -rf $WORKPATH/obj/libiconv-2012.09-98-mips-sde-elf-i586-mingw32msvc
mkdir -p $WORKPATH/obj/libiconv-2012.09-98-mips-sde-elf-i586-mingw32msvc
pushd $WORKPATH/obj/libiconv-2012.09-98-mips-sde-elf-i586-mingw32msvc
check_mentor_trademarks $WORKPATH/src/libiconv-1.11 --prefix=$WORKPATH/obj/pkg-2012.09-98-mips-sde-elf/mips-2012.09-98-mips-sde-elf.extras/host-libs-i586-mingw32msvc/usr --disable-shared --build=i686-pc-linux-gnu --target=mips-sde-elf --host=i586-mingw32msvc --disable-nls
popd
popenv
popenv
popenv

echo "----------------# task [127/209] /i586-mingw32msvc/libiconv/0/build\n"
pushenv
pushenvvar CC_FOR_BUILD gcc
pushenvvar CXX_FOR_BUILD g++
pushenvvar CC i586-mingw32msvc-gcc
...
echo "----------------# task [128/209] /i586-mingw32msvc/libiconv/0/install\n"
pushenv
pushenvvar CC_FOR_BUILD gcc
pushenvvar CXX_FOR_BUILD g++
pushenvvar CC i586-mingw32msvc-gcc
...
echo "----------------# task [129/209] /i586-mingw32msvc/make/copy\n"
pushenv
pushenvvar CC_FOR_BUILD gcc
pushenvvar CXX_FOR_BUILD g++
pushenvvar CC i586-mingw32msvc-gcc
...
pushenv
pushenv
rm -rf $WORKPATH/obj/make-src-2012.09-98-mips-sde-elf-i586-mingw32msvc
copy_dir_clean $WORKPATH/src/make-3.81 $WORKPATH/obj/make-src-2012.09-98-mips-sde-elf-i586-mingw32msvc
chmod -R u+w $WORKPATH/obj/make-src-2012.09-98-mips-sde-elf-i586-mingw32msvc
touch $WORKPATH/obj/make-src-2012.09-98-mips-sde-elf-i586-mingw32msvc/.gnu-stamp
popenv
popenv
popenv

echo "----------------# task [130/209] /i586-mingw32msvc/make/configure\n"
pushenv
pushenvvar CC_FOR_BUILD gcc
pushenvvar CXX_FOR_BUILD g++
pushenvvar CC i586-mingw32msvc-gcc
...
pushenv
pushenv
rm -rf $WORKPATH/obj/make-2012.09-98-mips-sde-elf-i586-mingw32msvc
mkdir -p $WORKPATH/obj/make-2012.09-98-mips-sde-elf-i586-mingw32msvc
pushd $WORKPATH/obj/make-2012.09-98-mips-sde-elf-i586-mingw32msvc
check_mentor_trademarks $WORKPATH/obj/make-src-2012.09-98-mips-sde-elf-i586-mingw32msvc --prefix=$WORKPATH/install --build=i686-pc-linux-gnu --target=mips-sde-elf --host=i586-mingw32msvc '--with-pkgversion=Ingenic 2015.02' --disable-nls --program-prefix=cs-
popd
popenv
popenv
popenv

echo "----------------# task [131/209] /i586-mingw32msvc/make/build\n"
pushenv
pushenvvar CC_FOR_BUILD gcc
pushenvvar CXX_FOR_BUILD g++
pushenvvar CC i586-mingw32msvc-gcc
...
echo "----------------# task [132/209] /i586-mingw32msvc/make/install\n"
pushenv
pushenvvar CC_FOR_BUILD gcc
pushenvvar CXX_FOR_BUILD g++
pushenvvar CC i586-mingw32msvc-gcc
...
pushenv
pushd $WORKPATH/obj/make-2012.09-98-mips-sde-elf-i586-mingw32msvc
make install prefix=$WORKPATH/install/host-i586-mingw32msvc exec_prefix=$WORKPATH/install/host-i586-mingw32msvc libdir=$WORKPATH/install/host-i586-mingw32msvc/lib htmldir=$WORKPATH/install/host-i586-mingw32msvc/share/doc/mips-mips-sde-elf/html pdfdir=$WORKPATH/install/host-i586-mingw32msvc/share/doc/mips-mips-sde-elf/pdf infodir=$WORKPATH/install/host-i586-mingw32msvc/share/doc/mips-mips-sde-elf/info mandir=$WORKPATH/install/host-i586-mingw32msvc/share/doc/mips-mips-sde-elf/man datadir=$WORKPATH/install/host-i586-mingw32msvc/share
popd
popenv
popenv
popenv

echo "----------------# task [133/209] /i586-mingw32msvc/coreutils/copy\n"
pushenv
pushenvvar CC_FOR_BUILD gcc
pushenvvar CXX_FOR_BUILD g++
pushenvvar CC i586-mingw32msvc-gcc
...
pushenv
pushenv
rm -rf $WORKPATH/obj/coreutils-src-2012.09-98-mips-sde-elf-i586-mingw32msvc
copy_dir_clean $WORKPATH/src/coreutils-5.94 $WORKPATH/obj/coreutils-src-2012.09-98-mips-sde-elf-i586-mingw32msvc
chmod -R u+w $WORKPATH/obj/coreutils-src-2012.09-98-mips-sde-elf-i586-mingw32msvc
touch $WORKPATH/obj/coreutils-src-2012.09-98-mips-sde-elf-i586-mingw32msvc/.gnu-stamp
popenv
popenv
popenv

echo "----------------# task [134/209] /i586-mingw32msvc/coreutils/configure\n"
pushenv
pushenvvar CC_FOR_BUILD gcc
pushenvvar CXX_FOR_BUILD g++
pushenvvar CC i586-mingw32msvc-gcc
...
pushenv
pushenv
rm -rf $WORKPATH/obj/coreutils-2012.09-98-mips-sde-elf-i586-mingw32msvc
mkdir -p $WORKPATH/obj/coreutils-2012.09-98-mips-sde-elf-i586-mingw32msvc
pushd $WORKPATH/obj/coreutils-2012.09-98-mips-sde-elf-i586-mingw32msvc
check_mentor_trademarks $WORKPATH/obj/coreutils-src-2012.09-98-mips-sde-elf-i586-mingw32msvc --prefix=$WORKPATH/install --build=i686-pc-linux-gnu --target=mips-sde-elf --host=i586-mingw32msvc '--with-pkgversion=Ingenic 2015.02' --disable-nls --program-prefix=cs-
popd
popenv
popenv
popenv

echo "----------------# task [135/209] /i586-mingw32msvc/coreutils/build\n"
pushenv
pushenvvar CC_FOR_BUILD gcc
pushenvvar CXX_FOR_BUILD g++
pushenvvar CC i586-mingw32msvc-gcc
...
echo "----------------# task [136/209] /i586-mingw32msvc/coreutils/install\n"
pushenv
pushenvvar CC_FOR_BUILD gcc
pushenvvar CXX_FOR_BUILD g++
pushenvvar CC i586-mingw32msvc-gcc
...
echo "----------------# task [137/209] /i586-mingw32msvc/zlib_first/copy\n"
pushenv
pushenvvar CC_FOR_BUILD gcc
pushenvvar CXX_FOR_BUILD g++
pushenvvar CC i586-mingw32msvc-gcc
...
pushenvvar RANLIB i586-mingw32msvc-ranlib
prepend_path PATH $WORKPATH/obj/tools-i686-pc-linux-gnu-2012.09-98-mips-sde-elf-i586-mingw32msvc/bin
rm -rf $WORKPATH/obj/zlib-first-2012.09-98-mips-sde-elf-i586-mingw32msvc
copy_dir_clean $WORKPATH/src/zlib-1.2.7 $WORKPATH/obj/zlib-first-2012.09-98-mips-sde-elf-i586-mingw32msvc
chmod -R u+w $WORKPATH/obj/zlib-first-2012.09-98-mips-sde-elf-i586-mingw32msvc
popenv

echo "----------------# task [138/209] /i586-mingw32msvc/zlib_first/configure\n"
pushenv
pushenvvar CC_FOR_BUILD gcc
pushenvvar CXX_FOR_BUILD g++
pushenvvar CC i586-mingw32msvc-gcc
...
pushenvvar RANLIB i586-mingw32msvc-ranlib
prepend_path PATH $WORKPATH/obj/tools-i686-pc-linux-gnu-2012.09-98-mips-sde-elf-i586-mingw32msvc/bin
pushd $WORKPATH/obj/zlib-first-2012.09-98-mips-sde-elf-i586-mingw32msvc
pushenv
pushenvvar CFLAGS '-O3 -fPIC'
pushenvvar CC 'i586-mingw32msvc-gcc '
pushenvvar AR i586-mingw32msvc-ar
pushenvvar RANLIB i586-mingw32msvc-ranlib
./configure --prefix=$WORKPATH/obj/pkg-2012.09-98-mips-sde-elf/mips-2012.09-98-mips-sde-elf.extras/host-libs-i586-mingw32msvc/usr --static
popenv
popd
popenv

echo "----------------# task [139/209] /i586-mingw32msvc/zlib_first/build\n"
pushenv
pushenvvar CC_FOR_BUILD gcc
pushenvvar CXX_FOR_BUILD g++
pushenvvar CC i586-mingw32msvc-gcc
...
echo "----------------# task [140/209] /i586-mingw32msvc/zlib_first/install\n"
pushenv
pushenvvar CC_FOR_BUILD gcc
pushenvvar CXX_FOR_BUILD g++
pushenvvar CC i586-mingw32msvc-gcc
...
echo "----------------# task [141/209] /i586-mingw32msvc/gmp/configure\n"
pushenv
pushenvvar CC_FOR_BUILD gcc
pushenvvar CXX_FOR_BUILD g++
pushenvvar CC i586-mingw32msvc-gcc
...
pushenv
pushenvvar CFLAGS '-g -O2'
rm -rf $WORKPATH/obj/gmp-2012.09-98-mips-sde-elf-i586-mingw32msvc
mkdir -p $WORKPATH/obj/gmp-2012.09-98-mips-sde-elf-i586-mingw32msvc
pushd $WORKPATH/obj/gmp-2012.09-98-mips-sde-elf-i586-mingw32msvc
check_mentor_trademarks $WORKPATH/src/gmp-2012.09 --prefix=$WORKPATH/obj/pkg-2012.09-98-mips-sde-elf/mips-2012.09-98-mips-sde-elf.extras/host-libs-i586-mingw32msvc/usr --disable-shared --build=i686-pc-linux-gnu --target=i586-mingw32msvc --host=i586-mingw32msvc --enable-cxx --disable-nls
popd
popenv
popenv
popenv

echo "----------------# task [142/209] /i586-mingw32msvc/gmp/build\n"
pushenv
pushenvvar CC_FOR_BUILD gcc
pushenvvar CXX_FOR_BUILD g++
pushenvvar CC i586-mingw32msvc-gcc
...
echo "----------------# task [143/209] /i586-mingw32msvc/gmp/install\n"
pushenv
pushenvvar CC_FOR_BUILD gcc
pushenvvar CXX_FOR_BUILD g++
pushenvvar CC i586-mingw32msvc-gcc
...
echo "----------------# task [144/209] /i586-mingw32msvc/gmp/postinstall\n"
pushenv
pushenvvar CC_FOR_BUILD gcc
pushenvvar CXX_FOR_BUILD g++
pushenvvar CC i586-mingw32msvc-gcc
...
echo "----------------# task [145/209] /i586-mingw32msvc/mpfr/configure\n"
pushenv
pushenvvar CC_FOR_BUILD gcc
pushenvvar CXX_FOR_BUILD g++
pushenvvar CC i586-mingw32msvc-gcc
...
pushenv
pushenv
rm -rf $WORKPATH/obj/mpfr-2012.09-98-mips-sde-elf-i586-mingw32msvc
mkdir -p $WORKPATH/obj/mpfr-2012.09-98-mips-sde-elf-i586-mingw32msvc
pushd $WORKPATH/obj/mpfr-2012.09-98-mips-sde-elf-i586-mingw32msvc
check_mentor_trademarks $WORKPATH/src/mpfr-2012.09 --prefix=$WORKPATH/obj/pkg-2012.09-98-mips-sde-elf/mips-2012.09-98-mips-sde-elf.extras/host-libs-i586-mingw32msvc/usr --disable-shared --build=i686-pc-linux-gnu --target=mips-sde-elf --host=i586-mingw32msvc --disable-nls --with-gmp=$WORKPATH/obj/pkg-2012.09-98-mips-sde-elf/mips-2012.09-98-mips-sde-elf.extras/host-libs-i586-mingw32msvc/usr
popd
popenv
popenv
popenv

echo "----------------# task [146/209] /i586-mingw32msvc/mpfr/build\n"
pushenv
pushenvvar CC_FOR_BUILD gcc
pushenvvar CXX_FOR_BUILD g++
pushenvvar CC i586-mingw32msvc-gcc
...
echo "----------------# task [147/209] /i586-mingw32msvc/mpfr/install\n"
pushenv
pushenvvar CC_FOR_BUILD gcc
pushenvvar CXX_FOR_BUILD g++
pushenvvar CC i586-mingw32msvc-gcc
...
echo "----------------# task [148/209] /i586-mingw32msvc/mpfr/postinstall\n"
pushenv
pushenvvar CC_FOR_BUILD gcc
pushenvvar CXX_FOR_BUILD g++
pushenvvar CC i586-mingw32msvc-gcc
...
echo "----------------# task [149/209] /i586-mingw32msvc/mpc/configure\n"
pushenv
pushenvvar CC_FOR_BUILD gcc
pushenvvar CXX_FOR_BUILD g++
pushenvvar CC i586-mingw32msvc-gcc
...
pushenv
pushenv
rm -rf $WORKPATH/obj/mpc-2012.09-98-mips-sde-elf-i586-mingw32msvc
mkdir -p $WORKPATH/obj/mpc-2012.09-98-mips-sde-elf-i586-mingw32msvc
pushd $WORKPATH/obj/mpc-2012.09-98-mips-sde-elf-i586-mingw32msvc
check_mentor_trademarks $WORKPATH/src/mpc-2012.09 --prefix=$WORKPATH/obj/pkg-2012.09-98-mips-sde-elf/mips-2012.09-98-mips-sde-elf.extras/host-libs-i586-mingw32msvc/usr --disable-shared --build=i686-pc-linux-gnu --target=mips-sde-elf --host=i586-mingw32msvc --disable-nls --with-gmp=$WORKPATH/obj/pkg-2012.09-98-mips-sde-elf/mips-2012.09-98-mips-sde-elf.extras/host-libs-i586-mingw32msvc/usr --with-mpfr=$WORKPATH/obj/pkg-2012.09-98-mips-sde-elf/mips-2012.09-98-mips-sde-elf.extras/host-libs-i586-mingw32msvc/usr
popd
popenv
popenv
popenv

echo "----------------# task [150/209] /i586-mingw32msvc/mpc/build\n"
pushenv
pushenvvar CC_FOR_BUILD gcc
pushenvvar CXX_FOR_BUILD g++
pushenvvar CC i586-mingw32msvc-gcc
...
echo "----------------# task [151/209] /i586-mingw32msvc/mpc/install\n"
pushenv
pushenvvar CC_FOR_BUILD gcc
pushenvvar CXX_FOR_BUILD g++
pushenvvar CC i586-mingw32msvc-gcc
...
echo "----------------# task [152/209] /i586-mingw32msvc/mpc/postinstall\n"
pushenv
pushenvvar CC_FOR_BUILD gcc
pushenvvar CXX_FOR_BUILD g++
pushenvvar CC i586-mingw32msvc-gcc
...
echo "----------------# task [153/209] /i586-mingw32msvc/ppl/configure\n"
pushenv
pushenvvar CC_FOR_BUILD gcc
pushenvvar CXX_FOR_BUILD g++
pushenvvar CC i586-mingw32msvc-gcc
...
pushenv
pushenv
rm -rf $WORKPATH/obj/ppl-2012.09-98-mips-sde-elf-i586-mingw32msvc
mkdir -p $WORKPATH/obj/ppl-2012.09-98-mips-sde-elf-i586-mingw32msvc
pushd $WORKPATH/obj/ppl-2012.09-98-mips-sde-elf-i586-mingw32msvc
check_mentor_trademarks $WORKPATH/src/ppl-sgxx-0.11-2012.09 --prefix=$WORKPATH/obj/pkg-2012.09-98-mips-sde-elf/mips-2012.09-98-mips-sde-elf.extras/host-libs-i586-mingw32msvc/usr --disable-shared --build=i686-pc-linux-gnu --target=mips-sde-elf --host=i586-mingw32msvc --disable-nls --with-libgmp-prefix=$WORKPATH/obj/pkg-2012.09-98-mips-sde-elf/mips-2012.09-98-mips-sde-elf.extras/host-libs-i586-mingw32msvc/usr --with-gmp-prefix=$WORKPATH/obj/pkg-2012.09-98-mips-sde-elf/mips-2012.09-98-mips-sde-elf.extras/host-libs-i586-mingw32msvc/usr CPPFLAGS=-I$WORKPATH/obj/pkg-2012.09-98-mips-sde-elf/mips-2012.09-98-mips-sde-elf.extras/host-libs-i586-mingw32msvc/usr/include LDFLAGS=-L$WORKPATH/obj/pkg-2012.09-98-mips-sde-elf/mips-2012.09-98-mips-sde-elf.extras/host-libs-i586-mingw32msvc/usr/lib --disable-watchdog
popd
popenv
popenv
popenv

echo "----------------# task [154/209] /i586-mingw32msvc/ppl/build\n"
pushenv
pushenvvar CC_FOR_BUILD gcc
pushenvvar CXX_FOR_BUILD g++
pushenvvar CC i586-mingw32msvc-gcc
...
echo "----------------# task [155/209] /i586-mingw32msvc/ppl/install\n"
pushenv
pushenvvar CC_FOR_BUILD gcc
pushenvvar CXX_FOR_BUILD g++
pushenvvar CC i586-mingw32msvc-gcc
...
echo "----------------# task [156/209] /i586-mingw32msvc/cloog/configure\n"
pushenv
pushenvvar CC_FOR_BUILD gcc
pushenvvar CXX_FOR_BUILD g++
pushenvvar CC i586-mingw32msvc-gcc
...
pushenv
pushenv
rm -rf $WORKPATH/obj/cloog-2012.09-98-mips-sde-elf-i586-mingw32msvc
mkdir -p $WORKPATH/obj/cloog-2012.09-98-mips-sde-elf-i586-mingw32msvc
pushd $WORKPATH/obj/cloog-2012.09-98-mips-sde-elf-i586-mingw32msvc
check_mentor_trademarks $WORKPATH/src/cloog-0.15 --prefix=$WORKPATH/obj/pkg-2012.09-98-mips-sde-elf/mips-2012.09-98-mips-sde-elf.extras/host-libs-i586-mingw32msvc/usr --disable-shared --build=i686-pc-linux-gnu --target=mips-sde-elf --host=i586-mingw32msvc --disable-nls --with-ppl=$WORKPATH/obj/pkg-2012.09-98-mips-sde-elf/mips-2012.09-98-mips-sde-elf.extras/host-libs-i586-mingw32msvc/usr --with-gmp=$WORKPATH/obj/pkg-2012.09-98-mips-sde-elf/mips-2012.09-98-mips-sde-elf.extras/host-libs-i586-mingw32msvc/usr
popd
popenv
popenv
popenv

echo "----------------# task [157/209] /i586-mingw32msvc/cloog/build\n"
pushenv
pushenvvar CC_FOR_BUILD gcc
pushenvvar CXX_FOR_BUILD g++
pushenvvar CC i586-mingw32msvc-gcc
...
echo "----------------# task [158/209] /i586-mingw32msvc/cloog/install\n"
pushenv
pushenvvar CC_FOR_BUILD gcc
pushenvvar CXX_FOR_BUILD g++
pushenvvar CC i586-mingw32msvc-gcc
...
echo "----------------# task [159/209] /i586-mingw32msvc/cloog/postinstall\n"
pushenv
pushenvvar CC_FOR_BUILD gcc
pushenvvar CXX_FOR_BUILD g++
pushenvvar CC i586-mingw32msvc-gcc
...
echo "----------------# task [160/209] /i586-mingw32msvc/libelf/configure\n"
pushenv
pushenvvar CC_FOR_BUILD gcc
pushenvvar CXX_FOR_BUILD g++
pushenvvar CC i586-mingw32msvc-gcc
...
pushenv
pushenv
rm -rf $WORKPATH/obj/libelf-2012.09-98-mips-sde-elf-i586-mingw32msvc
mkdir -p $WORKPATH/obj/libelf-2012.09-98-mips-sde-elf-i586-mingw32msvc
pushd $WORKPATH/obj/libelf-2012.09-98-mips-sde-elf-i586-mingw32msvc
check_mentor_trademarks $WORKPATH/src/libelf-2012.09 --prefix=$WORKPATH/obj/pkg-2012.09-98-mips-sde-elf/mips-2012.09-98-mips-sde-elf.extras/host-libs-i586-mingw32msvc/usr --disable-shared --build=i686-pc-linux-gnu --target=mips-sde-elf --host=i586-mingw32msvc --disable-nls
popd
popenv
popenv
popenv

echo "----------------# task [161/209] /i586-mingw32msvc/libelf/build\n"
pushenv
pushenvvar CC_FOR_BUILD gcc
pushenvvar CXX_FOR_BUILD g++
pushenvvar CC i586-mingw32msvc-gcc
...
echo "----------------# task [162/209] /i586-mingw32msvc/libelf/install\n"
pushenv
pushenvvar CC_FOR_BUILD gcc
pushenvvar CXX_FOR_BUILD g++
pushenvvar CC i586-mingw32msvc-gcc
...
echo "----------------# task [163/209] /i586-mingw32msvc/toolchain/binutils/copy\n"
pushenv
pushenvvar CC_FOR_BUILD gcc
pushenvvar CXX_FOR_BUILD g++
pushenvvar CC i586-mingw32msvc-gcc
...
pushenv
pushenv
pushenvvar CPPFLAGS -I$WORKPATH/obj/pkg-2012.09-98-mips-sde-elf/mips-2012.09-98-mips-sde-elf.extras/host-libs-i586-mingw32msvc/usr/include
pushenvvar LDFLAGS -L$WORKPATH/obj/pkg-2012.09-98-mips-sde-elf/mips-2012.09-98-mips-sde-elf.extras/host-libs-i586-mingw32msvc/usr/lib
rm -rf $WORKPATH/obj/binutils-src-2012.09-98-mips-sde-elf-i586-mingw32msvc
copy_dir_clean $WORKPATH/src/binutils-2012.09 $WORKPATH/obj/binutils-src-2012.09-98-mips-sde-elf-i586-mingw32msvc
chmod -R u+w $WORKPATH/obj/binutils-src-2012.09-98-mips-sde-elf-i586-mingw32msvc
touch $WORKPATH/obj/binutils-src-2012.09-98-mips-sde-elf-i586-mingw32msvc/.gnu-stamp
popenv
popenv
popenv

echo "----------------# task [164/209] /i586-mingw32msvc/toolchain/binutils/configure\n"
pushenv
pushenvvar CC_FOR_BUILD gcc
pushenvvar CXX_FOR_BUILD g++
pushenvvar CC i586-mingw32msvc-gcc
...
pushenvvar CPPFLAGS -I$WORKPATH/obj/pkg-2012.09-98-mips-sde-elf/mips-2012.09-98-mips-sde-elf.extras/host-libs-i586-mingw32msvc/usr/include
pushenvvar LDFLAGS -L$WORKPATH/obj/pkg-2012.09-98-mips-sde-elf/mips-2012.09-98-mips-sde-elf.extras/host-libs-i586-mingw32msvc/usr/lib
rm -rf $WORKPATH/obj/binutils-2012.09-98-mips-sde-elf-i586-mingw32msvc
mkdir -p $WORKPATH/obj/binutils-2012.09-98-mips-sde-elf-i586-mingw32msvc
pushd $WORKPATH/obj/binutils-2012.09-98-mips-sde-elf-i586-mingw32msvc
check_mentor_trademarks $WORKPATH/obj/binutils-src-2012.09-98-mips-sde-elf-i586-mingw32msvc --prefix=$WORKPATH/install --build=i686-pc-linux-gnu --target=mips-sde-elf --host=i586-mingw32msvc '--with-pkgversion=Ingenic 2015.02' --with-python=no --with-zlib=no --disable-nls --with-sysroot=/opt/codesourcery/mips-sde-elf --enable-poison-system-directories --enable-plugins
popd
popenv
popenv
popenv

echo "----------------# task [165/209] /i586-mingw32msvc/toolchain/binutils/libiberty\n"
pushenv
pushenvvar CC_FOR_BUILD gcc
pushenvvar CXX_FOR_BUILD g++
pushenvvar CC i586-mingw32msvc-gcc
...
popd
copy_dir_clean $WORKPATH/src/binutils-2012.09/include $WORKPATH/obj/pkg-2012.09-98-mips-sde-elf/mips-2012.09-98-mips-sde-elf.extras/host-binutils-i586-mingw32msvc/usr/include
chmod -R u+w $WORKPATH/obj/pkg-2012.09-98-mips-sde-elf/mips-2012.09-98-mips-sde-elf.extras/host-binutils-i586-mingw32msvc/usr/include
mkdir -p $WORKPATH/obj/pkg-2012.09-98-mips-sde-elf/mips-2012.09-98-mips-sde-elf.extras/host-binutils-i586-mingw32msvc/usr/lib
cp $WORKPATH/obj/binutils-2012.09-98-mips-sde-elf-i586-mingw32msvc/libiberty/libiberty.a $WORKPATH/obj/pkg-2012.09-98-mips-sde-elf/mips-2012.09-98-mips-sde-elf.extras/host-binutils-i586-mingw32msvc/usr/lib
popenv
popenv
popenv

echo "----------------# task [166/209] /i586-mingw32msvc/toolchain/binutils/build\n"
pushenv
pushenvvar CC_FOR_BUILD gcc
pushenvvar CXX_FOR_BUILD g++
pushenvvar CC i586-mingw32msvc-gcc
...
echo "----------------# task [167/209] /i586-mingw32msvc/toolchain/binutils/install\n"
pushenv
pushenvvar CC_FOR_BUILD gcc
pushenvvar CXX_FOR_BUILD g++
pushenvvar CC i586-mingw32msvc-gcc
...
echo "----------------# task [168/209] /i586-mingw32msvc/toolchain/binutils/postinstall\n"
pushenv
pushenvvar CC_FOR_BUILD gcc
pushenvvar CXX_FOR_BUILD g++
pushenvvar CC i586-mingw32msvc-gcc
...
pushenvvar CPPFLAGS -I$WORKPATH/obj/pkg-2012.09-98-mips-sde-elf/mips-2012.09-98-mips-sde-elf.extras/host-libs-i586-mingw32msvc/usr/include
pushenvvar LDFLAGS -L$WORKPATH/obj/pkg-2012.09-98-mips-sde-elf/mips-2012.09-98-mips-sde-elf.extras/host-libs-i586-mingw32msvc/usr/lib
pushd $WORKPATH/install/host-i586-mingw32msvc
rm -rf lib/charset.alias
rm -rf ./lib/libiberty.a
rm -rf ./lib
popd
pushd $WORKPATH/obj/binutils-2012.09-98-mips-sde-elf-i586-mingw32msvc
make prefix=$WORKPATH/install/host-i586-mingw32msvc exec_prefix=$WORKPATH/install/host-i586-mingw32msvc libdir=$WORKPATH/install/host-i586-mingw32msvc/lib htmldir=$WORKPATH/install/host-i586-mingw32msvc/share/doc/mips-mips-sde-elf/html pdfdir=$WORKPATH/install/host-i586-mingw32msvc/share/doc/mips-mips-sde-elf/pdf infodir=$WORKPATH/install/host-i586-mingw32msvc/share/doc/mips-mips-sde-elf/info mandir=$WORKPATH/install/host-i586-mingw32msvc/share/doc/mips-mips-sde-elf/man datadir=$WORKPATH/install/host-i586-mingw32msvc/share install-html
popd
pushd $WORKPATH/obj/binutils-2012.09-98-mips-sde-elf-i586-mingw32msvc
make prefix=$WORKPATH/install/host-i586-mingw32msvc exec_prefix=$WORKPATH/install/host-i586-mingw32msvc libdir=$WORKPATH/install/host-i586-mingw32msvc/lib htmldir=$WORKPATH/install/host-i586-mingw32msvc/share/doc/mips-mips-sde-elf/html pdfdir=$WORKPATH/install/host-i586-mingw32msvc/share/doc/mips-mips-sde-elf/pdf infodir=$WORKPATH/install/host-i586-mingw32msvc/share/doc/mips-mips-sde-elf/info mandir=$WORKPATH/install/host-i586-mingw32msvc/share/doc/mips-mips-sde-elf/man datadir=$WORKPATH/install/host-i586-mingw32msvc/share install-pdf
popd
cp $WORKPATH/obj/binutils-2012.09-98-mips-sde-elf-i586-mingw32msvc/bfd/.libs/libbfd.a $WORKPATH/obj/pkg-2012.09-98-mips-sde-elf/mips-2012.09-98-mips-sde-elf.extras/host-binutils-i586-mingw32msvc/usr/lib
cp $WORKPATH/obj/binutils-2012.09-98-mips-sde-elf-i586-mingw32msvc/bfd/bfd.h $WORKPATH/obj/pkg-2012.09-98-mips-sde-elf/mips-2012.09-98-mips-sde-elf.extras/host-binutils-i586-mingw32msvc/usr/include
cp $WORKPATH/src/binutils-2012.09/bfd/elf-bfd.h $WORKPATH/obj/pkg-2012.09-98-mips-sde-elf/mips-2012.09-98-mips-sde-elf.extras/host-binutils-i586-mingw32msvc/usr/include
cp $WORKPATH/obj/binutils-2012.09-98-mips-sde-elf-i586-mingw32msvc/opcodes/.libs/libopcodes.a $WORKPATH/obj/pkg-2012.09-98-mips-sde-elf/mips-2012.09-98-mips-sde-elf.extras/host-binutils-i586-mingw32msvc/usr/lib
mkdir -p $WORKPATH/obj/pkg-2012.09-98-mips-sde-elf/mips-2012.09-98-mips-sde-elf.extras/host-binutils-i586-mingw32msvc/usr/testbin
cp $WORKPATH/obj/binutils-2012.09-98-mips-sde-elf-i586-mingw32msvc/binutils/bfdtest1.exe $WORKPATH/obj/pkg-2012.09-98-mips-sde-elf/mips-2012.09-98-mips-sde-elf.extras/host-binutils-i586-mingw32msvc/usr/testbin
rm -f $WORKPATH/install/host-i586-mingw32msvc/share/doc/mips-mips-sde-elf/html/configure.html $WORKPATH/install/host-i586-mingw32msvc/share/doc/mips-mips-sde-elf/pdf/etc/configure.pdf
rm -f $WORKPATH/install/host-i586-mingw32msvc/share/doc/mips-mips-sde-elf/info/configure.info
install-info --infodir=$WORKPATH/install/host-i586-mingw32msvc/share/doc/mips-mips-sde-elf/info --remove-exactly configure
rm -f $WORKPATH/install/host-i586-mingw32msvc/share/doc/mips-mips-sde-elf/html/standards.html $WORKPATH/install/host-i586-mingw32msvc/share/doc/mips-mips-sde-elf/pdf/etc/standards.pdf
rm -f $WORKPATH/install/host-i586-mingw32msvc/share/doc/mips-mips-sde-elf/info/standards.info
install-info --infodir=$WORKPATH/install/host-i586-mingw32msvc/share/doc/mips-mips-sde-elf/info --remove-exactly standards
rmdir $WORKPATH/install/host-i586-mingw32msvc/share/doc/mips-mips-sde-elf/pdf/etc
rm -rf $WORKPATH/install/host-i586-mingw32msvc/share/doc/mips-mips-sde-elf/html/bfd.html $WORKPATH/install/host-i586-mingw32msvc/share/doc/mips-mips-sde-elf/pdf/bfd.pdf
rm -f $WORKPATH/install/host-i586-mingw32msvc/share/doc/mips-mips-sde-elf/info/bfd.info
install-info --infodir=$WORKPATH/install/host-i586-mingw32msvc/share/doc/mips-mips-sde-elf/info --remove-exactly bfd
rm -f $WORKPATH/install/host-i586-mingw32msvc/share/doc/mips-mips-sde-elf/html/libiberty.html $WORKPATH/install/host-i586-mingw32msvc/share/doc/mips-mips-sde-elf/pdf/libiberty.pdf
rm -f $WORKPATH/install/host-i586-mingw32msvc/bin/mips-sde-elf-ld.bfd.exe
rm -f $WORKPATH/install/host-i586-mingw32msvc/bin/ld.bfd.exe
rm -f $WORKPATH/install/host-i586-mingw32msvc/mips-sde-elf/bin/ld.bfd.exe
popenv
popenv
popenv

echo "----------------# task [169/209] /i586-mingw32msvc/toolchain/copy_libs\n"
pushenv
pushenvvar CC_FOR_BUILD gcc
pushenvvar CXX_FOR_BUILD g++
pushenvvar CC i586-mingw32msvc-gcc
...
pushenvvar RANLIB i586-mingw32msvc-ranlib
prepend_path PATH $WORKPATH/obj/tools-i686-pc-linux-gnu-2012.09-98-mips-sde-elf-i586-mingw32msvc/bin
copy_dir $WORKPATH/obj/tools-i686-pc-linux-gnu-2012.09-98-mips-sde-elf-i586-mingw32msvc/share/doc/mips-mips-sde-elf/html $WORKPATH/install/host-i586-mingw32msvc/share/doc/mips-mips-sde-elf/html
copy_dir $WORKPATH/obj/tools-i686-pc-linux-gnu-2012.09-98-mips-sde-elf-i586-mingw32msvc/share/doc/mips-mips-sde-elf/pdf $WORKPATH/install/host-i586-mingw32msvc/share/doc/mips-mips-sde-elf/pdf
copy_dir $WORKPATH/obj/tools-i686-pc-linux-gnu-2012.09-98-mips-sde-elf-i586-mingw32msvc/share/doc/mips-mips-sde-elf/info $WORKPATH/install/host-i586-mingw32msvc/share/doc/mips-mips-sde-elf/info
copy_dir $WORKPATH/obj/tools-i686-pc-linux-gnu-2012.09-98-mips-sde-elf-i586-mingw32msvc/share/doc/mips-mips-sde-elf/man $WORKPATH/install/host-i586-mingw32msvc/share/doc/mips-mips-sde-elf/man
# cp $WORKPATH/obj/tools-i686-pc-linux-gnu-2012.09-98-mips-sde-elf-i586-mingw32msvc/share/doc/mips-mips-sde-elf/LICENSE.txt $WORKPATH/install/host-i586-mingw32msvc/share/doc/mips-mips-sde-elf
copy_dir $WORKPATH/obj/tools-i686-pc-linux-gnu-2012.09-98-mips-sde-elf-i586-mingw32msvc/mips-sde-elf/lib $WORKPATH/install/host-i586-mingw32msvc/mips-sde-elf/lib
copy_dir $WORKPATH/obj/tools-i686-pc-linux-gnu-2012.09-98-mips-sde-elf-i586-mingw32msvc/mips-sde-elf/include $WORKPATH/install/host-i586-mingw32msvc/mips-sde-elf/include
copy_dir $WORKPATH/obj/tools-i686-pc-linux-gnu-2012.09-98-mips-sde-elf-i586-mingw32msvc/mips-sde-elf/include/c++ $WORKPATH/install/host-i586-mingw32msvc/mips-sde-elf/include/c++
copy_dir $WORKPATH/obj/tools-i686-pc-linux-gnu-2012.09-98-mips-sde-elf-i586-mingw32msvc/lib/gcc/mips-sde-elf $WORKPATH/install/host-i586-mingw32msvc/lib/gcc/mips-sde-elf
popenv

echo "----------------# task [170/209] /i586-mingw32msvc/toolchain/gcc_final/configure\n"
pushenv
pushenvvar CC_FOR_BUILD gcc
pushenvvar CXX_FOR_BUILD g++
pushenvvar CC i586-mingw32msvc-gcc
...
rm -f $WORKPATH/install/host-i586-mingw32msvc/mips-sde-elf/usr
ln -s . $WORKPATH/install/host-i586-mingw32msvc/mips-sde-elf/usr
rm -rf $WORKPATH/obj/gcc-2012.09-98-mips-sde-elf-i586-mingw32msvc
mkdir -p $WORKPATH/obj/gcc-2012.09-98-mips-sde-elf-i586-mingw32msvc
pushd $WORKPATH/obj/gcc-2012.09-98-mips-sde-elf-i586-mingw32msvc
check_mentor_trademarks $WORKPATH/src/gcc-4.7-2012.09 --build=i686-pc-linux-gnu --host=i586-mingw32msvc --target=mips-sde-elf --enable-threads --disable-libmudflap --disable-libssp --disable-libstdcxx-pch --with-arch-32=mips32r2 --with-arch-64=mips64r2 --enable-sgxx-sde-multilibs --disable-threads --with-gnu-as --with-gnu-ld '--with-specs=%{save-temps: -fverbose-asm} -D__CS_SOURCERYGXX_MAJ__=2012 -D__CS_SOURCERYGXX_MIN__=9 -D__CS_SOURCERYGXX_REV__=98' --enable-languages=c,c++ --disable-shared --enable-lto --with-newlib '--with-pkgversion=Ingenic 2015.02' --disable-nls --prefix=$WORKPATH/install --with-headers=yes --with-sysroot=/opt/codesourcery/mips-sde-elf --with-build-sysroot=$WORKPATH/install/host-i586-mingw32msvc/mips-sde-elf --with-libiconv-prefix=$WORKPATH/obj/pkg-2012.09-98-mips-sde-elf/mips-2012.09-98-mips-sde-elf.extras/host-libs-i586-mingw32msvc/usr --with-gmp=$WORKPATH/obj/pkg-2012.09-98-mips-sde-elf/mips-2012.09-98-mips-sde-elf.extras/host-libs-i586-mingw32msvc/usr --with-mpfr=$WORKPATH/obj/pkg-2012.09-98-mips-sde-elf/mips-2012.09-98-mips-sde-elf.extras/host-libs-i586-mingw32msvc/usr --with-mpc=$WORKPATH/obj/pkg-2012.09-98-mips-sde-elf/mips-2012.09-98-mips-sde-elf.extras/host-libs-i586-mingw32msvc/usr --with-ppl=$WORKPATH/obj/pkg-2012.09-98-mips-sde-elf/mips-2012.09-98-mips-sde-elf.extras/host-libs-i586-mingw32msvc/usr '--with-host-libstdcxx=-static-libgcc -Wl,-Bstatic,-lstdc++,-Bdynamic -lm' --with-cloog=$WORKPATH/obj/pkg-2012.09-98-mips-sde-elf/mips-2012.09-98-mips-sde-elf.extras/host-libs-i586-mingw32msvc/usr --with-libelf=$WORKPATH/obj/pkg-2012.09-98-mips-sde-elf/mips-2012.09-98-mips-sde-elf.extras/host-libs-i586-mingw32msvc/usr --disable-libgomp --disable-libitm --enable-poison-system-directories --with-build-time-tools=$WORKPATH/obj/tools-i686-pc-linux-gnu-2012.09-98-mips-sde-elf-i586-mingw32msvc/mips-sde-elf/bin --with-build-time-tools=$WORKPATH/obj/tools-i686-pc-linux-gnu-2012.09-98-mips-sde-elf-i586-mingw32msvc/mips-sde-elf/bin
popd
popenv
popenv

echo "----------------# task [171/209] /i586-mingw32msvc/toolchain/gcc_final/build\n"
pushenv
pushenvvar CC_FOR_BUILD gcc
pushenvvar CXX_FOR_BUILD g++
pushenvvar CC i586-mingw32msvc-gcc
...
ln -s . $WORKPATH/install/host-i586-mingw32msvc/mips-sde-elf/usr
pushd $WORKPATH/obj/gcc-2012.09-98-mips-sde-elf-i586-mingw32msvc
make -j4 LDFLAGS_FOR_TARGET=--sysroot=$WORKPATH/install/host-i586-mingw32msvc/mips-sde-elf CPPFLAGS_FOR_TARGET=--sysroot=$WORKPATH/install/host-i586-mingw32msvc/mips-sde-elf build_tooldir=$WORKPATH/install/host-i586-mingw32msvc/mips-sde-elf all-gcc
popd
popenv
popenv

echo "----------------# task [172/209] /i586-mingw32msvc/toolchain/gcc_final/install\n"
pushenv
pushenvvar CC_FOR_BUILD gcc
pushenvvar CXX_FOR_BUILD g++
pushenvvar CC i586-mingw32msvc-gcc
...
ln -s . $WORKPATH/install/host-i586-mingw32msvc/mips-sde-elf/usr
pushd $WORKPATH/obj/gcc-2012.09-98-mips-sde-elf-i586-mingw32msvc
make prefix=$WORKPATH/install/host-i586-mingw32msvc exec_prefix=$WORKPATH/install/host-i586-mingw32msvc libdir=$WORKPATH/install/host-i586-mingw32msvc/lib htmldir=$WORKPATH/install/host-i586-mingw32msvc/share/doc/mips-mips-sde-elf/html pdfdir=$WORKPATH/install/host-i586-mingw32msvc/share/doc/mips-mips-sde-elf/pdf infodir=$WORKPATH/install/host-i586-mingw32msvc/share/doc/mips-mips-sde-elf/info mandir=$WORKPATH/install/host-i586-mingw32msvc/share/doc/mips-mips-sde-elf/man install-gcc
make prefix=$WORKPATH/install/host-i586-mingw32msvc exec_prefix=$WORKPATH/install/host-i586-mingw32msvc libdir=$WORKPATH/install/host-i586-mingw32msvc/lib htmldir=$WORKPATH/install/host-i586-mingw32msvc/share/doc/mips-mips-sde-elf/html pdfdir=$WORKPATH/install/host-i586-mingw32msvc/share/doc/mips-mips-sde-elf/pdf infodir=$WORKPATH/install/host-i586-mingw32msvc/share/doc/mips-mips-sde-elf/info mandir=$WORKPATH/install/host-i586-mingw32msvc/share/doc/mips-mips-sde-elf/man install-html-gcc
make prefix=$WORKPATH/install/host-i586-mingw32msvc exec_prefix=$WORKPATH/install/host-i586-mingw32msvc libdir=$WORKPATH/install/host-i586-mingw32msvc/lib htmldir=$WORKPATH/install/host-i586-mingw32msvc/share/doc/mips-mips-sde-elf/html pdfdir=$WORKPATH/install/host-i586-mingw32msvc/share/doc/mips-mips-sde-elf/pdf infodir=$WORKPATH/install/host-i586-mingw32msvc/share/doc/mips-mips-sde-elf/info mandir=$WORKPATH/install/host-i586-mingw32msvc/share/doc/mips-mips-sde-elf/man install-pdf-gcc
popd
popenv
...
echo "----------------# task [173/209] /i586-mingw32msvc/toolchain/gcc_final/postinstall\n"
pushenv
pushenvvar CC_FOR_BUILD gcc
pushenvvar CXX_FOR_BUILD g++
pushenvvar CC i586-mingw32msvc-gcc
...
copy_dir $WORKPATH/obj/tools-i686-pc-linux-gnu-2012.09-98-mips-sde-elf-i586-mingw32msvc/mips-sde-elf/include/c++ $WORKPATH/install/host-i586-mingw32msvc/mips-sde-elf/include/c++
rm -f $WORKPATH/install/host-i586-mingw32msvc/mips-sde-elf/usr
rm -rf $WORKPATH/install/host-i586-mingw32msvc/share/doc/mips-mips-sde-elf/html/gccinstall $WORKPATH/install/host-i586-mingw32msvc/share/doc/mips-mips-sde-elf/pdf/gcc/gccinstall.pdf
rm -f $WORKPATH/install/host-i586-mingw32msvc/share/doc/mips-mips-sde-elf/info/gccinstall.info
install-info --infodir=$WORKPATH/install/host-i586-mingw32msvc/share/doc/mips-mips-sde-elf/info --remove-exactly gccinstall
rm -rf $WORKPATH/install/host-i586-mingw32msvc/share/doc/mips-mips-sde-elf/html/gccint $WORKPATH/install/host-i586-mingw32msvc/share/doc/mips-mips-sde-elf/pdf/gcc/gccint.pdf
rm -f $WORKPATH/install/host-i586-mingw32msvc/share/doc/mips-mips-sde-elf/info/gccint.info
install-info --infodir=$WORKPATH/install/host-i586-mingw32msvc/share/doc/mips-mips-sde-elf/info --remove-exactly gccint
rm -rf $WORKPATH/install/host-i586-mingw32msvc/share/doc/mips-mips-sde-elf/html/cppinternals $WORKPATH/install/host-i586-mingw32msvc/share/doc/mips-mips-sde-elf/pdf/gcc/cppinternals.pdf
rm -f $WORKPATH/install/host-i586-mingw32msvc/share/doc/mips-mips-sde-elf/info/cppinternals.info
install-info --infodir=$WORKPATH/install/host-i586-mingw32msvc/share/doc/mips-mips-sde-elf/info --remove-exactly cppinternals
rm -f $WORKPATH/install/host-i586-mingw32msvc/share/doc/mips-mips-sde-elf/html/libiberty.html $WORKPATH/install/host-i586-mingw32msvc/share/doc/mips-mips-sde-elf/pdf/libiberty.pdf
popenv
popenv

if [ "" == "x" ];then # Don't compile
echo "----------------# task [174/209] /i586-mingw32msvc/toolchain/zlib/0/copy\n"
pushenv
pushenvvar CC_FOR_BUILD gcc
pushenvvar CXX_FOR_BUILD g++
pushenvvar CC i586-mingw32msvc-gcc
...
pushenvvar RANLIB i586-mingw32msvc-ranlib
prepend_path PATH $WORKPATH/obj/tools-i686-pc-linux-gnu-2012.09-98-mips-sde-elf-i586-mingw32msvc/bin
rm -rf $WORKPATH/obj/zlib-2012.09-98-mips-sde-elf-i586-mingw32msvc
copy_dir_clean $WORKPATH/src/zlib-1.2.7 $WORKPATH/obj/zlib-2012.09-98-mips-sde-elf-i586-mingw32msvc
chmod -R u+w $WORKPATH/obj/zlib-2012.09-98-mips-sde-elf-i586-mingw32msvc
popenv

echo "----------------# task [175/209] /i586-mingw32msvc/toolchain/zlib/0/configure\n"
pushenv
pushenvvar CC_FOR_BUILD gcc
pushenvvar CXX_FOR_BUILD g++
pushenvvar CC i586-mingw32msvc-gcc
...
pushenvvar RANLIB i586-mingw32msvc-ranlib
prepend_path PATH $WORKPATH/obj/tools-i686-pc-linux-gnu-2012.09-98-mips-sde-elf-i586-mingw32msvc/bin
pushd $WORKPATH/obj/zlib-2012.09-98-mips-sde-elf-i586-mingw32msvc
pushenv
pushenvvar CFLAGS '-O3 -fPIC'
pushenvvar CC 'i586-mingw32msvc-gcc '
pushenvvar AR i586-mingw32msvc-ar
...
echo "----------------# task [176/209] /i586-mingw32msvc/toolchain/zlib/0/build\n"
pushenv
pushenvvar CC_FOR_BUILD gcc
pushenvvar CXX_FOR_BUILD g++
pushenvvar CC i586-mingw32msvc-gcc
...
echo "----------------# task [177/209] /i586-mingw32msvc/toolchain/zlib/0/install\n"
pushenv
pushenvvar CC_FOR_BUILD gcc
pushenvvar CXX_FOR_BUILD g++
pushenvvar CC i586-mingw32msvc-gcc
...
echo "----------------# task [178/209] /i586-mingw32msvc/toolchain/expat/0/configure\n"
pushenv
pushenvvar CC_FOR_BUILD gcc
pushenvvar CXX_FOR_BUILD g++
pushenvvar CC i586-mingw32msvc-gcc
...
pushenv
pushenv
rm -rf $WORKPATH/obj/expat-2012.09-98-mips-sde-elf-i586-mingw32msvc
mkdir -p $WORKPATH/obj/expat-2012.09-98-mips-sde-elf-i586-mingw32msvc
pushd $WORKPATH/obj/expat-2012.09-98-mips-sde-elf-i586-mingw32msvc
check_mentor_trademarks $WORKPATH/src/expat-2012.09 --prefix=$WORKPATH/obj/pkg-2012.09-98-mips-sde-elf/mips-2012.09-98-mips-sde-elf.extras/host-libs-i586-mingw32msvc/usr --disable-shared --build=i686-pc-linux-gnu --target=mips-sde-elf --host=i586-mingw32msvc --disable-nls
popd
popenv
popenv
popenv

echo "----------------# task [179/209] /i586-mingw32msvc/toolchain/expat/0/build\n"
pushenv
pushenvvar CC_FOR_BUILD gcc
pushenvvar CXX_FOR_BUILD g++
pushenvvar CC i586-mingw32msvc-gcc
...
echo "----------------# task [180/209] /i586-mingw32msvc/toolchain/expat/0/install\n"
pushenv
pushenvvar CC_FOR_BUILD gcc
pushenvvar CXX_FOR_BUILD g++
pushenvvar CC i586-mingw32msvc-gcc
...
if [ "" == "x" ];then # Don't compile
echo "----------------# task [181/209] /i586-mingw32msvc/toolchain/gdb/0/copy\n"
pushenv
pushenvvar CC_FOR_BUILD gcc
pushenvvar CXX_FOR_BUILD g++
pushenvvar CC i586-mingw32msvc-gcc
...
pushenvvar CPPFLAGS -I$WORKPATH/obj/pkg-2012.09-98-mips-sde-elf/mips-2012.09-98-mips-sde-elf.extras/host-libs-i586-mingw32msvc/usr/include
pushenvvar LDFLAGS -L$WORKPATH/obj/pkg-2012.09-98-mips-sde-elf/mips-2012.09-98-mips-sde-elf.extras/host-libs-i586-mingw32msvc/usr/lib
rm -rf $WORKPATH/obj/gdb-src-2012.09-98-mips-sde-elf-i586-mingw32msvc
copy_dir_clean $WORKPATH/src/gdb-2012.09 $WORKPATH/obj/gdb-src-2012.09-98-mips-sde-elf-i586-mingw32msvc
chmod -R u+w $WORKPATH/obj/gdb-src-2012.09-98-mips-sde-elf-i586-mingw32msvc
touch $WORKPATH/obj/gdb-src-2012.09-98-mips-sde-elf-i586-mingw32msvc/.gnu-stamp
popenv
popenv
popenv

echo "----------------# task [182/209] /i586-mingw32msvc/toolchain/gdb/0/configure\n"
pushenv
pushenvvar CC_FOR_BUILD gcc
pushenvvar CXX_FOR_BUILD g++
pushenvvar CC i586-mingw32msvc-gcc
...
pushenvvar CPPFLAGS -I$WORKPATH/obj/pkg-2012.09-98-mips-sde-elf/mips-2012.09-98-mips-sde-elf.extras/host-libs-i586-mingw32msvc/usr/include
pushenvvar LDFLAGS -L$WORKPATH/obj/pkg-2012.09-98-mips-sde-elf/mips-2012.09-98-mips-sde-elf.extras/host-libs-i586-mingw32msvc/usr/lib
rm -rf $WORKPATH/obj/gdb-2012.09-98-mips-sde-elf-i586-mingw32msvc
mkdir -p $WORKPATH/obj/gdb-2012.09-98-mips-sde-elf-i586-mingw32msvc
pushd $WORKPATH/obj/gdb-2012.09-98-mips-sde-elf-i586-mingw32msvc
check_mentor_trademarks $WORKPATH/obj/gdb-src-2012.09-98-mips-sde-elf-i586-mingw32msvc --prefix=$WORKPATH/install --build=i686-pc-linux-gnu --target=mips-sde-elf --host=i586-mingw32msvc '--with-pkgversion=Ingenic 2015.02' --disable-libmcheck --disable-nls --with-libexpat-prefix=$WORKPATH/obj/pkg-2012.09-98-mips-sde-elf/mips-2012.09-98-mips-sde-elf.extras/host-libs-i586-mingw32msvc/usr --with-libiconv-prefix=$WORKPATH/obj/pkg-2012.09-98-mips-sde-elf/mips-2012.09-98-mips-sde-elf.extras/host-libs-i586-mingw32msvc/usr --with-system-gdbinit=/opt/codesourcery/i586-mingw32msvc/mips-sde-elf/lib/gdbinit '--with-gdb-datadir='\''${prefix}'\''/mips-sde-elf/share/gdb'
popd
popenv
popenv
popenv

echo "----------------# task [183/209] /i586-mingw32msvc/toolchain/gdb/0/build\n"
pushenv
pushenvvar CC_FOR_BUILD gcc
pushenvvar CXX_FOR_BUILD g++
pushenvvar CC i586-mingw32msvc-gcc
...
echo "----------------# task [184/209] /i586-mingw32msvc/toolchain/gdb/0/install\n"
pushenv
pushenvvar CC_FOR_BUILD gcc
pushenvvar CXX_FOR_BUILD g++
pushenvvar CC i586-mingw32msvc-gcc
...
echo "----------------# task [185/209] /i586-mingw32msvc/toolchain/gdb/0/postinstall\n"
pushenv
pushenvvar CC_FOR_BUILD gcc
pushenvvar CXX_FOR_BUILD g++
pushenvvar CC i586-mingw32msvc-gcc
...
make prefix=$WORKPATH/install/host-i586-mingw32msvc exec_prefix=$WORKPATH/install/host-i586-mingw32msvc libdir=$WORKPATH/install/host-i586-mingw32msvc/lib htmldir=$WORKPATH/install/host-i586-mingw32msvc/share/doc/mips-mips-sde-elf/html pdfdir=$WORKPATH/install/host-i586-mingw32msvc/share/doc/mips-mips-sde-elf/pdf infodir=$WORKPATH/install/host-i586-mingw32msvc/share/doc/mips-mips-sde-elf/info mandir=$WORKPATH/install/host-i586-mingw32msvc/share/doc/mips-mips-sde-elf/man datadir=$WORKPATH/install/host-i586-mingw32msvc/share install-pdf
popd
rm -rf $WORKPATH/install/host-i586-mingw32msvc/share/doc/mips-mips-sde-elf/html/annotate $WORKPATH/install/host-i586-mingw32msvc/share/doc/mips-mips-sde-elf/pdf/annotate.pdf
rm -f $WORKPATH/install/host-i586-mingw32msvc/share/doc/mips-mips-sde-elf/info/annotate.info
install-info --infodir=$WORKPATH/install/host-i586-mingw32msvc/share/doc/mips-mips-sde-elf/info --remove-exactly annotate
rm -rf $WORKPATH/install/host-i586-mingw32msvc/share/doc/mips-mips-sde-elf/html/gdbint $WORKPATH/install/host-i586-mingw32msvc/share/doc/mips-mips-sde-elf/pdf/gdbint.pdf
rm -f $WORKPATH/install/host-i586-mingw32msvc/share/doc/mips-mips-sde-elf/info/gdbint.info
install-info --infodir=$WORKPATH/install/host-i586-mingw32msvc/share/doc/mips-mips-sde-elf/info --remove-exactly gdbint
rm -rf $WORKPATH/install/host-i586-mingw32msvc/share/doc/mips-mips-sde-elf/html/stabs $WORKPATH/install/host-i586-mingw32msvc/share/doc/mips-mips-sde-elf/pdf/stabs.pdf
rm -f $WORKPATH/install/host-i586-mingw32msvc/share/doc/mips-mips-sde-elf/info/stabs.info
install-info --infodir=$WORKPATH/install/host-i586-mingw32msvc/share/doc/mips-mips-sde-elf/info --remove-exactly stabs
rm -f $WORKPATH/install/host-i586-mingw32msvc/share/doc/mips-mips-sde-elf/html/configure.html $WORKPATH/install/host-i586-mingw32msvc/share/doc/mips-mips-sde-elf/pdf/etc/configure.pdf
rm -f $WORKPATH/install/host-i586-mingw32msvc/share/doc/mips-mips-sde-elf/info/configure.info
install-info --infodir=$WORKPATH/install/host-i586-mingw32msvc/share/doc/mips-mips-sde-elf/info --remove-exactly configure
rm -f $WORKPATH/install/host-i586-mingw32msvc/share/doc/mips-mips-sde-elf/html/standards.html $WORKPATH/install/host-i586-mingw32msvc/share/doc/mips-mips-sde-elf/pdf/etc/standards.pdf
...
rm -f $WORKPATH/install/host-i586-mingw32msvc/share/doc/mips-mips-sde-elf/html/libiberty.html $WORKPATH/install/host-i586-mingw32msvc/share/doc/mips-mips-sde-elf/pdf/libiberty.pdf
pushd $WORKPATH/install/host-i586-mingw32msvc
mkdir -p i586-mingw32msvc/mips-sde-elf/include/
mv include/gdb i586-mingw32msvc/mips-sde-elf/include
rmdir include
popd
popenv
popenv
...
echo "----------------# task [186/209] /i586-mingw32msvc/gdil/configure\n"
pushenv
pushenvvar CC_FOR_BUILD gcc
pushenvvar CXX_FOR_BUILD g++
pushenvvar CC i586-mingw32msvc-gcc
...
pushenv
pushenv
rm -rf $WORKPATH/obj/gdil-2012.09-98-mips-sde-elf-i586-mingw32msvc
mkdir -p $WORKPATH/obj/gdil-2012.09-98-mips-sde-elf-i586-mingw32msvc
pushd $WORKPATH/obj/gdil-2012.09-98-mips-sde-elf-i586-mingw32msvc
check_mentor_trademarks $WORKPATH/src/gdil-2012.09 --prefix=$WORKPATH/obj/pkg-2012.09-98-mips-sde-elf/mips-2012.09-98-mips-sde-elf.extras/host-libs-i586-mingw32msvc/usr --disable-shared --build=i686-pc-linux-gnu --target=mips-sde-elf --host=i586-mingw32msvc --with-csl-docbook=$WORKPATH/src/csl-docbook-trunk '--with-xml-catalog-files=/usr/local/tools/gcc-4.3.3/share/sgml/docbook/docbook-xsl/catalog.xml /etc/xml/catalog' --disable-nls --with-expat=$WORKPATH/obj/pkg-2012.09-98-mips-sde-elf/mips-2012.09-98-mips-sde-elf.extras/host-libs-i586-mingw32msvc/usr '--with-features=xml autoconf driver config sprite doc'
popd
popenv
popenv
popenv

echo "----------------# task [187/209] /i586-mingw32msvc/gdil/build\n"
pushenv
pushenvvar CC_FOR_BUILD gcc
pushenvvar CXX_FOR_BUILD g++
pushenvvar CC i586-mingw32msvc-gcc
...
echo "----------------# task [188/209] /i586-mingw32msvc/gdil/install\n"
pushenv
pushenvvar CC_FOR_BUILD gcc
pushenvvar CXX_FOR_BUILD g++
pushenvvar CC i586-mingw32msvc-gcc
...
echo "----------------# task [189/209] /i586-mingw32msvc/edge_utils/build\n"
pushenv
pushenvvar CC_FOR_BUILD gcc
pushenvvar CXX_FOR_BUILD g++
pushenvvar CC i586-mingw32msvc-gcc
...
pushenvvar RANLIB i586-mingw32msvc-ranlib
prepend_path PATH $WORKPATH/obj/tools-i686-pc-linux-gnu-2012.09-98-mips-sde-elf-i586-mingw32msvc/bin
rm -rf $WORKPATH/obj/edge-utils-2012.09-98-mips-sde-elf-i586-mingw32msvc
mkdir -p $WORKPATH/obj/edge-utils-2012.09-98-mips-sde-elf-i586-mingw32msvc
copy_dir_clean $WORKPATH/src/edge-utils-2012.09/source $WORKPATH/obj/edge-utils-2012.09-98-mips-sde-elf-i586-mingw32msvc/source
chmod -R u+w $WORKPATH/obj/edge-utils-2012.09-98-mips-sde-elf-i586-mingw32msvc
make -C $WORKPATH/obj/edge-utils-2012.09-98-mips-sde-elf-i586-mingw32msvc/source/debugger/utils -j4 BLDTYPE=rls HOST_OS=win32 GPREF=i586-mingw32msvc- win32_rls/libUtils.a
mkdir -p $WORKPATH/obj/pkg-2012.09-98-mips-sde-elf/mips-2012.09-98-mips-sde-elf.extras/edge-utils-i586-mingw32msvc/lib
cp $WORKPATH/obj/edge-utils-2012.09-98-mips-sde-elf-i586-mingw32msvc/source/debugger/utils/win32_rls/libUtils.a $WORKPATH/obj/pkg-2012.09-98-mips-sde-elf/mips-2012.09-98-mips-sde-elf.extras/edge-utils-i586-mingw32msvc/lib
mkdir -p $WORKPATH/obj/pkg-2012.09-98-mips-sde-elf/mips-2012.09-98-mips-sde-elf.extras/edge-utils-i586-mingw32msvc/include
cp $WORKPATH/src/edge-utils-2012.09/source/debugger/utils/NumericValue.h $WORKPATH/src/edge-utils-2012.09/source/debugger/utils/clBaseTypes.h $WORKPATH/src/edge-utils-2012.09/source/debugger/utils/clByteBuffer.h $WORKPATH/src/edge-utils-2012.09/source/debugger/utils/clErrorLogger.h $WORKPATH/src/edge-utils-2012.09/source/debugger/utils/clException.h $WORKPATH/src/edge-utils-2012.09/source/debugger/utils/clStl.h $WORKPATH/src/edge-utils-2012.09/source/debugger/utils/cluAllocators.h $WORKPATH/src/edge-utils-2012.09/source/debugger/utils/cluAtomic.h $WORKPATH/src/edge-utils-2012.09/source/debugger/utils/cluCLibrary.h $WORKPATH/src/edge-utils-2012.09/source/debugger/utils/cluCond.h $WORKPATH/src/edge-utils-2012.09/source/debugger/utils/cluConfigData.h $WORKPATH/src/edge-utils-2012.09/source/debugger/utils/cluConfigFile.h $WORKPATH/src/edge-utils-2012.09/source/debugger/utils/cluDebugTrace.h $WORKPATH/src/edge-utils-2012.09/source/debugger/utils/cluDll.h $WORKPATH/src/edge-utils-2012.09/source/debugger/utils/cluEmo.h $WORKPATH/src/edge-utils-2012.09/source/debugger/utils/cluEndian.h $WORKPATH/src/edge-utils-2012.09/source/debugger/utils/cluErrors.h $WORKPATH/src/edge-utils-2012.09/source/debugger/utils/cluEvent.h $WORKPATH/src/edge-utils-2012.09/source/debugger/utils/cluEventWaiter.h $WORKPATH/src/edge-utils-2012.09/source/debugger/utils/cluFile.h $WORKPATH/src/edge-utils-2012.09/source/debugger/utils/cluFileUtils.h $WORKPATH/src/edge-utils-2012.09/source/debugger/utils/cluFindFile.h $WORKPATH/src/edge-utils-2012.09/source/debugger/utils/cluFunctionTrace.h $WORKPATH/src/edge-utils-2012.09/source/debugger/utils/cluGuard.h $WORKPATH/src/edge-utils-2012.09/source/debugger/utils/cluHighResTimer.h $WORKPATH/src/edge-utils-2012.09/source/debugger/utils/cluHtmlLogFile.h $WORKPATH/src/edge-utils-2012.09/source/debugger/utils/cluInetPackets.h $WORKPATH/src/edge-utils-2012.09/source/debugger/utils/cluInetSocket.h $WORKPATH/src/edge-utils-2012.09/source/debugger/utils/cluLogFile.h $WORKPATH/src/edge-utils-2012.09/source/debugger/utils/cluMutex.h $WORKPATH/src/edge-utils-2012.09/source/debugger/utils/cluOutput.h $WORKPATH/src/edge-utils-2012.09/source/debugger/utils/cluQ.h $WORKPATH/src/edge-utils-2012.09/source/debugger/utils/cluRedirect.h $WORKPATH/src/edge-utils-2012.09/source/debugger/utils/cluRegex.h $WORKPATH/src/edge-utils-2012.09/source/debugger/utils/cluSemaphore.h $WORKPATH/src/edge-utils-2012.09/source/debugger/utils/cluSerialPort.h $WORKPATH/src/edge-utils-2012.09/source/debugger/utils/cluSerialPortBase.h $WORKPATH/src/edge-utils-2012.09/source/debugger/utils/cluSerialPortPosix.h $WORKPATH/src/edge-utils-2012.09/source/debugger/utils/cluSerialPortWin32.h $WORKPATH/src/edge-utils-2012.09/source/debugger/utils/cluSmartPtr.h $WORKPATH/src/edge-utils-2012.09/source/debugger/utils/cluSocketBase.h $WORKPATH/src/edge-utils-2012.09/source/debugger/utils/cluSplitPath.h $WORKPATH/src/edge-utils-2012.09/source/debugger/utils/cluStats.h $WORKPATH/src/edge-utils-2012.09/source/debugger/utils/cluStringHeapManager.h $WORKPATH/src/edge-utils-2012.09/source/debugger/utils/cluStringUtil.h $WORKPATH/src/edge-utils-2012.09/source/debugger/utils/cluSync.h $WORKPATH/src/edge-utils-2012.09/source/debugger/utils/cluTask.h $WORKPATH/src/edge-utils-2012.09/source/debugger/utils/cluTextTable.h $WORKPATH/src/edge-utils-2012.09/source/debugger/utils/cluThread.h $WORKPATH/src/edge-utils-2012.09/source/debugger/utils/cluThreadPool.h $WORKPATH/src/edge-utils-2012.09/source/debugger/utils/cluThreadedMember.h $WORKPATH/src/edge-utils-2012.09/source/debugger/utils/cluTime.h $WORKPATH/src/edge-utils-2012.09/source/debugger/utils/cluTimerQueue.h $WORKPATH/src/edge-utils-2012.09/source/debugger/utils/cluTransaction.h $WORKPATH/src/edge-utils-2012.09/source/debugger/utils/cluTransactionIdMap.h $WORKPATH/src/edge-utils-2012.09/source/debugger/utils/cluUniqueIDManager.h $WORKPATH/src/edge-utils-2012.09/source/debugger/utils/cluUnixSignalHandling.h $WORKPATH/src/edge-utils-2012.09/source/debugger/utils/cluUtils.h $WORKPATH/src/edge-utils-2012.09/source/debugger/utils/cluUtilsPch.h $WORKPATH/src/edge-utils-2012.09/source/debugger/utils/cluValueMap.h $WORKPATH/src/edge-utils-2012.09/source/debugger/utils/cluVector.h $WORKPATH/src/edge-utils-2012.09/source/debugger/utils/cluXmlParser.h $WORKPATH/src/edge-utils-2012.09/source/debugger/utils/rpn_calc.h $WORKPATH/src/edge-utils-2012.09/source/debugger/utils/stdint_opus.h $WORKPATH/obj/pkg-2012.09-98-mips-sde-elf/mips-2012.09-98-mips-sde-elf.extras/edge-utils-i586-mingw32msvc/include
cp $WORKPATH/src/edge-utils-2012.09/source/debugger/utils/cluConfigData.inl $WORKPATH/src/edge-utils-2012.09/source/debugger/utils/cluEvent.inl $WORKPATH/src/edge-utils-2012.09/source/debugger/utils/cluGuard.inl $WORKPATH/src/edge-utils-2012.09/source/debugger/utils/cluHighResTimer.inl $WORKPATH/src/edge-utils-2012.09/source/debugger/utils/cluLogFile.inl $WORKPATH/src/edge-utils-2012.09/source/debugger/utils/cluMutex.inl $WORKPATH/src/edge-utils-2012.09/source/debugger/utils/cluTask.inl $WORKPATH/src/edge-utils-2012.09/source/debugger/utils/cluThread.inl $WORKPATH/src/edge-utils-2012.09/source/debugger/utils/cluTime.inl $WORKPATH/obj/pkg-2012.09-98-mips-sde-elf/mips-2012.09-98-mips-sde-elf.extras/edge-utils-i586-mingw32msvc/include
popenv

echo "----------------# task [190/209] /i586-mingw32msvc/mips_sprite/configure\n"
pushenv
pushenvvar CC_FOR_BUILD gcc
pushenvvar CXX_FOR_BUILD g++
pushenvvar CC i586-mingw32msvc-gcc
...
pushenv
pushenv
rm -rf $WORKPATH/obj/mips_sprite-2012.09-98-mips-sde-elf-i586-mingw32msvc
mkdir -p $WORKPATH/obj/mips_sprite-2012.09-98-mips-sde-elf-i586-mingw32msvc
pushd $WORKPATH/obj/mips_sprite-2012.09-98-mips-sde-elf-i586-mingw32msvc
check_mentor_trademarks $WORKPATH/src/mips_sprite-2012.09 --prefix=$WORKPATH/install --build=i686-pc-linux-gnu --target=mips-sde-elf --host=i586-mingw32msvc '--with-pkgversion=Ingenic 2015.02' --enable-backends=mdimips --disable-nls --with-gdil=$WORKPATH/obj/pkg-2012.09-98-mips-sde-elf/mips-2012.09-98-mips-sde-elf.extras/host-libs-i586-mingw32msvc/usr --with-expat=$WORKPATH/obj/pkg-2012.09-98-mips-sde-elf/mips-2012.09-98-mips-sde-elf.extras/host-libs-i586-mingw32msvc/usr --with-boards=$WORKPATH/obj/pkg-2012.09-98-mips-sde-elf/mips-2012.09-98-mips-sde-elf.extras/cs3/boards
popd
popenv
popenv
popenv

echo "----------------# task [191/209] /i586-mingw32msvc/mips_sprite/build\n"
pushenv
pushenvvar CC_FOR_BUILD gcc
pushenvvar CXX_FOR_BUILD g++
pushenvvar CC i586-mingw32msvc-gcc
...
echo "----------------# task [192/209] /i586-mingw32msvc/mips_sprite/install\n"
pushenv
pushenvvar CC_FOR_BUILD gcc
pushenvvar CXX_FOR_BUILD g++
pushenvvar CC i586-mingw32msvc-gcc
...
echo "----------------# task [193/209] /i586-mingw32msvc/sprite/configure\n"
pushenv
pushenvvar CC_FOR_BUILD gcc
pushenvvar CXX_FOR_BUILD g++
pushenvvar CC i586-mingw32msvc-gcc
...
pushenv
pushenv
rm -rf $WORKPATH/obj/sprite-2012.09-98-mips-sde-elf-i586-mingw32msvc
mkdir -p $WORKPATH/obj/sprite-2012.09-98-mips-sde-elf-i586-mingw32msvc
pushd $WORKPATH/obj/sprite-2012.09-98-mips-sde-elf-i586-mingw32msvc
check_mentor_trademarks $WORKPATH/src/sprite-2012.09 --prefix=$WORKPATH/install --build=i686-pc-linux-gnu --target=mips-sde-elf --host=i586-mingw32msvc '--with-pkgversion=Ingenic 2015.02' --enable-backends=mdimips --disable-nls --with-gdil=$WORKPATH/obj/pkg-2012.09-98-mips-sde-elf/mips-2012.09-98-mips-sde-elf.extras/host-libs-i586-mingw32msvc/usr --with-expat=$WORKPATH/obj/pkg-2012.09-98-mips-sde-elf/mips-2012.09-98-mips-sde-elf.extras/host-libs-i586-mingw32msvc/usr --with-boards=$WORKPATH/obj/pkg-2012.09-98-mips-sde-elf/mips-2012.09-98-mips-sde-elf.extras/cs3/boards --with-edge-utils=$WORKPATH/obj/pkg-2012.09-98-mips-sde-elf/mips-2012.09-98-mips-sde-elf.extras/edge-utils-i586-mingw32msvc --with-mep_cs=
popd
popenv
popenv
popenv

echo "----------------# task [194/209] /i586-mingw32msvc/sprite/build\n"
pushenv
pushenvvar CC_FOR_BUILD gcc
pushenvvar CXX_FOR_BUILD g++
pushenvvar CC i586-mingw32msvc-gcc
...
echo "----------------# task [195/209] /i586-mingw32msvc/sprite/install\n"
pushenv
pushenvvar CC_FOR_BUILD gcc
pushenvvar CXX_FOR_BUILD g++
pushenvvar CC i586-mingw32msvc-gcc
...
echo "----------------# task [196/209] /i586-mingw32msvc/pretidy_installation\n"
pushenv
pushenvvar CC_FOR_BUILD gcc
pushenvvar CXX_FOR_BUILD g++
pushenvvar CC i586-mingw32msvc-gcc
...
echo "----------------# task [197/209] /i586-mingw32msvc/remove_libtool_archives\n"
pushenv
pushenvvar CC_FOR_BUILD gcc
pushenvvar CXX_FOR_BUILD g++
pushenvvar CC i586-mingw32msvc-gcc
...
pushenvvar RANLIB i586-mingw32msvc-ranlib
prepend_path PATH $WORKPATH/obj/tools-i686-pc-linux-gnu-2012.09-98-mips-sde-elf-i586-mingw32msvc/bin
find $WORKPATH/install/host-i586-mingw32msvc -name '*.la' -exec rm '{}' ';'
popenv

echo "----------------# task [198/209] /i586-mingw32msvc/remove_copied_libs\n"
pushenv
pushenvvar CC_FOR_BUILD gcc
pushenvvar CXX_FOR_BUILD g++
pushenvvar CC i586-mingw32msvc-gcc
...
echo "----------------# task [199/209] /i586-mingw32msvc/remove_fixed_headers\n"
pushenv
pushenvvar CC_FOR_BUILD gcc
pushenvvar CXX_FOR_BUILD g++
pushenvvar CC i586-mingw32msvc-gcc
...
pushenvvar RANLIB i586-mingw32msvc-ranlib
prepend_path PATH $WORKPATH/obj/tools-i686-pc-linux-gnu-2012.09-98-mips-sde-elf-i586-mingw32msvc/bin
pushd $WORKPATH/install/host-i586-mingw32msvc/lib/gcc/mips-sde-elf/4.7.2/include-fixed
popd
popenv

echo "----------------# task [200/209] /i586-mingw32msvc/add_tooldir_readme\n"
pushenv
pushenvvar CC_FOR_BUILD gcc
pushenvvar CXX_FOR_BUILD g++
pushenvvar CC i586-mingw32msvc-gcc
...
pushenvvar RANLIB i586-mingw32msvc-ranlib
prepend_path PATH $WORKPATH/obj/tools-i686-pc-linux-gnu-2012.09-98-mips-sde-elf-i586-mingw32msvc/bin
cat > $WORKPATH/install/host-i586-mingw32msvc/mips-sde-elf/bin/README.txt <<'EOF0'
The executables in this directory are for internal use by the compiler
and may not operate correctly when used directly.  This directory
should not be placed on your PATH.  Instead, you should use the
executables in ../../bin/ and place that directory on your PATH.
...
echo "----------------# task [201/209] /i586-mingw32msvc/strip_host_objects\n"
pushenv
pushenvvar CC_FOR_BUILD gcc
pushenvvar CXX_FOR_BUILD g++
pushenvvar CC i586-mingw32msvc-gcc
...
pushenvvar RANLIB i586-mingw32msvc-ranlib
prepend_path PATH $WORKPATH/obj/tools-i686-pc-linux-gnu-2012.09-98-mips-sde-elf-i586-mingw32msvc/bin
# i586-mingw32msvc-strip $WORKPATH/install/host-i586-mingw32msvc/bin/cs-make.exe
# i586-mingw32msvc-strip $WORKPATH/install/host-i586-mingw32msvc/bin/cs-rm.exe
i586-mingw32msvc-strip $WORKPATH/install/host-i586-mingw32msvc/bin/mips-sde-elf-addr2line.exe
i586-mingw32msvc-strip $WORKPATH/install/host-i586-mingw32msvc/bin/mips-sde-elf-ar.exe
i586-mingw32msvc-strip $WORKPATH/install/host-i586-mingw32msvc/bin/mips-sde-elf-as.exe
i586-mingw32msvc-strip $WORKPATH/install/host-i586-mingw32msvc/bin/mips-sde-elf-c++.exe
i586-mingw32msvc-strip $WORKPATH/install/host-i586-mingw32msvc/bin/mips-sde-elf-c++filt.exe
# i586-mingw32msvc-strip $WORKPATH/install/host-i586-mingw32msvc/bin/mips-sde-elf-conv.exe
i586-mingw32msvc-strip $WORKPATH/install/host-i586-mingw32msvc/bin/mips-sde-elf-cpp.exe
i586-mingw32msvc-strip $WORKPATH/install/host-i586-mingw32msvc/bin/mips-sde-elf-elfedit.exe
i586-mingw32msvc-strip $WORKPATH/install/host-i586-mingw32msvc/bin/mips-sde-elf-g++.exe
i586-mingw32msvc-strip $WORKPATH/install/host-i586-mingw32msvc/bin/mips-sde-elf-gcc-4.7.2.exe
i586-mingw32msvc-strip $WORKPATH/install/host-i586-mingw32msvc/bin/mips-sde-elf-gcc-ar.exe
i586-mingw32msvc-strip $WORKPATH/install/host-i586-mingw32msvc/bin/mips-sde-elf-gcc-nm.exe
i586-mingw32msvc-strip $WORKPATH/install/host-i586-mingw32msvc/bin/mips-sde-elf-gcc-ranlib.exe
i586-mingw32msvc-strip $WORKPATH/install/host-i586-mingw32msvc/bin/mips-sde-elf-gcc.exe
i586-mingw32msvc-strip $WORKPATH/install/host-i586-mingw32msvc/bin/mips-sde-elf-gcov.exe
i586-mingw32msvc-strip $WORKPATH/install/host-i586-mingw32msvc/bin/mips-sde-elf-gdb.exe
i586-mingw32msvc-strip $WORKPATH/install/host-i586-mingw32msvc/bin/mips-sde-elf-gprof.exe
i586-mingw32msvc-strip $WORKPATH/install/host-i586-mingw32msvc/bin/mips-sde-elf-ld.exe
i586-mingw32msvc-strip $WORKPATH/install/host-i586-mingw32msvc/bin/mips-sde-elf-nm.exe
i586-mingw32msvc-strip $WORKPATH/install/host-i586-mingw32msvc/bin/mips-sde-elf-objcopy.exe
i586-mingw32msvc-strip $WORKPATH/install/host-i586-mingw32msvc/bin/mips-sde-elf-objdump.exe
i586-mingw32msvc-strip $WORKPATH/install/host-i586-mingw32msvc/bin/mips-sde-elf-ranlib.exe
i586-mingw32msvc-strip $WORKPATH/install/host-i586-mingw32msvc/bin/mips-sde-elf-readelf.exe
i586-mingw32msvc-strip $WORKPATH/install/host-i586-mingw32msvc/bin/mips-sde-elf-run.exe
i586-mingw32msvc-strip $WORKPATH/install/host-i586-mingw32msvc/bin/mips-sde-elf-size.exe
# i586-mingw32msvc-strip $WORKPATH/install/host-i586-mingw32msvc/bin/mips-sde-elf-sprite.exe
i586-mingw32msvc-strip $WORKPATH/install/host-i586-mingw32msvc/bin/mips-sde-elf-strings.exe
# i586-mingw32msvc-strip $WORKPATH/install/host-i586-mingw32msvc/bin/mips-sde-elf-strip.exe
i586-mingw32msvc-strip $WORKPATH/install/host-i586-mingw32msvc/mips-sde-elf/bin/ar.exe
i586-mingw32msvc-strip $WORKPATH/install/host-i586-mingw32msvc/mips-sde-elf/bin/as.exe
i586-mingw32msvc-strip $WORKPATH/install/host-i586-mingw32msvc/mips-sde-elf/bin/c++.exe
i586-mingw32msvc-strip $WORKPATH/install/host-i586-mingw32msvc/mips-sde-elf/bin/g++.exe
i586-mingw32msvc-strip $WORKPATH/install/host-i586-mingw32msvc/mips-sde-elf/bin/gcc.exe
i586-mingw32msvc-strip $WORKPATH/install/host-i586-mingw32msvc/mips-sde-elf/bin/ld.exe
i586-mingw32msvc-strip $WORKPATH/install/host-i586-mingw32msvc/mips-sde-elf/bin/nm.exe
i586-mingw32msvc-strip $WORKPATH/install/host-i586-mingw32msvc/mips-sde-elf/bin/objcopy.exe
i586-mingw32msvc-strip $WORKPATH/install/host-i586-mingw32msvc/mips-sde-elf/bin/objdump.exe
i586-mingw32msvc-strip $WORKPATH/install/host-i586-mingw32msvc/mips-sde-elf/bin/ranlib.exe
i586-mingw32msvc-strip $WORKPATH/install/host-i586-mingw32msvc/mips-sde-elf/bin/strip.exe
i586-mingw32msvc-strip $WORKPATH/install/host-i586-mingw32msvc/libexec/gcc/mips-sde-elf/4.7.2/cc1.exe
i586-mingw32msvc-strip $WORKPATH/install/host-i586-mingw32msvc/libexec/gcc/mips-sde-elf/4.7.2/collect2.exe
i586-mingw32msvc-strip $WORKPATH/install/host-i586-mingw32msvc/libexec/gcc/mips-sde-elf/4.7.2/install-tools/fixincl.exe
i586-mingw32msvc-strip $WORKPATH/install/host-i586-mingw32msvc/libexec/gcc/mips-sde-elf/4.7.2/cc1plus.exe
i586-mingw32msvc-strip $WORKPATH/install/host-i586-mingw32msvc/libexec/gcc/mips-sde-elf/4.7.2/lto-wrapper.exe
i586-mingw32msvc-strip $WORKPATH/install/host-i586-mingw32msvc/libexec/gcc/mips-sde-elf/4.7.2/lto1.exe
popenv

echo "----------------# task [202/209] /i586-mingw32msvc/package_tbz2\n"
pushenv
pushenvvar CC_FOR_BUILD gcc
pushenvvar CXX_FOR_BUILD g++
pushenvvar CC i586-mingw32msvc-gcc
...
pushenvvar RANLIB i586-mingw32msvc-ranlib
prepend_path PATH $WORKPATH/obj/tools-i686-pc-linux-gnu-2012.09-98-mips-sde-elf-i586-mingw32msvc/bin
rm -f $WORKPATH/pkg/mips-2012.09-98-mips-sde-elf-i586-mingw32msvc.tar.bz2
pushd $WORKPATH/install/host-i586-mingw32msvc
popd
pushd $WORKPATH/obj
rm -f mips-2012.09
ln -s $WORKPATH/install/host-i586-mingw32msvc mips-2012.09
# tar cjf $WORKPATH/pkg/mips-2012.09-98-mips-sde-elf-i586-mingw32msvc.tar.bz2 --owner=0 --group=0 --exclude=host-i686-pc-linux-gnu --exclude=host-i586-mingw32msvc mips-2012.09/bin mips-2012.09/i586-mingw32msvc mips-2012.09/lib mips-2012.09/libexec mips-2012.09/mips-sde-elf mips-2012.09/share
tar cjf $WORKPATH/pkg/mips-2012.09-98-mips-sde-elf-i586-mingw32msvc.tar.bz2 --owner=0 --group=0 --exclude=host-i686-pc-linux-gnu --exclude=host-i586-mingw32msvc mips-2012.09/bin mips-2012.09/lib mips-2012.09/libexec mips-2012.09/mips-sde-elf mips-2012.09/share
rm -f mips-2012.09
popd
popenv

if [ "" == "x" ];then # Don't compile
echo "----------------# task [203/209] /i586-mingw32msvc/package_installanywhere/unpack\n"
pushenv
pushenvvar CC_FOR_BUILD gcc
pushenvvar CXX_FOR_BUILD g++
pushenvvar CC i586-mingw32msvc-gcc
...
pushenvvar RANLIB i586-mingw32msvc-ranlib
prepend_path PATH $WORKPATH/obj/tools-i686-pc-linux-gnu-2012.09-98-mips-sde-elf-i586-mingw32msvc/bin
$WORKPATH/src/scripts-trunk/gnu-ia-unpack -i $WORKPATH/install/host-i586-mingw32msvc -l $WORKPATH/logs -o $WORKPATH/obj -p $WORKPATH/pkg -s $WORKPATH/src -T $WORKPATH/testlogs -h i586-mingw32msvc -e $WORKPATH/obj/pkg-2012.09-98-mips-sde-elf/mips-2012.09-98-mips-sde-elf.extras sgxx/2012.09/mips-sde-elf-lite
popenv

echo "----------------# task [204/209] /i586-mingw32msvc/package_installanywhere/merge_modules\n"
pushenv
pushenvvar CC_FOR_BUILD gcc
pushenvvar CXX_FOR_BUILD g++
pushenvvar CC i586-mingw32msvc-gcc
...
pushenvvar RANLIB i586-mingw32msvc-ranlib
prepend_path PATH $WORKPATH/obj/tools-i686-pc-linux-gnu-2012.09-98-mips-sde-elf-i586-mingw32msvc/bin
$WORKPATH/src/scripts-trunk/gnu-ia-helper-mm -i $WORKPATH/install/host-i586-mingw32msvc -l $WORKPATH/logs -o $WORKPATH/obj -p $WORKPATH/pkg -s $WORKPATH/src -T $WORKPATH/testlogs -h i586-mingw32msvc -m iamm-common sgxx/2012.09/mips-sde-elf-lite
$WORKPATH/src/scripts-trunk/gnu-ia-helper-mm -i $WORKPATH/install/host-i586-mingw32msvc -l $WORKPATH/logs -o $WORKPATH/obj -p $WORKPATH/pkg -s $WORKPATH/src -T $WORKPATH/testlogs -h i586-mingw32msvc -m iamm-jvm sgxx/2012.09/mips-sde-elf-lite
popenv

echo "----------------# task [205/209] /i586-mingw32msvc/package_installanywhere/installer\n"
pushenv
pushenvvar CC_FOR_BUILD gcc
pushenvvar CXX_FOR_BUILD g++
pushenvvar CC i586-mingw32msvc-gcc
...
pushenvvar RANLIB i586-mingw32msvc-ranlib
prepend_path PATH $WORKPATH/obj/tools-i686-pc-linux-gnu-2012.09-98-mips-sde-elf-i586-mingw32msvc/bin
$WORKPATH/src/scripts-trunk/gnu-ia-helper -i $WORKPATH/install/host-i586-mingw32msvc -l $WORKPATH/logs -o $WORKPATH/obj -p $WORKPATH/pkg -s $WORKPATH/src -T $WORKPATH/testlogs -h i586-mingw32msvc -f $WORKPATH/obj/pkg-2012.09-98-mips-sde-elf/mips-2012.09-98-mips-sde-elf.extras/getting_started/license.html -e $WORKPATH/obj/pkg-2012.09-98-mips-sde-elf/mips-2012.09-98-mips-sde-elf.extras sgxx/2012.09/mips-sde-elf-lite
popenv
fi # end 203
...
cp $WORKPATH/Jz-special/Jz-mxu/jzmedia.h $WORKPATH/install/host-i586-mingw32msvc/mips-sde-elf/include
cp $WORKPATH/Jz-special/Jz-mxu128/jzmxu128.h $WORKPATH/install/host-i586-mingw32msvc/mips-sde-elf/include
