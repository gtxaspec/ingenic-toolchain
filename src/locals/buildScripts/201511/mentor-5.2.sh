...
#build mfp64 default with mnan=2008
...
check_mentor_trademarks ${local_path}/src/gcc-5-2015.11 --build=i686-pc-linux-gnu --host=i686-pc-linux-gnu --target=mips-linux-gnu --enable-threads --disable-libmudflap --disable-libssp --disable-libstdcxx-pch --with-arch-32=mips32r2 --with-arch-64=mips64r2 --with-float=hard --with-mips-plt --enable-extra-sgxxlite-multilibs --with-gnu-as --with-gnu-ld '--with-specs=-D__CS_SOURCERYGXX_MAJ__=2015 -D__CS_SOURCERYGXX_MIN__=11 -D__CS_SOURCERYGXX_REV__=32' --enable-languages=c,c++,fortran --enable-shared --enable-lto --enable-symvers=gnu --enable-__cxa_atexit --with-glibc-version=2.22 '--with-pkgversion=Ingenic 2016.03-32'  --disable-nls --prefix=${local_path}/install/opt/codesourcery --with-sysroot=${local_path}/install/opt/codesourcery/mips-linux-gnu/libc --with-build-sysroot=${local_path}/install/opt/codesourcery/mips-linux-gnu/libc --with-gmp=${local_path}/obj/pkg-2015.11-32-mips-linux-gnu/mips-2015.11-32-mips-linux-gnu.extras/host-libs-i686-pc-linux-gnu/usr --with-mpfr=${local_path}/obj/pkg-2015.11-32-mips-linux-gnu/mips-2015.11-32-mips-linux-gnu.extras/host-libs-i686-pc-linux-gnu/usr --with-mpc=${local_path}/obj/pkg-2015.11-32-mips-linux-gnu/mips-2015.11-32-mips-linux-gnu.extras/host-libs-i686-pc-linux-gnu/usr --with-isl=${local_path}/obj/pkg-2015.11-32-mips-linux-gnu/mips-2015.11-32-mips-linux-gnu.extras/host-libs-i686-pc-linux-gnu/usr --enable-libgomp --disable-libitm --enable-libatomic --disable-libssp --disable-libcc1 --enable-poison-system-directories --with-python-dir=mips-linux-gnu/share/gdb/python --with-build-time-tools=${local_path}/install/opt/codesourcery/mips-linux-gnu/bin --with-build-time-tools=${local_path}/install/opt/codesourcery/mips-linux-gnu/bin SED=sed
popd
popenv
popenv
...
pushenvvar RANLIB 'ranlib '
prepend_path PATH ${local_path}/install/opt/codesourcery/bin
pushd ${local_path}/install/opt/codesourcery/lib/gcc/mips-linux-gnu/5.2.0/include-fixed
popd
popenv
...
strip ${local_path}/install/opt/codesourcery/bin/mips-linux-gnu-gcc-5.2.0
...
#strip2 ${local_path}/install/opt/codesourcery/bin/mips-linux-gnu-qemu-el
...
strip ${local_path}/install/opt/codesourcery/libexec/gcc/mips-linux-gnu/5.2.0/cc1
strip ${local_path}/install/opt/codesourcery/libexec/gcc/mips-linux-gnu/5.2.0/collect2
strip ${local_path}/install/opt/codesourcery/libexec/gcc/mips-linux-gnu/5.2.0/install-tools/fixincl
strip ${local_path}/install/opt/codesourcery/libexec/gcc/mips-linux-gnu/5.2.0/plugin/gengtype
strip ${local_path}/install/opt/codesourcery/libexec/gcc/mips-linux-gnu/5.2.0/cc1plus
strip ${local_path}/install/opt/codesourcery/libexec/gcc/mips-linux-gnu/5.2.0/lto-wrapper
strip ${local_path}/install/opt/codesourcery/libexec/gcc/mips-linux-gnu/5.2.0/lto1
strip ${local_path}/install/opt/codesourcery/libexec/gcc/mips-linux-gnu/5.2.0/liblto_plugin.so
strip ${local_path}/install/opt/codesourcery/libexec/gcc/mips-linux-gnu/5.2.0/f951
popenv
...
mips-linux-gnu-objcopy ${remove_sections} ${local_path}/install/opt/codesourcery/mips-linux-gnu/libc/uclibc/${sysn}/lib/ld-uClibc-0.9.30.so || true
mips-linux-gnu-objcopy ${remove_sections} ${local_path}/install/opt/codesourcery/mips-linux-gnu/libc/uclibc/${sysn}/lib/libuClibc-0.9.30.so || true
mips-linux-gnu-objcopy ${remove_sections} ${local_path}/install/opt/codesourcery/mips-linux-gnu/libc/uclibc/${sysn}/lib/libcrypt-0.9.30.so || true
mips-linux-gnu-objcopy ${remove_sections} ${local_path}/install/opt/codesourcery/mips-linux-gnu/libc/uclibc/${sysn}/lib/libutil-0.9.30.so || true
mips-linux-gnu-objcopy ${remove_sections} ${local_path}/install/opt/codesourcery/mips-linux-gnu/libc/uclibc/${sysn}/lib/libthread_db-0.9.30.so || true
mips-linux-gnu-objcopy ${remove_sections} ${local_path}/install/opt/codesourcery/mips-linux-gnu/libc/uclibc/${sysn}/lib/libnsl-0.9.30.so || true
...
mips-linux-gnu-objcopy ${remove_sections} ${local_path}/install/opt/codesourcery/mips-linux-gnu/libc/uclibc/${sysn}/lib/librt-0.9.30.so || true
mips-linux-gnu-objcopy ${remove_sections} ${local_path}/install/opt/codesourcery/mips-linux-gnu/libc/uclibc/${sysn}/lib/libm-0.9.30.so || true
mips-linux-gnu-objcopy ${remove_sections} ${local_path}/install/opt/codesourcery/mips-linux-gnu/libc/uclibc/${sysn}/lib/libpthread-0.9.30.so || true
mips-linux-gnu-objcopy ${remove_sections} ${local_path}/install/opt/codesourcery/mips-linux-gnu/libc/uclibc/${sysn}/lib/libresolv-0.9.30.so || true
mips-linux-gnu-objcopy ${remove_sections} ${local_path}/install/opt/codesourcery/mips-linux-gnu/libc/uclibc/${sysn}/lib/libdl-0.9.30.so || true
...
mips-linux-gnu-objcopy ${remove_sections} ${local_path}/install/opt/codesourcery/lib/gcc/mips-linux-gnu/5.2.0/${muln}/libgcov.a || true
mips-linux-gnu-objcopy ${remove_sections} ${local_path}/install/opt/codesourcery/lib/gcc/mips-linux-gnu/5.2.0/${muln}/crtend.o || true
mips-linux-gnu-objcopy ${remove_sections} ${local_path}/install/opt/codesourcery/lib/gcc/mips-linux-gnu/5.2.0/${muln}/libgcc_eh.a || true
mips-linux-gnu-objcopy ${remove_sections} ${local_path}/install/opt/codesourcery/lib/gcc/mips-linux-gnu/5.2.0/${muln}/crtendS.o || true
mips-linux-gnu-objcopy ${remove_sections} ${local_path}/install/opt/codesourcery/lib/gcc/mips-linux-gnu/5.2.0/${muln}/crtbegin.o || true
mips-linux-gnu-objcopy ${remove_sections} ${local_path}/install/opt/codesourcery/lib/gcc/mips-linux-gnu/5.2.0/${muln}/crtfastmath.o || true
mips-linux-gnu-objcopy ${remove_sections} ${local_path}/install/opt/codesourcery/lib/gcc/mips-linux-gnu/5.2.0/${muln}/crtbeginS.o || true
mips-linux-gnu-objcopy ${remove_sections} ${local_path}/install/opt/codesourcery/lib/gcc/mips-linux-gnu/5.2.0/${muln}/libgcc.a || true
mips-linux-gnu-objcopy ${remove_sections} ${local_path}/install/opt/codesourcery/lib/gcc/mips-linux-gnu/5.2.0/${muln}/crtbeginT.o || true
mips-linux-gnu-objcopy ${remove_sections} ${local_path}/install/opt/codesourcery/lib/gcc/mips-linux-gnu/5.2.0/uclibc/${muln}/libgcov.a || true
mips-linux-gnu-objcopy ${remove_sections} ${local_path}/install/opt/codesourcery/lib/gcc/mips-linux-gnu/5.2.0/uclibc/${muln}/crtend.o || true
mips-linux-gnu-objcopy ${remove_sections} ${local_path}/install/opt/codesourcery/lib/gcc/mips-linux-gnu/5.2.0/uclibc/${muln}/libgcc_eh.a || true
mips-linux-gnu-objcopy ${remove_sections} ${local_path}/install/opt/codesourcery/lib/gcc/mips-linux-gnu/5.2.0/uclibc/${muln}/crtendS.o || true
mips-linux-gnu-objcopy ${remove_sections} ${local_path}/install/opt/codesourcery/lib/gcc/mips-linux-gnu/5.2.0/uclibc/${muln}/crtbegin.o || true
mips-linux-gnu-objcopy ${remove_sections} ${local_path}/install/opt/codesourcery/lib/gcc/mips-linux-gnu/5.2.0/uclibc/${muln}/crtfastmath.o || true
mips-linux-gnu-objcopy ${remove_sections} ${local_path}/install/opt/codesourcery/lib/gcc/mips-linux-gnu/5.2.0/uclibc/${muln}/crtbeginS.o || true
mips-linux-gnu-objcopy ${remove_sections} ${local_path}/install/opt/codesourcery/lib/gcc/mips-linux-gnu/5.2.0/uclibc/${muln}/libgcc.a || true
mips-linux-gnu-objcopy ${remove_sections} ${local_path}/install/opt/codesourcery/lib/gcc/mips-linux-gnu/5.2.0/uclibc/${muln}/crtbeginT.o || true
done
popenv
...
pushenvvar AS 'as '
pushenvvar RANLIB 'ranlib '
pushd ${local_path}/install/opt/codesourcery/share
rm doc/ -rf
rm man/ -rf
popd
popenv
