export PATH=/home/toolchains/r2.1/install/bin:$PATH
export DEJAGNU=/home/toolchains/dejagnu-r2.1/site.exp


make -j4 -k -w check RUNTESTFLAGS="--target_board jz-cs-4.7.2-mips-gcc-sshscp -v -v"
