...
/* { dg-final { scan-assembler-times "msa_fcmul_w.*:.*fcmul\\.w.*msa_fcmul_w" 1 } } */
/* { dg-final { scan-assembler-times "msa_fexuplc_w.*:.*fexuplc\\.w.*msa_fexuplc_w" 1 } } */
/* { dg-final { scan-assembler-times "msa_fexuprc_w.*:.*fexuprc\\.w.*msa_fexuprc_w" 1 } } */
/* { dg-final { scan-assembler-times "msa_ldinss_w.*:.*ldinss\\.w.*msa_ldinss_w" 1 } } */
/* { dg-final { scan-assembler-times "msa_ldinssu_w.*:.*ldinssu\\.w.*msa_ldinssu_w" 1 } } */
/* { dg-final { scan-assembler-times "msa_ldinssu2_w.*:.*ldinssu2\\.w.*msa_ldinssu2_w" 1 } } */
/* { dg-final { scan-assembler-times "msa_ldins_w.*:.*ldins\\.w.*msa_ldins_w" 1 } } */
/* { dg-final { scan-assembler-times "msa_ldins_d.*:.*ldins\\.d.*msa_ldins_d" 1 } } */
/* { dg-final { scan-assembler-times "msa_stext_w.*:.*stext\\.w.*msa_stext_w" 1 } } */
/* { dg-final { scan-assembler-times "msa_stext_d.*:.*stext\\.d.*msa_stext_d" 1 } } */
/* { dg-final { scan-assembler-times "msa_ldinsu_w.*:.*ldinsu\\.w.*msa_ldinsu_w" 1 } } */
/* { dg-final { scan-assembler-times "msa_ldinsu_d.*:.*ldinsu\\.d.*msa_ldinsu_d" 1 } } */
/* { dg-final { scan-assembler-times "msa_stextu_w.*:.*stextu\\.w.*msa_stextu_w" 1 } } */
/* { dg-final { scan-assembler-times "msa_stextu_d.*:.*stextu\\.d.*msa_stextu_d" 1 } } */
/* { dg-final { scan-assembler-times "msa_vshfr_b.*:.*vshfr\\.b.*msa_vshfr_b" 1 } } */
/* { dg-final { scan-assembler-times "msa_vsldi_b.*:.*vsldi\\.b.*msa_vsldi_b" 1 } } */
/* { dg-final { scan-assembler-times "msa_bmr_b.*:.*bmr\\.v.*msa_bmr_b" 1 } } */
/* { dg-final { scan-assembler-times "msa_pcntv_b.*:.*pcnt\\.v.*msa_pcntv_b" 1 } } */
/* { dg-final { scan-assembler-times "msa_bext_b.*:.*bext\\.b.*msa_bext_b" 1 } } */
/* { dg-final { scan-assembler-times "msa_bext_h.*:.*bext\\.h.*msa_bext_h" 1 } } */
/* { dg-final { scan-assembler-times "msa_bext_w.*:.*bext\\.w.*msa_bext_w" 1 } } */
/* { dg-final { scan-assembler-times "msa_bexp_b.*:.*bexp\\.b.*msa_bexp_b" 1 } } */
/* { dg-final { scan-assembler-times "msa_bexp_h.*:.*bexp\\.h.*msa_bexp_h" 1 } } */
/* { dg-final { scan-assembler-times "msa_bexp_w.*:.*bexp\\.w.*msa_bexp_w" 1 } } */
/* { dg-final { scan-assembler-times "msa_bexp_2b.*:.*bexp\\.2b.*msa_bexp_2b" 1 } } */
/* { dg-final { scan-assembler-times "msa_bexp_4b.*:.*bexp\\.4b.*msa_bexp_4b" 1 } } */
/* { dg-final { scan-assembler-times "msa_bmu_b.*:.*bmu\\.v.*msa_bmu_b" 1 } } */
/* { dg-final { scan-assembler-times "msa_sllv_b.*:.*sll\\.v.*msa_sllv_b" 1 } } */
/* { dg-final { scan-assembler-times "msa_slliv_b.*:.*slli\\.v.*msa_slliv_b" 1 } } */
/* { dg-final { scan-assembler-times "msa_srlv_b.*:.*srl\\.v.*msa_srlv_b" 1 } } */
/* { dg-final { scan-assembler-times "msa_srliv_b.*:.*srli\\.v.*msa_srliv_b" 1 } } */
/* { dg-final { scan-assembler-times "msa_srliv_b.*:.*srli\\.v.*msa_srliv_b" 1 } } */
/* { dg-final { scan-assembler-times "msa_movew_w.*:.*move\\.w.*msa_movew_w" 1 } } */
/* { dg-final { scan-assembler-times "msa_movbt_b.*:.*movbt\\.b.*msa_movbt_b" 1 } } */
/* { dg-final { scan-assembler-times "msa_movbp_b.*:.*movbp\\.b.*msa_movbp_b" 1 } } */
/* { dg-final { scan-assembler-times "msa_satss_b.*:.*satss\\.b.*msa_satss_b" 1 } } */
/* { dg-final { scan-assembler-times "msa_satss_h.*:.*satss\\.h.*msa_satss_h" 1 } } */
/* { dg-final { scan-assembler-times "msa_satuu_b.*:.*satuu\\.b.*msa_satuu_b" 1 } } */
/* { dg-final { scan-assembler-times "msa_satuu_h.*:.*satuu\\.h.*msa_satuu_h" 1 } } */
/* { dg-final { scan-assembler-times "msa_satus_b.*:.*satus\\.b.*msa_satus_b" 1 } } */
/* { dg-final { scan-assembler-times "msa_satus_h.*:.*satus\\.h.*msa_satus_h" 1 } } */
/* { dg-final { scan-assembler-times "msa_addsl_h.*:.*addsl\\.h.*msa_addsl_h" 1 } } */
/* { dg-final { scan-assembler-times "msa_addsl_w.*:.*addsl\\.w.*msa_addsl_w" 1 } } */
/* { dg-final { scan-assembler-times "msa_addsr_h.*:.*addsr\\.h.*msa_addsr_h" 1 } } */
/* { dg-final { scan-assembler-times "msa_addsr_w.*:.*addsr\\.w.*msa_addsr_w" 1 } } */
/* { dg-final { scan-assembler-times "msa_addul_h.*:.*addul\\.h.*msa_addul_h" 1 } } */
/* { dg-final { scan-assembler-times "msa_addul_w.*:.*addul\\.w.*msa_addul_w" 1 } } */
/* { dg-final { scan-assembler-times "msa_addur_h.*:.*addur\\.h.*msa_addur_h" 1 } } */
/* { dg-final { scan-assembler-times "msa_addur_w.*:.*addur\\.w.*msa_addur_w" 1 } } */
/* { dg-final { scan-assembler-times "msa_accsl_h.*:.*accsl\\.h.*msa_accsl_h" 1 } } */
/* { dg-final { scan-assembler-times "msa_accsl_w.*:.*accsl\\.w.*msa_accsl_w" 1 } } */
/* { dg-final { scan-assembler-times "msa_accsr_h.*:.*accsr\\.h.*msa_accsr_h" 1 } } */
/* { dg-final { scan-assembler-times "msa_accsr_w.*:.*accsr\\.w.*msa_accsr_w" 1 } } */
/* { dg-final { scan-assembler-times "msa_accul_h.*:.*accul\\.h.*msa_accul_h" 1 } } */
/* { dg-final { scan-assembler-times "msa_accul_w.*:.*accul\\.w.*msa_accul_w" 1 } } */
/* { dg-final { scan-assembler-times "msa_accur_h.*:.*accur\\.h.*msa_accur_h" 1 } } */
/* { dg-final { scan-assembler-times "msa_accur_w.*:.*accur\\.w.*msa_accur_w" 1 } } */
/* { dg-final { scan-assembler-times "msa_subsl_h.*:.*subsl\\.h.*msa_subsl_h" 1 } } */
/* { dg-final { scan-assembler-times "msa_subsl_w.*:.*subsl\\.w.*msa_subsl_w" 1 } } */
/* { dg-final { scan-assembler-times "msa_subsr_h.*:.*subsr\\.h.*msa_subsr_h" 1 } } */
/* { dg-final { scan-assembler-times "msa_subsr_w.*:.*subsr\\.w.*msa_subsr_w" 1 } } */
/* { dg-final { scan-assembler-times "msa_subul_h.*:.*subul\\.h.*msa_subul_h" 1 } } */
/* { dg-final { scan-assembler-times "msa_subul_w.*:.*subul\\.w.*msa_subul_w" 1 } } */
/* { dg-final { scan-assembler-times "msa_subur_h.*:.*subur\\.h.*msa_subur_h" 1 } } */
/* { dg-final { scan-assembler-times "msa_subur_w.*:.*subur\\.w.*msa_subur_w" 1 } } */
/* { dg-final { scan-assembler-times "msa_mulsl_h.*:.*mulsl\\.h.*msa_mulsl_h" 1 } } */
/* { dg-final { scan-assembler-times "msa_mulsl_w.*:.*mulsl\\.w.*msa_mulsl_w" 1 } } */
/* { dg-final { scan-assembler-times "msa_mulsr_h.*:.*mulsr\\.h.*msa_mulsr_h" 1 } } */
/* { dg-final { scan-assembler-times "msa_mulsr_w.*:.*mulsr\\.w.*msa_mulsr_w" 1 } } */
/* { dg-final { scan-assembler-times "msa_mulul_h.*:.*mulul\\.h.*msa_mulul_h" 1 } } */
/* { dg-final { scan-assembler-times "msa_mulul_w.*:.*mulul\\.w.*msa_mulul_w" 1 } } */
/* { dg-final { scan-assembler-times "msa_mulur_h.*:.*mulur\\.h.*msa_mulur_h" 1 } } */
/* { dg-final { scan-assembler-times "msa_mulur_w.*:.*mulur\\.w.*msa_mulur_w" 1 } } */
...
/* Ingenic Xburst2 SIMD extension MXA Instructions. */
#define FCMUL(T) T FN(fcmul, T ## _DF) (T i, T j) { return __msa_fcmul_w(i, j);}
#define FEXUPLC(T1, T2, T3) T1 FN(fexuplc, T1 ## _DF)(T2 i, T3 j) { return __msa_fexuplc_w(i, j);}
#define FEXUPRC(T1, T2, T3) T1 FN(fexuprc, T1 ## _DF)(T2 i, T3 j) { return __msa_fexuprc_w(i, j);}
#define LDINSS(T, N) T FN(ldinss, T ## _DF) (T i, void *base, int offset) { return __msa_ldinss_w (i, N, base, offset); }
#define LDINSSU(T, N) T FN(ldinssu, T ## _DF) (T i, void *base, int offset) { return __msa_ldinssu_w (i, N, base, offset); }
#define LDINSSU2(T, N) T FN(ldinssu2, T ## _DF) (T i, void *base, int offset) { return __msa_ldinssu2_w (i, N, base, offset); }
#define LDINS(T, N) T FN(ldins, T ## _DF) (T i, void *base, int offset) { return BUILTIN(ldins, T ## _DF) (i, N, base, offset); }
#define LDINSU(T, N) T FN(ldinsu, T ## _DF) (T i, void *base, int offset) { return BUILTIN(ldinsu, T ## _DF) (i, N, base, offset); }
#define STEXT(T, N) void FN(stext, T ## _DF) (T i, void *base, int offset) { BUILTIN(stext, T ## _DF) (i, N, base, offset); }
/* #define STEXTU(T, N) void FN(stextu, T ## _DF) (T i, void *base, int offset) { BUILTIN(stextu, T ## _DF) (i, N, base, offset); } */
#define STEXTU(T, N) void FN(stextu, T ## _DF) (T i, void *base) { BUILTIN(stextu, T ## _DF) (i, N, base); }
#define VSHFR(T) T FN(vshfr, T ## _DF) (T i, T j, T k) { return __msa_vshfr_b(i, j, k);}
#define VSLDI(T, N) T FN(vsldi, T ## _DF) (T i, T j) { return __msa_vsldi_b(i, j, N);}
#define BMR(T) T FN(bmr, T ## _DF) (T i, T j, T k) { return __msa_bmr_v(i, j, k);}
#define PCNTV(T) T FN(pcntv, T ## _DF) (T i) { return __msa_pcnt_v(i);}
#define BEXT(T) T FN(bext, T ## _DF) (T i) { return BUILTIN(bext, T ## _DF)(i);}
#define BEXP(T) T FN(bexp, T ## _DF) (T i) {return BUILTIN(bexp, T ## _DF)(i);}
#define BEXP2B(T) T FN(bexp, 2b) (T i) {return __msa_bexp_2b(i);}
#define BEXP4B(T) T FN(bexp, 4b) (T i) {return __msa_bexp_4b(i);}
#define BMU(T) T FN(bmu, T ## _DF) (T i, T j, T k) { return __msa_bmu_v(i, j, k);}
#define SLLV(T) T FN(sllv, T ## _DF) (T i, T j) { return __msa_sll_v(i, j);}
#define SLLIV(T, N) T FN(slliv, T ## _DF) (T i, T j) { return __msa_slli_v(i, N);}
#define SRLV(T) T FN(srlv, T ## _DF) (T i, T j) { return __msa_srl_v(i, j);}
#define SRLIV(T, N) T FN(srliv, T ## _DF) (T i, T j) { return __msa_srli_v(i, N);}
#define MOVEW(T, M, N) T FN(movew, T ## _DF) (T i, T j) { return __msa_move_w(i, M, j, N);}
#define MOVBT(T) T FN(movbt, T ## _DF) (T i, T j) { return __msa_movbt_b(i, j);}
#define MOVBP(T) T FN(movbp, T ## _DF) (T i, T j) { return __msa_movbp_b(i, j);}
#define SATSS(T1, T2) T1 FN(satss, T1 ## _DF) (T2 i, T2 j) { return BUILTIN(satss, T1 ## _DF)(i, j);}
#define SATUU(T1, T2) T1 FN(satuu, T1 ## _DF) (T2 i, T2 j) { return BUILTIN(satuu, T1 ## _DF)(i, j);}
#define SATUS(T1, T2) T1 FN(satus, T1 ## _DF) (T2 i, T2 j) { return BUILTIN(satus, T1 ## _DF)(i, j);}
#define ADDSL(T1, T2) T1 FN(addsl, T1 ## _DF) (T2 i, T2 j) {return BUILTIN(addsl, T1 ## _DF)(i, j);}
#define ADDSR(T1, T2) T1 FN(addsr, T1 ## _DF) (T2 i, T2 j) {return BUILTIN(addsr, T1 ## _DF)(i, j);}
#define ADDUL(T1, T2) T1 FN(addul, T1 ## _DF) (T2 i, T2 j) {return BUILTIN(addul, T1 ## _DF)(i, j);}
#define ADDUR(T1, T2) T1 FN(addur, T1 ## _DF) (T2 i, T2 j) {return BUILTIN(addur, T1 ## _DF)(i, j);}
#define ACCSL(T1, T2) T1 FN(accsl, T1 ## _DF) (T1 i, T2 j) {return BUILTIN(accsl, T1 ## _DF)(i, j);}
#define ACCSR(T1, T2) T1 FN(accsr, T1 ## _DF) (T1 i, T2 j) {return BUILTIN(accsr, T1 ## _DF)(i, j);}
#define ACCUL(T1, T2) T1 FN(accul, T1 ## _DF) (T1 i, T2 j) {return BUILTIN(accul, T1 ## _DF)(i, j);}
#define ACCUR(T1, T2) T1 FN(accur, T1 ## _DF) (T1 i, T2 j) {return BUILTIN(accur, T1 ## _DF)(i, j);}
#define SUBSL(T1, T2) T1 FN(subsl, T1 ## _DF) (T2 i, T2 j) {return BUILTIN(subsl, T1 ## _DF)(i, j);}
#define SUBSR(T1, T2) T1 FN(subsr, T1 ## _DF) (T2 i, T2 j) {return BUILTIN(subsr, T1 ## _DF)(i, j);}
#define SUBUL(T1, T2) T1 FN(subul, T1 ## _DF) (T2 i, T2 j) {return BUILTIN(subul, T1 ## _DF)(i, j);}
#define SUBUR(T1, T2) T1 FN(subur, T1 ## _DF) (T2 i, T2 j) {return BUILTIN(subur, T1 ## _DF)(i, j);}
#define MULSL(T1, T2) T1 FN(mulsl, T1 ## _DF) (T2 i, T2 j) {return BUILTIN(mulsl, T1 ## _DF)(i, j);}
#define MULSR(T1, T2) T1 FN(mulsr, T1 ## _DF) (T2 i, T2 j) {return BUILTIN(mulsr, T1 ## _DF)(i, j);}
#define MULUL(T1, T2) T1 FN(mulul, T1 ## _DF) (T2 i, T2 j) {return BUILTIN(mulul, T1 ## _DF)(i, j);}
#define MULUR(T1, T2) T1 FN(mulur, T1 ## _DF) (T2 i, T2 j) {return BUILTIN(mulur, T1 ## _DF)(i, j);}
...
#define ITERATE_FOR_ALL_SIGNED_INT_VECTOR_TYPES_3(FUNC) \
  FUNC (v8i16, v16i8) \
  FUNC (v4i32, v8i16)

#define ITERATE_FOR_ALL_SIGNED_INT_VECTOR_TYPES_U3(FUNC) \
  FUNC (v8u16, v16u8) \
  FUNC (v4u32, v8u16)
...
STEXTU (v4i32, 3)
STEXTU (v2i64, 1)
FEXUPLC(v4f32, v8i16, v8i16)
FEXUPRC(v4f32, v8i16, v8i16)
PCNTV(v16i8)
BEXT(v16i8)
BEXT(v8i16)
BEXT(v4i32)
...
SATUS(v16u8, v8i16)
SATUS(v8u16, v4i32)
ITERATE_FOR_ALL_SIGNED_INT_VECTOR_TYPES_3(ADDSL)
ITERATE_FOR_ALL_SIGNED_INT_VECTOR_TYPES_3(ADDSR)
ITERATE_FOR_ALL_SIGNED_INT_VECTOR_TYPES_U3(ADDUL)
ITERATE_FOR_ALL_SIGNED_INT_VECTOR_TYPES_U3(ADDUR)
ITERATE_FOR_ALL_SIGNED_INT_VECTOR_TYPES_3(ACCSL)
ITERATE_FOR_ALL_SIGNED_INT_VECTOR_TYPES_3(ACCSR)
ITERATE_FOR_ALL_SIGNED_INT_VECTOR_TYPES_U3(ACCUL)
ITERATE_FOR_ALL_SIGNED_INT_VECTOR_TYPES_U3(ACCUR)
ITERATE_FOR_ALL_SIGNED_INT_VECTOR_TYPES_3(SUBSL)
ITERATE_FOR_ALL_SIGNED_INT_VECTOR_TYPES_3(SUBSR)
SUBUL(v8i16, v16u8)
SUBUL(v4i32, v8u16)
SUBUR(v8i16, v16u8)
SUBUR(v4i32, v8u16)
ITERATE_FOR_ALL_SIGNED_INT_VECTOR_TYPES_3(MULSL)
ITERATE_FOR_ALL_SIGNED_INT_VECTOR_TYPES_3(MULSR)
ITERATE_FOR_ALL_SIGNED_INT_VECTOR_TYPES_U3(MULUL)
ITERATE_FOR_ALL_SIGNED_INT_VECTOR_TYPES_U3(MULUR)
