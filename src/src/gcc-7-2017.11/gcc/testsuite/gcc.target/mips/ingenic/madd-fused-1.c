...
/* { dg-final { scan-assembler-not "madd.d" } } */
/* { dg-final { scan-assembler-not "msub.s" } } */
/* { dg-final { scan-assembler-not "msub.d" } } */
/* { dg-final { scan-assembler-not "fmaddw" } } */
/* { dg-final { scan-assembler-not "fmaddd" } } */
/* { dg-final { scan-assembler-not "fmsubw" } } */
/* { dg-final { scan-assembler-not "fmsubd" } } */
