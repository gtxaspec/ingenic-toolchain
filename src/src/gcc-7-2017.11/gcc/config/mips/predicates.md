...
(define_predicate "const_uimm0_operand"
  (and (match_code "const_int")
       (match_test "IN_RANGE (INTVAL (op), 0, 0)")))

(define_predicate "const_uimm1_operand"
  (and (match_code "const_int")
       (match_test "IN_RANGE (INTVAL (op), 0, 1)")))

(define_predicate "const_uimm2_operand"
  (and (match_code "const_int")
...
(define_predicate "const_uimm10_operand"
  (and (match_code "const_int")
...
(define_predicate "const_uimm16_operand"
  (and (match_code "const_int")
...
(define_predicate "const_imm6_operand"
  (and (match_code "const_int")
       (match_test "IN_RANGE (INTVAL (op), -32, 31)")))

(define_predicate "const_imm7_operand"
  (and (match_code "const_int")
       (match_test "IN_RANGE (INTVAL (op), -64, 63)")))

(define_predicate "const_imm8_operand"
  (and (match_code "const_int")
       (match_test "IN_RANGE (INTVAL (op), -128, 128)")))
...
(define_predicate "aq10_4_operand"
  (and (match_code "const_int")
       (match_test "mips_signed_immediate_p (INTVAL (op), 10, 4)")))
...
(define_predicate "const_vector_same_uimm0_operand"
  (match_code "const_vector")
{
  return mips_const_vector_same_int_p (op, mode, 0, 0);
})
...
(define_predicate "const_vector_same_simm16_operand"
  (match_code "const_vector")
{
  return mips_const_vector_same_int_p (op, mode, -32768, 32767);
})
...
;; This predicates is added for Ingenic MXU2
(define_predicate "const_vector_same_simm15_operand"
  (match_code "const_vector")
{
  return mips_const_vector_same_int_p (op, mode, -16384, 16383);
})

(define_predicate "const_imm15_operand"
  (and (match_code "const_int")
       (match_test "IMM15_OPERAND (INTVAL (op))")))
