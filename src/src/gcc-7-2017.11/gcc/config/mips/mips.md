...
(define_mode_attr UNITMODE [(SF "SF") (DF "DF") (V2SF "SF") (V4SF "SF")
			    ...
			    (V64QI "QI") (V32HI "HI") (V16SI "SI") 
                            (V8DI "DI") (V4TI "TI") (V2DF "DF") (V2OI "OI")
                            (V16SF "SF")])
...
(define_insn "*mov<mode>_internal"
  [(set (match_operand:IMOVE32 0 "nonimmediate_operand" "=d,!u,!u,d,e,!u,!ks,d,ZS,ZT,m,*f,*f,*d,*m,*d,*z,*a,*d,*B*C*D,*B*C*D,*d,*m,q,R,q")
	(match_operand:IMOVE32 1 "move_operand" "d,J,Udb7,Yd,Yf,ZT,ZS,m,!ks,!kbJ,dJ,*d*J,*m,*f,*f,*z,*d,*J*d,*a,*d,*m,*B*C*D,*B*C*D,R,q,q"))]
  "!TARGET_MIPS16
   && (register_operand (operands[0], <MODE>mode)
       || reg_or_0_operand (operands[1], <MODE>mode))"
  { return mips_output_move (operands[0], operands[1]); }
  [(set_attr "move_type" "move,move,const,const,const,load,load,load,store,store,store,mtc,fpload,mfc,fpstore,mfc,mtc,mtlo,mflo,mtc,fpload,mfc,fpstore,load,store,move")
...
{
  rtx pat = gen_prefetch1 (operands[0], operands[1], operands[2]);
...
; The MIPS MXU2 Instructions.
(include "mips-mxu2.md")

; The MIPS MXU3 Instructions.
(include "mips-mxu3.md")

; The Ingenic Xburst2 SIMD extension MXA Instructions.
(include "ingenic-mxa.md")
