...
;; Also for mxu2 vtruncs*.
(define_mode_attr unitfmt
  [(V2DF "d")
   (V4SF "s")])

;; This is used in mxu2 float convertion insn.
(define_mode_attr mxu2fmt_ivconv
  [(V2DF  "l")
   (V4SF  "w")])
  ...
  "ISA_HAS_MSA || ISA_HAS_MXU2"
{
 if (ISA_HAS_MSA)
 {
  ...
  else if (ISA_HAS_MXU2)
 {
  if (<UNITMODE>mode == QImode || <UNITMODE>mode == HImode)
    {
      rtx dest1 = gen_reg_rtx (SImode);
      emit_insn (gen_mxu2_mtcpus_<msafmt> (dest1, operands[1], operands[2]));
      emit_move_insn (operands[0],
		      gen_lowpart (<UNITMODE>mode, dest1));
    }
    else
      emit_insn (gen_mxu2_mtcpus_<msafmt> (operands[0], operands[1], operands[2]));
	}
  else
	  gcc_unreachable();
  ...
  "ISA_HAS_MSA || ISA_HAS_MXU2 "
{
 if (ISA_HAS_MSA)
 {
  ...
  if (val == 0)
  ...
  else
    {
	 ...
	 operands[2] accordingly.  */
      ...
      rtx tempsub = simplify_gen_subreg (V16QImode,
			     operands[1], GET_MODE(operands[1]), 0);
      gcc_assert (tempsub != NULL_RTX);
      emit_move_insn (ws, tempsub);
  ...
  emit_insn (gen_msa_vec_extract_<msafmt_f> (operands[0], temp));
    ...
    emit_insn (gen_mxu2_mtfpu_<msafmt_f> (operands[0], operands[1], operands[2]));
  else
    gcc_unreachable();
  DONE;
})
  ...
  "ISA_HAS_MSA || ISA_HAS_MXU2"
{
  ...
  if (ISA_HAS_MSA)
    ...
    emit_insn (gen_mxu2_insfcpu_<msafmt> (operands[0], operands[0], operands[2],
    	      		operands[1]));
  else
    gcc_unreachable();
  DONE;
  ...
  "ISA_HAS_MSA || ISA_HAS_MXU2"
{
  ...
  if (ISA_HAS_MSA)
    ...
    emit_insn (gen_mxu2_insffpu_<msafmt_f> (operands[0], operands[0], operands[2],
					      operands[1]));
	else
	gcc_unreachable();
  DONE;
...
(define_insn "msa_vshf_<msafmt_f>"
  [(set (match_operand:MSA 0 "register_operand" "=f")
...
{
  rtx sel = operands[3];
  rtx temp_sel = gen_reg_rtx (<VIMODE>mode);

  emit_insn(gen_and<mode_i>3 (temp_sel, sel,
		    mips_gen_const_int_vector (<VIMODE>mode, 0x3f)));
  emit_insn (gen_msa_vshf_<msafmt_f> (operands[0], operands[1],
			    operands[2], temp_sel));
...
(define_insn "add<mode>3"
  [(set (match_operand:IMSA 0 "register_operand" "=f,q,f,f")
	(plus:IMSA
	  (match_operand:IMSA 1 "register_operand" "f,q,f,f")
	  (match_operand:IMSA 2 "reg_or_vector_same_ximm5_operand" "f,q,Unv5,Uuv5")))]
  "ISA_HAS_MSA || ISA_HAS_MXU2"
{
...
(define_insn "sub<mode>3"
  [(set (match_operand:IMSA 0 "register_operand" "=f,q,f")
	(minus:IMSA
	  (match_operand:IMSA 1 "register_operand" "f,q,f")
	  (match_operand:IMSA 2 "reg_or_vector_same_uimm5_operand" "f,q,Uuv5")))]
  "ISA_HAS_MSA || ISA_HAS_MXU2"
  "@
...
(define_insn "mul<mode>3"
  [(set (match_operand:IMSA 0 "register_operand" "=f,q")
	(mult:IMSA (match_operand:IMSA 1 "register_operand" "f,q")
		   (match_operand:IMSA 2 "register_operand" "f,q")))]
  "ISA_HAS_MSA || ISA_HAS_MXU2"
  "@
...
(define_insn "div<mode>3"
  [(set (match_operand:IMSA 0 "register_operand" "=f,q")
	(div:IMSA (match_operand:IMSA 1 "register_operand" "f,q")
		  (match_operand:IMSA 2 "register_operand" "f,q")))]
  "ISA_HAS_MSA || ISA_HAS_MXU2"
  {
    if (which_alternative == 0)
     ...
     return mips_mxu2_output_division("divs<msafmt>\t%w0,%w1,%w2", operands);
...
(define_insn "udiv<mode>3"
  [(set (match_operand:IMSA 0 "register_operand" "=f,q")
	(udiv:IMSA (match_operand:IMSA 1 "register_operand" "f,q")
		   (match_operand:IMSA 2 "register_operand" "f,q")))]
  "ISA_HAS_MSA || ISA_HAS_MXU2"
  {
    if (which_alternative == 0)
      ...
      return mips_mxu2_output_division("divu<msafmt>\t%w0,%w1,%w2", operands);
...
(define_insn "mod<mode>3"
  [(set (match_operand:IMSA 0 "register_operand" "=f,q")
	(mod:IMSA (match_operand:IMSA 1 "register_operand" "f,q")
		  (match_operand:IMSA 2 "register_operand" "f,q")))]
  "ISA_HAS_MSA || ISA_HAS_MXU2"
  {
     if (which_alternative == 0)
       ...
       return mips_mxu2_output_division("mods<msafmt>\t%w0,%w1,%w2", operands);
...
(define_insn "umod<mode>3"
  [(set (match_operand:IMSA 0 "register_operand" "=f,q")
	(umod:IMSA (match_operand:IMSA 1 "register_operand" "f,q")
		   (match_operand:IMSA 2 "register_operand" "f,q")))]
  "ISA_HAS_MSA || ISA_HAS_MXU2"
  {
    if (which_alternative == 0)
     ...
     return mips_mxu2_output_division("modu<msafmt>\t%w0,%w1,%w2", operands);
...
(define_insn "xor<mode>3"
  [(set (match_operand:IMSA 0 "register_operand" "=f,q,f,f,q")
	(xor:IMSA
	  (match_operand:IMSA 1 "register_operand" "f,q,f,f,q")
	  (match_operand:IMSA 2 "reg_or_vector_same_val_operand" "f,q,YC,Urv8,Urv8")))]
  "ISA_HAS_MSA || ISA_HAS_MXU2"
  "@
   xor.v\t%w0,%w1,%w2
   xor%&v\t%w0,%w1,%w2
   ...
   xori.b\t%w0,%w1,%B2
   xori%&b\t%w0,%w1,%B2"
  [(set_attr "type" "simd_logic,simd_logic,simd_bit,simd_logic,simd_logic")
   (set_attr "mode" "<MODE>")])
...
(define_insn "and<mode>3"
  [(set (match_operand:IMSA 0 "register_operand" "=f,q,f,f,q")
	(and:IMSA
	  (match_operand:IMSA 1 "register_operand" "f,q,f,f,q")
	  (match_operand:IMSA 2 "reg_or_vector_same_val_operand" "f,q,YZ,Urv8,Urv8")))]
  "ISA_HAS_MSA || ISA_HAS_MXU2"
{
  switch (which_alternative)
    {
...
(define_insn "one_cmpl<mode>2"
  [(set (match_operand:IMSA 0 "register_operand" "=f,q")
	(not:IMSA (match_operand:IMSA 1 "register_operand" "f,q")))]
  "ISA_HAS_MSA || ISA_HAS_MXU2"
  "@
   nor.v\t%w0,%w1,%w1
   nor%&v\t%w0,%w1,%w1"
...
(define_insn "vlshr<mode>3"
  [(set (match_operand:IMSA 0 "register_operand" "=f,q,f,q")
	(lshiftrt:IMSA
	  (match_operand:IMSA 1 "register_operand" "f,q,f,q")
	  (match_operand:IMSA 2 "reg_or_vector_same_uimm6_operand" "f,q,Uuv6,Uuv6")))]
  "ISA_HAS_MSA || ISA_HAS_MXU2"
  "@
   srl.<msafmt>\t%w0,%w1,%w2
   srl%&<msafmt>\t%w0,%w1,%w2
...
(define_insn "add<mode>3"
  [(set (match_operand:FMSA 0 "register_operand" "=f,q")
	(plus:FMSA (match_operand:FMSA 1 "register_operand" "f,q")
		   (match_operand:FMSA 2 "register_operand" "f,q")))]
  "ISA_HAS_MSA || ISA_HAS_MXU2"
  "@
...
(define_insn "sub<mode>3"
  [(set (match_operand:FMSA 0 "register_operand" "=f,q")
	(minus:FMSA (match_operand:FMSA 1 "register_operand" "f,q")
		    (match_operand:FMSA 2 "register_operand" "f,q")))]
  "ISA_HAS_MSA || ISA_HAS_MXU2"
  "@
...
(define_insn "mul<mode>3"
  [(set (match_operand:FMSA 0 "register_operand" "=f,q")
	(mult:FMSA (match_operand:FMSA 1 "register_operand" "f,q")
		   (match_operand:FMSA 2 "register_operand" "f,q")))]
  "ISA_HAS_MSA || ISA_HAS_MXU2"
  "@
...
(define_insn "div<mode>3"
  [(set (match_operand:FMSA 0 "register_operand" "=f,q")
	(div:FMSA (match_operand:FMSA 1 "register_operand" "f,q")
		  (match_operand:FMSA 2 "register_operand" "f,q")))]
  "ISA_HAS_MSA ||ISA_HAS_MXU2 "
  "@
...
(define_insn "fma<mode>4_intrinsic"
  [(set (match_operand:FMSA 0 "register_operand" "=f")
...
(define_insn "*fma<mode>4"
  [(set (match_operand:FMSA 0 "register_operand" "=f")
	(fma:FMSA (match_operand:FMSA 1 "register_operand" "f")
		  (match_operand:FMSA 2 "register_operand" "f")
		  (match_operand:FMSA 3 "register_operand" "0")))]
  "ISA_HAS_MSA && GENERATE_FMADD"
  "fmadd.<msafmt>\t%w0,%w1,%w2"
  [(set_attr "type" "simd_fmadd")
   (set_attr "mode" "<MODE>")])

(define_insn "fnma<mode>4_intrinsic"
  [(set (match_operand:FMSA 0 "register_operand" "=f")
	(unspec:FMSA [(match_operand:FMSA 1 "register_operand" "f")
		      (match_operand:FMSA 2 "register_operand" "f")
		      (match_operand:FMSA 3 "register_operand" "0")]
...
(define_insn "sqrt<mode>2"
  [(set (match_operand:FMSA 0 "register_operand" "=f,q")
	(sqrt:FMSA (match_operand:FMSA 1 "register_operand" "f,q")))]
  "ISA_HAS_MSA || ISA_HAS_MXU2"
  "@
  fsqrt.<msafmt>\t%w0,%w1
  fsqrt%&<msafmt>\t%w0,%w1"
...
(define_insn "ssadd<mode>3"
  [(set (match_operand:IMSA 0 "register_operand" "=f,q")
	(ss_plus:IMSA (match_operand:IMSA 1 "register_operand" "f,q")
		      (match_operand:IMSA 2 "register_operand" "f,q")))]
  "ISA_HAS_MSA || ISA_HAS_MXU2"
  "@
   adds_s.<msafmt>\t%w0,%w1,%w2
   addss<msafmt>\t%w0,%w1,%w2"
  [(set_attr "type" "simd_int_arith")
   (set_attr "mode" "<MODE>")])

(define_insn "usadd<mode>3"
  [(set (match_operand:IMSA 0 "register_operand" "=f,q")
	(us_plus:IMSA (match_operand:IMSA 1 "register_operand" "f,q")
		      (match_operand:IMSA 2 "register_operand" "f,q")))]
  "ISA_HAS_MSA || ISA_HAS_MXU2"
  "@
   adds_u.<msafmt>\t%w0,%w1,%w2
   adduu<msafmt>\t%w0,%w1,%w2"
  [(set_attr "type" "simd_int_arith")
   (set_attr "mode" "<MODE>")])
...
(define_insn "float<fint><FMSA:mode>2"
  [(set (match_operand:FMSA 0 "register_operand" "=f,q")
	(float:FMSA (match_operand:<FINT> 1 "register_operand" "f,q")))]
  "ISA_HAS_MSA || ISA_HAS_MXU2"
  {
    if (ISA_HAS_MSA && which_alternative == 0)
	  return "ffint_s.<msafmt>\t%w0,%w1";
	else if (ISA_HAS_MXU2 && which_alternative ==1)
	  return "vcvts<FMSA:unitfmt><FMSA:mxu2fmt_ivconv>\t%w0,%w1";
	else
	   gcc_unreachable();
	}
...
(define_insn "floatuns<fint><FMSA:mode>2"
  [(set (match_operand:FMSA 0 "register_operand" "=f,q")
	(unsigned_float:FMSA
	  (match_operand:<VIMODE> 1 "register_operand" "f,q")))]
  "ISA_HAS_MSA || ISA_HAS_MXU2"
  "@
   ffint_u.<msafmt>\t%w0,%w1
   vcvtu<FMSA:unitfmt><FMSA:mxu2fmt_ivconv>\t%w0,%w1"
  [(set_attr "type" "simd_fcvt")
   (set_attr "cnv_mode" "<FINTCNV>")
   (set_attr "mode" "<MODE>")])
...
(define_insn "smax<mode>3"
  [(set (match_operand:FMSA 0 "register_operand" "=f,q")
	(smax:FMSA (match_operand:FMSA 1 "register_operand" "f,q")
		   (match_operand:FMSA 2 "register_operand" "f,q")))]
  "ISA_HAS_MSA || ISA_HAS_MXU2"
  "@
...
(define_insn "smin<mode>3"
  [(set (match_operand:FMSA 0 "register_operand" "=f,q")
	(smin:FMSA (match_operand:FMSA 1 "register_operand" "f,q")
		   (match_operand:FMSA 2 "register_operand" "f,q")))]
  "ISA_HAS_MSA || ISA_HAS_MXU2"
  "@
...
(define_insn "fix_trunc<FMSA:mode><mode_i>2"
  [(set (match_operand:<VIMODE> 0 "register_operand" "=f,q")
	(fix:<VIMODE> (match_operand:FMSA 1 "register_operand" "f,q")))]
  "ISA_HAS_MSA || ISA_HAS_MXU2"
  "@
   ftrunc_s.<msafmt>\t%w0,%w1
   vtruncs<FMSA:mxu2fmt_ivconv><FMSA:unitfmt>\t%w0,%w1"
  [(set_attr "type" "simd_fcvt")
   (set_attr "cnv_mode" "<FINTCNV_2>")
   (set_attr "mode" "<MODE>")])
...
(define_insn "fixuns_trunc<FMSA:mode><mode_i>2"
  [(set (match_operand:<VIMODE> 0 "register_operand" "=f,q")
	(unsigned_fix:<VIMODE> (match_operand:FMSA 1 "register_operand" "f,q")))]
  "ISA_HAS_MSA || ISA_HAS_MXU2"
  "@
  ftrunc_u.<msafmt>\t%w0,%w1
  vtruncu<FMSA:mxu2fmt_ivconv><FMSA:unitfmt>\t%w0,%w1"
  [(set_attr "type" "simd_fcvt")
   (set_attr "cnv_mode" "<FINTCNV_2>")
   (set_attr "mode" "<MODE>")])
...
(define_insn "smax<mode>3"
  [(set (match_operand:IMSA 0 "register_operand" "=f,q,f")
	(smax:IMSA (match_operand:IMSA 1 "register_operand" "f,q,f")
		   (match_operand:IMSA 2 "reg_or_vector_same_simm5_operand" "f,q,Usv5")))]
  "ISA_HAS_MSA || ISA_HAS_MXU2"
  "@
   max_s.<msafmt>\t%w0,%w1,%w2
   maxs<msafmt>\t%w0,%w1,%w2
...
(define_insn "umax<mode>3"
  [(set (match_operand:IMSA 0 "register_operand" "=f,q,f")
	(umax:IMSA (match_operand:IMSA 1 "register_operand" "f,q,f")
		   (match_operand:IMSA 2 "reg_or_vector_same_uimm5_operand" "f,q,Uuv5")))]
  "ISA_HAS_MSA || ISA_HAS_MXU2"
  "@
   max_u.<msafmt>\t%w0,%w1,%w2
   maxu<msafmt>\t%w0,%w1,%w2
...
(define_insn "smin<mode>3"
  [(set (match_operand:IMSA 0 "register_operand" "=f,q,f")
	(smin:IMSA (match_operand:IMSA 1 "register_operand" "f,q,f")
		   (match_operand:IMSA 2 "reg_or_vector_same_simm5_operand" "f,q,Usv5")))]
  "ISA_HAS_MSA || ISA_HAS_MXU2"
  "@
   min_s.<msafmt>\t%w0,%w1,%w2
   mins<msafmt>\t%w0,%w1,%w2
...
(define_insn "umin<mode>3"
  [(set (match_operand:IMSA 0 "register_operand" "=f,q,f")
	(umin:IMSA (match_operand:IMSA 1 "register_operand" "f,q,f")
		   (match_operand:IMSA 2 "reg_or_vector_same_uimm5_operand" "f,q,Uuv5")))]
  "ISA_HAS_MSA || ISA_HAS_MXU2"
  "@
   min_u.<msafmt>\t%w0,%w1,%w2
   minu<msafmt>\t%w0,%w1,%w2
