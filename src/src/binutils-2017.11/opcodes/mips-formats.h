...
#define UINT_MXU(SIZE, LSB, BANK) \
  { \
    static const struct mips_int_operand op = { \
      { OP_INT_##BANK, SIZE, LSB },(1 << (SIZE)) - 1 , 0, 0,FALSE \
    }; \
    return &op.root; \
  }

#define UINT_MULTI2(SIZE, SHIFT0, SIZE0, LSB0, SHIFT1, SIZE1, LSB1)  \
  {                                                                  \
    static const struct mips_int_multi_operand op = {                \
      { OP_INT_MULTI, SIZE, 0}, ((1 << (SIZE)) - 1), 0, 0, FALSE, 2, \
        SHIFT0, {OP_INT, SIZE0, LSB0},                               \
        SHIFT1, {OP_INT, SIZE1, LSB1},                               \
        0, {OP_INT, 1, 0},                                           \
        0, {OP_INT, 1, 0},                                           \
    };                                                               \
    return &op.root;                                                 \
...
#define SINT_MULTI2(SIZE, SHIFT0, SIZE0, LSB0, SHIFT1, SIZE1, LSB1)  \
  {                                                                  \
    static const struct mips_int_multi_operand op = {                \
      { OP_INT_MULTI, SIZE, 0}, ((1 << ((SIZE) - 1)) - 1), 0, 0, FALSE, 2, \
        SHIFT0, {OP_INT, SIZE0, LSB0},                               \
        SHIFT1, {OP_INT, SIZE1, LSB1},                               \
        0, {OP_INT, 1, 0},                                           \
        0, {OP_INT, 1, 0},                                           \
...
#define UINT_MULTI3(SIZE, SHIFT0, SIZE0, LSB0, SHIFT1, SIZE1, LSB1, SHIFT2, SIZE2, LSB2)  \
  {                                                                  \
    static const struct mips_int_multi_operand op = {                \
      { OP_INT_MULTI, SIZE, 0}, ((1 << (SIZE)) - 1), 0, 0, FALSE, 3, \
        SHIFT0, {OP_INT, SIZE0, LSB0},                               \
        SHIFT1, {OP_INT, SIZE1, LSB1},                               \
        SHIFT2, {OP_INT, SIZE2, LSB2},                               \
        0, {OP_INT, 1, 0},                                           \
    };                                                               \
    return &op.root;                                                 \
  }

#define SINT_MULTI3(SIZE, SHIFT0, SIZE0, LSB0, SHIFT1, SIZE1, LSB1, SHIFT2, SIZE2, LSB2)  \
  {                                                                  \
    static const struct mips_int_multi_operand op = {                \
      { OP_INT_MULTI, SIZE, 0}, ((1 << ((SIZE) - 1)) - 1), 0, 0, FALSE, 3, \
        SHIFT0, {OP_INT, SIZE0, LSB0},                               \
        SHIFT1, {OP_INT, SIZE1, LSB1},                               \
        SHIFT2, {OP_INT, SIZE2, LSB2},                               \
        0, {OP_INT, 1, 0},                                           \
...
#define INT_ADJ_MXU(SIZE, LSB, MAX_VAL, NIN_VAL, BANK, PRINT_HEX) \
  { \
    static const struct mips_fixedint_operand op = { \
      {{ OP_INT_##BANK, SIZE, LSB }, MAX_VAL, 0, 0, PRINT_HEX },NIN_VAL \
    }; \
    return &op.root.root; \
  }
