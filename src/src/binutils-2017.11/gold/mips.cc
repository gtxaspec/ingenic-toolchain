                                                 ...
                                                 elfcpp::Elf_Word in_flags)
{
  ...
  if ((new_flags & elfcpp::EF_MIPS_ARCH_ASE)
      != (old_flags & elfcpp::EF_MIPS_ARCH_ASE))
    {
      ...
      // Compare MXU3 ABI.
      int old_mxu3 = old_flags & elfcpp::EF_MIPS_ARCH_MXU3;
      int new_mxu3 = new_flags & elfcpp::EF_MIPS_ARCH_MXU3;
      int old_mxu3_ext_abi = old_flags & elfcpp::EF_MIPS_ARCH_ASE_MXU3_EXT_ABI;
      int new_mxu3_ext_abi = new_flags & elfcpp::EF_MIPS_ARCH_ASE_MXU3_EXT_ABI;
  ...
  if ((old_flags & EF_MIPS_ARCH_MXU3) || (new_flags & EF_MIPS_ARCH_MXU3))
    {
      merged_flags |= elfcpp::EF_MIPS_ARCH_MXU3;
    }
