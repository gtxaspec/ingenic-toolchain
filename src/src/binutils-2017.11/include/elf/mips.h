...
START_RELOC_NUMBERS (elf_mips_reloc_type)
  ...
  /* Add relocs for Ingenic MXU R2 10size branch.  */
  RELOC_NUMBER (R_MIPS_PC10, 52)
  /* Space to grow */
...
/* Use MXU3 ISA extensions ABI. */
#define EF_MIPS_ARCH_ASE_MXU3_EXT_ABI  0x01000000

/* Use MXU3 ISA extensions. */
#define EF_MIPS_ARCH_MXU3   0x00000800
