...
typedef INT (WSAAPI *PFN_InetPton) (INT, LPCTSTR, LPVOID);
typedef LPCTSTR (WSAAPI *PFN_InetNtop) (INT, LPVOID, LPTSTR, size_t);
typedef NET_IFINDEX (WSAAPI *PFN_IfNameToIndex) (LPCSTR);
