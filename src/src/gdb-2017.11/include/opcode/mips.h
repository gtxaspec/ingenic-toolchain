...
enum mips_operand_type {
  ...
  /* Described by mips_opts_mxu_operand.  */
  OP_INT_OPT,
  OP_INT_OPTNUM,
  OP_INT_APT1,
  OP_INT_APT2,
  ...
  /* For fixed range ingeter ,by mips_fixed_int_operand*/
  OP_INT_FIXED,

  /* Multi encoding segment for Interger operand.  */
  OP_INT_MULTI,
  ...
  /* An index selected by an integer with 0, e.g. [0].  */
  OP_IMM0_INDEX,

  /* An index selected by an integer with 0 and non bit encoding, e.g. [0].  */
  OP_IMM0_INDEX_NOBIT,
...
enum mips_reg_operand_type {
  ...
  /* Ingenic MXU register xr0-xr16  */
  OP_REG_MXU,
  OP_REG_MXU_CR,

  /* Ingenic MXU R2 vr0-vr31 and control registers. */
  OP_REG_MXU128,
  OP_REG_MXU128_CR,

  /* Ingenic MXU R3 vr0-vr31 registers. */
  OP_REG_MXU512,
  OP_REG_MXU512_VSR,
  OP_REG_MXU512_VWR,
  OP_REG_MXU512_MCS
...
struct mips_int_multi_operand
{
  ...
  unsigned int nseg;
  unsigned int shift0;
  struct mips_operand oproot0;
  unsigned int shift1;
  struct mips_operand oproot1;
  unsigned int shift2;
  struct mips_operand oproot2;
  unsigned int shift3;
  struct mips_operand oproot3;
  /* multi OP_INT encoding list.  */
};
...
/* Mips32r2 MXU ASE  */
#define ASE_MXU128		0x00008000 /* For Ingenic MXU R2 128bit.  */
#define ASE_MXU512		0x00020000 /* For Ingenic MXU R2 512bit MXU3.  */
#define ASE_MXU512_1		0x00040000 /* For Ingenic MXU R2 512bit MXU3.1.  */
#define ASE_MXU			0x00010000 /* For Ingenic MXU 32bit.  */
