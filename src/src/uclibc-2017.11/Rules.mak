...
ifneq ($(findstring $(TARGET_ARCH),mips mips64),)
# At least with some versions of `make' literal \# does not work in
# $(shell ...), the backslash is not stripped, so use this indirection.
HASH := \#
ifneq ($(shell $(CC) $(CFLAGS) -dM -E - < /dev/null | grep __mips_nan2008),)
UCLIBC_LDSO_NAME := $(UCLIBC_LDSO_NAME)-mipsn8
endif
endif
