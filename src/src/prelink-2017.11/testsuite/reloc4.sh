...
rm -f prelink.cache
$BUILD_CC -O2 -o reloc4lib1.tmp $srcdir/reloc4lib1.c
$BUILD_CC -O2 -o reloc4lib2.tmp $srcdir/reloc4lib2.c
$BUILD_CC -O2 -o reloc4lib3.tmp $srcdir/reloc4lib3.c
$BUILD_CC -O2 -o reloc4.tmp $srcdir/reloc4.c
