...
dnl  AC_REQUIRE([gl_FUNC_NONREENTRANT_EUIDACCESS])
...
dnl  AC_REQUIRE([gl_GETUGROUPS])
  AC_REQUIRE([gl_HARD_LOCALE])
  AC_REQUIRE([gl_HASH])
  AC_REQUIRE([gl_HASH_PJW])
  AC_REQUIRE([gl_HUMAN])
dnl  AC_REQUIRE([gl_IDCACHE])
