...
#define copy_scalar_tof(type) \
  tmp32 = *from, Cat2(__store_,type)(*to, tmp32);
...
#define copy_tof(mb,type) \
  tmp32 = from->mb, Cat2(__store_,type)(to->mb, tmp32);
...
/*
 * GNU hash uses an ELF_T_WORD entity size on 32-bit platforms
 */
#define ghash_32L__tom word_32L__tom
#define ghash_32L__tof word_32L__tof
#define ghash_32M__tom word_32M__tom
#define ghash_32M__tof word_32M__tof
