...
#endif
#ifdef GENERATOR_FILE
extern int TARGET_FIX_T40_X2000;
#else
  int x_TARGET_FIX_T40_X2000;
#define TARGET_FIX_T40_X2000 global_options.x_TARGET_FIX_T40_X2000
#endif
#ifdef GENERATOR_FILE
...
#endif
#ifdef GENERATOR_FILE
extern int mips_ingenic_save_restore;
#else
  int x_mips_ingenic_save_restore;
#define mips_ingenic_save_restore global_options.x_mips_ingenic_save_restore
#endif
#ifdef GENERATOR_FILE
...
enum opt_code
{
  ...
  OPT_mfix_t40_x2000 = 1184,                 /* -mfix-t40-x2000 */
  OPT_mfix_vr4120 = 1185,                    /* -mfix-vr4120 */
  OPT_mfix_vr4130 = 1186,                    /* -mfix-vr4130 */
  OPT_mfix4300 = 1187,                       /* -mfix4300 */
  OPT_mflip_mips16 = 1188,                   /* -mflip-mips16 */
  OPT_mflush_func_ = 1189,                   /* -mflush-func= */
  OPT_mfp_exceptions = 1190,                 /* -mfp-exceptions */
  OPT_mfp32 = 1191,                          /* -mfp32 */
  OPT_mfp64 = 1192,                          /* -mfp64 */
  OPT_mfpxx = 1193,                          /* -mfpxx */
  OPT_mframe_header_opt = 1194,              /* -mframe-header-opt */
  OPT_mfused_madd = 1195,                    /* -mfused-madd */
  OPT_mfusion = 1196,                        /* -mfusion */
  ...
  OPT_mmxu = 1225,                           /* -mmxu */
  OPT_mmxu2 = 1226,                          /* -mmxu2 */
  OPT_mmxu3 = 1227,                          /* -mmxu3 */
  OPT_mmxu3_ext_abi = 1228,                  /* -mmxu3-ext-abi */
  OPT_mmxu3_1 = 1229,                        /* -mmxu3.1 */
  OPT_mnan_ = 1230,                          /* -mnan= */
  OPT_mno_float = 1231,                      /* -mno-float */
  OPT_mno_flush_func = 1232,                 /* -mno-flush-func */
  OPT_mno_mdmx = 1233,                       /* -mno-mdmx */
  OPT_mno_mips16 = 1234,                     /* -mno-mips16 */
  OPT_mno_mips3d = 1235,                     /* -mno-mips3d */
  OPT_modd_spreg = 1236,                     /* -modd-spreg */
  OPT_mpaired_single = 1237,                 /* -mpaired-single */
  OPT_mplt = 1238,                           /* -mplt */
  OPT_mr10k_cache_barrier_ = 1239,           /* -mr10k-cache-barrier= */
  OPT_mrelax_pic_calls = 1240,               /* -mrelax-pic-calls */
  OPT_msave_restore_ = 1241,                 /* -msave-restore= */
  OPT_mshared = 1242,                        /* -mshared */
  OPT_msingle_float = 1243,                  /* -msingle-float */
  OPT_mslsa = 1244,                          /* -mslsa */
  OPT_msmartmips = 1245,                     /* -msmartmips */
  OPT_msoft_float = 1246,                    /* -msoft-float */
  OPT_msplit_addresses = 1247,               /* -msplit-addresses */
  OPT_msym32 = 1248,                         /* -msym32 */
  OPT_msynci = 1249,                         /* -msynci */
  OPT_mtune_ = 1250,                         /* -mtune= */
  OPT_muclibc = 1251,                        /* -muclibc */
  OPT_muninit_const_in_rodata = 1252,        /* -muninit-const-in-rodata */
  OPT_mvirt = 1253,                          /* -mvirt */
  OPT_mvr4130_align = 1254,                  /* -mvr4130-align */
  OPT_mxgot = 1255,                          /* -mxgot */
  OPT_mxpa = 1256,                           /* -mxpa */
  OPT_n = 1257,                              /* -n */
  OPT_no_canonical_prefixes = 1258,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1259,              /* -no-integrated-cpp */
  OPT_no_pie = 1260,                         /* -no-pie */
  OPT_noasmopt = 1261,                       /* -noasmopt */
  OPT_nocpp = 1262,                          /* -nocpp */
  OPT_nodefaultlibs = 1263,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1264,                   /* -nostartfiles */
  OPT_nostdinc = 1265,                       /* -nostdinc */
  OPT_nostdinc__ = 1266,                     /* -nostdinc++ */
  OPT_nostdlib = 1267,                       /* -nostdlib */
  OPT_o = 1268,                              /* -o */
  OPT_p = 1269,                              /* -p */
  OPT_pass_exit_codes = 1270,                /* -pass-exit-codes */
  /* OPT_pedantic = 1271, */                 /* -pedantic */
  OPT_pedantic_errors = 1272,                /* -pedantic-errors */
  OPT_pg = 1273,                             /* -pg */
  OPT_pie = 1274,                            /* -pie */
  OPT_pipe = 1275,                           /* -pipe */
  OPT_posix = 1276,                          /* -posix */
  OPT_print_file_name_ = 1277,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1278,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1279,          /* -print-multi-directory */
  OPT_print_multi_lib = 1280,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1281,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1282,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1283,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1284,               /* -print-prog-name= */
  OPT_print_search_dirs = 1285,              /* -print-search-dirs */
  OPT_print_sysroot = 1286,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1287,   /* -print-sysroot-headers-suffix */
  OPT_profile = 1288,                        /* -profile */
  OPT_pthread = 1289,                        /* -pthread */
  OPT_quiet = 1290,                          /* -quiet */
  OPT_r = 1291,                              /* -r */
  OPT_rdynamic = 1292,                       /* -rdynamic */
  OPT_remap = 1293,                          /* -remap */
  OPT_s = 1294,                              /* -s */
  OPT_save_temps = 1295,                     /* -save-temps */
  OPT_save_temps_ = 1296,                    /* -save-temps= */
  OPT_shared = 1297,                         /* -shared */
  OPT_shared_libgcc = 1298,                  /* -shared-libgcc */
  /* OPT_specs = 1299, */                    /* -specs */
  OPT_specs_ = 1300,                         /* -specs= */
  OPT_static = 1301,                         /* -static */
  OPT_static_libasan = 1302,                 /* -static-libasan */
  OPT_static_libgcc = 1303,                  /* -static-libgcc */
  OPT_static_libgfortran = 1304,             /* -static-libgfortran */
  OPT_static_libgo = 1305,                   /* -static-libgo */
  OPT_static_liblsan = 1306,                 /* -static-liblsan */
  OPT_static_libmpx = 1307,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1308,          /* -static-libmpxwrappers */
  OPT_static_libstdc__ = 1309,               /* -static-libstdc++ */
  OPT_static_libtsan = 1310,                 /* -static-libtsan */
  OPT_static_libubsan = 1311,                /* -static-libubsan */
  /* OPT_std_c__03 = 1312, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1313, */                /* -std=c++0x */
  OPT_std_c__11 = 1314,                      /* -std=c++11 */
  OPT_std_c__14 = 1315,                      /* -std=c++14 */
  /* OPT_std_c__17 = 1316, */                /* -std=c++17 */
  /* OPT_std_c__1y = 1317, */                /* -std=c++1y */
  OPT_std_c__1z = 1318,                      /* -std=c++1z */
  OPT_std_c__98 = 1319,                      /* -std=c++98 */
  OPT_std_c11 = 1320,                        /* -std=c11 */
  /* OPT_std_c1x = 1321, */                  /* -std=c1x */
  /* OPT_std_c89 = 1322, */                  /* -std=c89 */
  OPT_std_c90 = 1323,                        /* -std=c90 */
  OPT_std_c99 = 1324,                        /* -std=c99 */
  /* OPT_std_c9x = 1325, */                  /* -std=c9x */
  OPT_std_f2003 = 1326,                      /* -std=f2003 */
  OPT_std_f2008 = 1327,                      /* -std=f2008 */
  OPT_std_f2008ts = 1328,                    /* -std=f2008ts */
  OPT_std_f95 = 1329,                        /* -std=f95 */
  OPT_std_gnu = 1330,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1331, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1332, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1333,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1334,                    /* -std=gnu++14 */
  /* OPT_std_gnu__17 = 1335, */              /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1336, */              /* -std=gnu++1y */
  OPT_std_gnu__1z = 1337,                    /* -std=gnu++1z */
  OPT_std_gnu__98 = 1338,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1339,                      /* -std=gnu11 */
  /* OPT_std_gnu1x = 1340, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1341, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1342,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1343,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1344, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1345, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1346,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1347, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1348, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1349, */         /* -std=iso9899:2011 */
  OPT_std_legacy = 1350,                     /* -std=legacy */
  OPT_symbolic = 1351,                       /* -symbolic */
  OPT_t = 1352,                              /* -t */
  OPT_time = 1353,                           /* -time */
  OPT_time_ = 1354,                          /* -time= */
  OPT_tno_android_cc = 1355,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1356,                 /* -tno-android-ld */
  OPT_traditional = 1357,                    /* -traditional */
  OPT_traditional_cpp = 1358,                /* -traditional-cpp */
  OPT_trigraphs = 1359,                      /* -trigraphs */
  OPT_u = 1360,                              /* -u */
  OPT_undef = 1361,                          /* -undef */
  OPT_v = 1362,                              /* -v */
  OPT_version = 1363,                        /* -version */
  OPT_w = 1364,                              /* -w */
  OPT_wrapper = 1365,                        /* -wrapper */
  OPT_x = 1366,                              /* -x */
  OPT_z = 1367,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
