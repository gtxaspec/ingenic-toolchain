...
#define HAVE_mfc1 (TARGET_HARD_FLOAT)
#define HAVE_prologue_stub 1
#define HAVE_syn_fpu (TARGET_HARD_FLOAT)
...
#define HAVE_fnmsv2sf4 (((ISA_HAS_FUSED_MADD3 || ISA_HAS_FUSED_MADD4) \
   && !HONOR_SIGNED_ZEROS (V2SFmode)) && (TARGET_HARD_FLOAT && TARGET_PAIRED_SINGLE_FLOAT))
#define HAVE_madd4sf ((ISA_HAS_UNFUSED_MADD4) && (TARGET_HARD_FLOAT))
#define HAVE_madd4df ((ISA_HAS_UNFUSED_MADD4) && (TARGET_HARD_FLOAT && TARGET_DOUBLE_FLOAT))
#define HAVE_madd4v2sf ((ISA_HAS_UNFUSED_MADD4) && (TARGET_HARD_FLOAT && TARGET_PAIRED_SINGLE_FLOAT))
...
extern rtx        gen_mfc1                             (void);
extern rtx        gen_prologue_stub                    (void);
extern rtx        gen_syn_fpu                          (rtx, rtx, rtx);
...
extern rtx        gen_madd4sf                          (rtx, rtx, rtx, rtx);
extern rtx        gen_madd4df                          (rtx, rtx, rtx, rtx);
extern rtx        gen_madd4v2sf                        (rtx, rtx, rtx, rtx);
