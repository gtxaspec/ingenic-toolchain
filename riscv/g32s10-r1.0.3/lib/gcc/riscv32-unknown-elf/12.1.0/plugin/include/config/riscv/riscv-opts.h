...
/* AIE vector register sizes.  */
enum riscv_aie_vector_bits_enum {
  AIE_SCALABLE,
  AIE_NOT_IMPLEMENTED = AIE_SCALABLE,
  AIE_128 = 128,
  AIE_256 = 256,
  AIE_512 = 512,
  AIE_1024 = 1024,
...
#define MASK_INGENICAIE (1 << 0)
#define TARGET_INGENICAIE ((riscv_ingenic_subext & MASK_INGENICAIE) != 0)
#define TARGET_INGENICAIE_VERSION (__riscv_xingenicaie)
