...
#endif
  E_OImode,                /* config/riscv/riscv-modes.def:26 */
#define HAVE_OImode
#ifdef USE_ENUM_MODES
...
#endif
  E_XImode,                /* config/riscv/riscv-modes.def:27 */
#define HAVE_XImode
#ifdef USE_ENUM_MODES
...
#endif
  E_VWmode,                /* config/riscv/riscv-modes.def:28 */
#define HAVE_VWmode
#ifdef USE_ENUM_MODES
#define VWmode E_VWmode
#else
#define VWmode (scalar_int_mode ((scalar_int_mode::from_int) E_VWmode))
#endif
...
#endif
  E_CVWmode,               /* machmode.def:267 */
#define HAVE_CVWmode
#ifdef USE_ENUM_MODES
#define CVWmode E_CVWmode
#else
#define CVWmode (complex_mode ((complex_mode::from_int) E_CVWmode))
#endif
...
#endif
  E_VNx16BImode,           /* config/riscv/riscv-modes.def:39 */
...
#endif
  E_VNx8BImode,            /* config/riscv/riscv-modes.def:40 */
...
#endif
  E_VNx4BImode,            /* config/riscv/riscv-modes.def:41 */
...
#endif
  E_VNx16QImode,           /* config/riscv/riscv-modes.def:78 */
...
#endif
  E_VNx8HImode,            /* config/riscv/riscv-modes.def:78 */
...
#endif
  E_VNx4SImode,            /* config/riscv/riscv-modes.def:78 */
...
#endif
  E_VNx2DImode,            /* config/riscv/riscv-modes.def:78 */
...
#endif
  E_VNx2QImode,            /* config/riscv/riscv-modes.def:106 */
...
#endif
  E_VNx4QImode,            /* config/riscv/riscv-modes.def:107 */
...
#endif
  E_VNx2HImode,            /* config/riscv/riscv-modes.def:107 */
...
#endif
  E_VNx8QImode,            /* config/riscv/riscv-modes.def:108 */
...
#endif
  E_VNx4HImode,            /* config/riscv/riscv-modes.def:108 */
...
#endif
  E_VNx2SImode,            /* config/riscv/riscv-modes.def:108 */
...
#endif
  E_VNx2TImode,            /* config/riscv/riscv-modes.def:81 */
...
#endif
  E_AIE_V2OImode,          /* config/riscv/riscv-modes.def:88 */
#define HAVE_AIE_V2OImode
#ifdef USE_ENUM_MODES
#define AIE_V2OImode E_AIE_V2OImode
#else
#define AIE_V2OImode ((void) 0, E_AIE_V2OImode)
#endif
  E_AIE_V4OImode,          /* config/riscv/riscv-modes.def:90 */
#define HAVE_AIE_V4OImode
#ifdef USE_ENUM_MODES
#define AIE_V4OImode E_AIE_V4OImode
#else
#define AIE_V4OImode ((void) 0, E_AIE_V4OImode)
#endif
  E_VNx8HFmode,            /* config/riscv/riscv-modes.def:72 */
...
#endif
  E_VNx4SFmode,            /* config/riscv/riscv-modes.def:69 */
...
#endif
  E_VNx2HFmode,            /* config/riscv/riscv-modes.def:134 */
...
#endif
  E_VNx4HFmode,            /* config/riscv/riscv-modes.def:131 */
...
#endif
  E_VNx2SFmode,            /* config/riscv/riscv-modes.def:128 */
...
#define VNx2SFmode ((void) 0, E_VNx2SFmode)
  ...
  MIN_MODE_PARTIAL_INT = E_VWmode,
  MAX_MODE_PARTIAL_INT = E_VWmode,
  ...
  MAX_MODE_VECTOR_BOOL = E_VNx4BImode,

  MIN_MODE_VECTOR_INT = E_VNx16QImode,
  MAX_MODE_VECTOR_INT = E_AIE_V4OImode,
