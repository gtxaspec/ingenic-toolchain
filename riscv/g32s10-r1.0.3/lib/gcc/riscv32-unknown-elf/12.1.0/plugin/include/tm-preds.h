...
extern bool const_segment1_operand (rtx, machine_mode);
extern bool const_segment2_operand (rtx, machine_mode);
extern bool const_segment4_operand (rtx, machine_mode);
extern bool const_segment8_operand (rtx, machine_mode);
extern bool const_segment16_operand (rtx, machine_mode);
extern bool const_segment32_operand (rtx, machine_mode);
extern bool const_segment64_operand (rtx, machine_mode);
extern bool const_segment2_dynamic_operand (rtx, machine_mode);
extern bool const_segment4_dynamic_operand (rtx, machine_mode);
extern bool const_segment8_dynamic_operand (rtx, machine_mode);
extern bool const_segment16_dynamic_operand (rtx, machine_mode);
extern bool const_segment32_dynamic_operand (rtx, machine_mode);
extern bool const_segment64_dynamic_operand (rtx, machine_mode);
extern bool const_uns_arith_operand (rtx, machine_mode);
extern bool const_imm5_operand (rtx, machine_mode);
extern bool const_imm7_operand (rtx, machine_mode);
extern bool const_imm8_operand (rtx, machine_mode);
extern bool const_uimm8_operand (rtx, machine_mode);
extern bool const_imm9_operand (rtx, machine_mode);
extern bool const_uimm9_operand (rtx, machine_mode);
extern bool const_imm10_operand (rtx, machine_mode);
extern bool const_imm16_operand (rtx, machine_mode);
extern bool const_uimm10_operand (rtx, machine_mode);
extern bool const_uimm15_operand (rtx, machine_mode);
extern bool const_uimm16_operand (rtx, machine_mode);
extern bool reg_or_mem_operand (rtx, machine_mode);
extern bool const_vector_operand (rtx, machine_mode);
extern bool aie_move_operand (rtx, machine_mode);
extern bool vector_move_operand (rtx, machine_mode);
extern bool aie_index_operand (rtx, machine_mode);
extern bool vwr_move_operand (rtx, machine_mode);
extern bool const_vector_same_bytes_operand (rtx, machine_mode);
extern bool reg_or_const_vector_same_bytes_operand (rtx, machine_mode);
extern bool const_vector_same_val_operand (rtx, machine_mode);
extern bool reg_or_const_vector_same_val_operand (rtx, machine_mode);
extern bool const_vector_same_uimm0_operand (rtx, machine_mode);
extern bool const_vector_same_simm16_operand (rtx, machine_mode);
extern bool const_vector_same_uimm16_operand (rtx, machine_mode);
extern bool const_vector_li_operand (rtx, machine_mode);
extern bool vector_undef_operand (rtx, machine_mode);
extern bool vector_merge_operand (rtx, machine_mode);
extern bool vector_all_zeros_mask_operand (rtx, machine_mode);
...
{
  return c >= CONSTRAINT_m && c <= CONSTRAINT_R;
}
...
{
  if (c >= CONSTRAINT_G && c <= CONSTRAINT_Wc1)
    return;
