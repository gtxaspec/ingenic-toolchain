...
enum opt_code
{
  ...
  OPT_mmxa = 1843,                           /* -mmxa */
  OPT_mnan_ = 1844,                          /* -mnan= */
  OPT_mno_float = 1845,                      /* -mno-float */
  OPT_mno_flush_func = 1846,                 /* -mno-flush-func */
  OPT_mno_mdmx = 1847,                       /* -mno-mdmx */
  OPT_mno_mips16 = 1848,                     /* -mno-mips16 */
  OPT_mno_mips3d = 1849,                     /* -mno-mips3d */
  OPT_modd_spreg = 1850,                     /* -modd-spreg */
  OPT_mpaired_single = 1851,                 /* -mpaired-single */
  OPT_mplt = 1852,                           /* -mplt */
  OPT_mr10k_cache_barrier_ = 1853,           /* -mr10k-cache-barrier= */
  OPT_mrelax_pic_calls = 1854,               /* -mrelax-pic-calls */
  OPT_mshared = 1855,                        /* -mshared */
  OPT_msingle_float = 1856,                  /* -msingle-float */
  OPT_msmartmips = 1857,                     /* -msmartmips */
  OPT_msoft_float = 1858,                    /* -msoft-float */
  OPT_msplit_addresses = 1859,               /* -msplit-addresses */
  OPT_msym32 = 1860,                         /* -msym32 */
  OPT_msynci = 1861,                         /* -msynci */
  OPT_mtune_ = 1862,                         /* -mtune= */
  OPT_muclibc = 1863,                        /* -muclibc */
  OPT_munaligned_access = 1864,              /* -munaligned-access */
  OPT_muninit_const_in_rodata = 1865,        /* -muninit-const-in-rodata */
  OPT_mvirt = 1866,                          /* -mvirt */
  OPT_mvr4130_align = 1867,                  /* -mvr4130-align */
  OPT_mxgot = 1868,                          /* -mxgot */
  OPT_mxpa = 1869,                           /* -mxpa */
  OPT_n = 1870,                              /* -n */
  ...
  OPT_pie = 1891,                            /* -pie */
  OPT_pipe = 1892,                           /* -pipe */
  OPT_posix = 1893,                          /* -posix */
  OPT_print_file_name_ = 1894,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1895,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1896,          /* -print-multi-directory */
  OPT_print_multi_lib = 1897,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1898,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1899,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1900,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1901,               /* -print-prog-name= */
  OPT_print_search_dirs = 1902,              /* -print-search-dirs */
  OPT_print_sysroot = 1903,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1904,   /* -print-sysroot-headers-suffix */
  OPT_print_value = 1905,                    /* -print-value */
  OPT_profile = 1906,                        /* -profile */
  OPT_pthread = 1907,                        /* -pthread */
  OPT_quiet = 1908,                          /* -quiet */
  OPT_r = 1909,                              /* -r */
  OPT_rdynamic = 1910,                       /* -rdynamic */
  OPT_remap = 1911,                          /* -remap */
  OPT_reverse_sort = 1912,                   /* -reverse-sort */
  OPT_s = 1913,                              /* -s */
  OPT_save_temps = 1914,                     /* -save-temps */
  OPT_save_temps_ = 1915,                    /* -save-temps= */
  OPT_shared = 1916,                         /* -shared */
  OPT_shared_libgcc = 1917,                  /* -shared-libgcc */
  OPT_shared_libphobos = 1918,               /* -shared-libphobos */
  OPT_size_sort = 1919,                      /* -size-sort */
  /* OPT_specs = 1920, */                    /* -specs */
  OPT_specs_ = 1921,                         /* -specs= */
  OPT_static = 1922,                         /* -static */
  OPT_static_libasan = 1923,                 /* -static-libasan */
  OPT_static_libgcc = 1924,                  /* -static-libgcc */
  OPT_static_libgfortran = 1925,             /* -static-libgfortran */
  OPT_static_libgo = 1926,                   /* -static-libgo */
  OPT_static_libhwasan = 1927,               /* -static-libhwasan */
  OPT_static_liblsan = 1928,                 /* -static-liblsan */
  OPT_static_libmpx = 1929,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1930,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 1931,               /* -static-libphobos */
  OPT_static_libstdc__ = 1932,               /* -static-libstdc++ */
  OPT_static_libtsan = 1933,                 /* -static-libtsan */
  OPT_static_libubsan = 1934,                /* -static-libubsan */
  OPT_static_pie = 1935,                     /* -static-pie */
  /* OPT_std_c__03 = 1936, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1937, */                /* -std=c++0x */
  OPT_std_c__11 = 1938,                      /* -std=c++11 */
  OPT_std_c__14 = 1939,                      /* -std=c++14 */
  OPT_std_c__17 = 1940,                      /* -std=c++17 */
  /* OPT_std_c__1y = 1941, */                /* -std=c++1y */
  /* OPT_std_c__1z = 1942, */                /* -std=c++1z */
  OPT_std_c__20 = 1943,                      /* -std=c++20 */
  OPT_std_c__23 = 1944,                      /* -std=c++23 */
  /* OPT_std_c__2a = 1945, */                /* -std=c++2a */
  /* OPT_std_c__2b = 1946, */                /* -std=c++2b */
  OPT_std_c__98 = 1947,                      /* -std=c++98 */
  OPT_std_c11 = 1948,                        /* -std=c11 */
  OPT_std_c17 = 1949,                        /* -std=c17 */
  /* OPT_std_c18 = 1950, */                  /* -std=c18 */
  /* OPT_std_c1x = 1951, */                  /* -std=c1x */
  OPT_std_c2x = 1952,                        /* -std=c2x */
  /* OPT_std_c89 = 1953, */                  /* -std=c89 */
  OPT_std_c90 = 1954,                        /* -std=c90 */
  OPT_std_c99 = 1955,                        /* -std=c99 */
  /* OPT_std_c9x = 1956, */                  /* -std=c9x */
  OPT_std_f2003 = 1957,                      /* -std=f2003 */
  OPT_std_f2008 = 1958,                      /* -std=f2008 */
  OPT_std_f2008ts = 1959,                    /* -std=f2008ts */
  OPT_std_f2018 = 1960,                      /* -std=f2018 */
  OPT_std_f95 = 1961,                        /* -std=f95 */
  OPT_std_gnu = 1962,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1963, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1964, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1965,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1966,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 1967,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1968, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 1969, */              /* -std=gnu++1z */
  OPT_std_gnu__20 = 1970,                    /* -std=gnu++20 */
  OPT_std_gnu__23 = 1971,                    /* -std=gnu++23 */
  /* OPT_std_gnu__2a = 1972, */              /* -std=gnu++2a */
  /* OPT_std_gnu__2b = 1973, */              /* -std=gnu++2b */
  OPT_std_gnu__98 = 1974,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1975,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1976,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1977, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 1978, */                /* -std=gnu1x */
  OPT_std_gnu2x = 1979,                      /* -std=gnu2x */
  /* OPT_std_gnu89 = 1980, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1981,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1982,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1983, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1984, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1985,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1986, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1987, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1988, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 1989, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 1990, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 1991,                     /* -std=legacy */
  OPT_stdlib_ = 1992,                        /* -stdlib= */
  OPT_symbol_ = 1993,                        /* -symbol= */
  OPT_symbolic = 1994,                       /* -symbolic */
  OPT_t = 1995,                              /* -t */
  OPT_time = 1996,                           /* -time */
  OPT_time_ = 1997,                          /* -time= */
  OPT_tno_android_cc = 1998,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1999,                 /* -tno-android-ld */
  OPT_traditional = 2000,                    /* -traditional */
  OPT_traditional_cpp = 2001,                /* -traditional-cpp */
  OPT_tree_stats = 2002,                     /* -tree-stats */
  OPT_trigraphs = 2003,                      /* -trigraphs */
  OPT_type_stats = 2004,                     /* -type-stats */
  OPT_u = 2005,                              /* -u */
  OPT_undef = 2006,                          /* -undef */
  OPT_v = 2007,                              /* -v */
  OPT_version = 2008,                        /* -version */
  OPT_w = 2009,                              /* -w */
  OPT_wrapper = 2010,                        /* -wrapper */
  OPT_x = 2011,                              /* -x */
  OPT_z = 2012,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
