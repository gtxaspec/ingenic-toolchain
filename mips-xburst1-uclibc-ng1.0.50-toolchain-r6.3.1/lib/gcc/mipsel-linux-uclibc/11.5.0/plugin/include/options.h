...
#define TARGET_MXU2 ((target_flags & MASK_MXU2) != 0)
#define TARGET_MXU2_P(target_flags) (((target_flags) & MASK_MXU2) != 0)
...
enum opt_code
{
  ...
  OPT_list = 1680,                           /* -list */
  OPT_mabi_ = 1681,                          /* -mabi= */
  OPT_mabicalls = 1682,                      /* -mabicalls */
  OPT_mabs_ = 1683,                          /* -mabs= */
  OPT_mandroid = 1684,                       /* -mandroid */
  OPT_march_ = 1685,                         /* -march= */
  OPT_mbionic = 1686,                        /* -mbionic */
  OPT_mbranch_cost_ = 1687,                  /* -mbranch-cost= */
  OPT_mbranch_likely = 1688,                 /* -mbranch-likely */
  OPT_mcheck_zero_division = 1689,           /* -mcheck-zero-division */
  OPT_mcode_readable_ = 1690,                /* -mcode-readable= */
  OPT_mcompact_branches_ = 1691,             /* -mcompact-branches= */
  OPT_mcrc = 1692,                           /* -mcrc */
  OPT_mdebug = 1693,                         /* -mdebug */
  OPT_mdebugd = 1694,                        /* -mdebugd */
  OPT_mdivide_breaks = 1695,                 /* -mdivide-breaks */
  OPT_mdivide_traps = 1696,                  /* -mdivide-traps */
  OPT_mdmx = 1697,                           /* -mdmx */
  OPT_mdouble_float = 1698,                  /* -mdouble-float */
  OPT_mdsp = 1699,                           /* -mdsp */
  OPT_mdspr2 = 1700,                         /* -mdspr2 */
  OPT_meb = 1701,                            /* -meb */
  OPT_mel = 1702,                            /* -mel */
  OPT_membedded_data = 1703,                 /* -membedded-data */
  OPT_meva = 1704,                           /* -meva */
  OPT_mexplicit_relocs = 1705,               /* -mexplicit-relocs */
  OPT_mextern_sdata = 1706,                  /* -mextern-sdata */
  OPT_mfix_24k = 1707,                       /* -mfix-24k */
  OPT_mfix_r10000 = 1708,                    /* -mfix-r10000 */
  OPT_mfix_r4000 = 1709,                     /* -mfix-r4000 */
  OPT_mfix_r4400 = 1710,                     /* -mfix-r4400 */
  OPT_mfix_r5900 = 1711,                     /* -mfix-r5900 */
  OPT_mfix_rm7000 = 1712,                    /* -mfix-rm7000 */
  OPT_mfix_sb1 = 1713,                       /* -mfix-sb1 */
  OPT_mfix_vr4120 = 1714,                    /* -mfix-vr4120 */
  OPT_mfix_vr4130 = 1715,                    /* -mfix-vr4130 */
  OPT_mfix4300 = 1716,                       /* -mfix4300 */
  OPT_mflip_mips16 = 1717,                   /* -mflip-mips16 */
  OPT_mflush_func_ = 1718,                   /* -mflush-func= */
  OPT_mfp_exceptions = 1719,                 /* -mfp-exceptions */
  OPT_mfp32 = 1720,                          /* -mfp32 */
  OPT_mfp64 = 1721,                          /* -mfp64 */
  OPT_mfpxx = 1722,                          /* -mfpxx */
  OPT_mframe_header_opt = 1723,              /* -mframe-header-opt */
  OPT_mfused_madd = 1724,                    /* -mfused-madd */
  OPT_mginv = 1725,                          /* -mginv */
  OPT_mglibc = 1726,                         /* -mglibc */
  OPT_mgp32 = 1727,                          /* -mgp32 */
  OPT_mgp64 = 1728,                          /* -mgp64 */
  OPT_mgpopt = 1729,                         /* -mgpopt */
  OPT_mhard_float = 1730,                    /* -mhard-float */
  OPT_mimadd = 1731,                         /* -mimadd */
  OPT_minterlink_compressed = 1732,          /* -minterlink-compressed */
  OPT_minterlink_mips16 = 1733,              /* -minterlink-mips16 */
  OPT_mips = 1734,                           /* -mips */
  OPT_mips16 = 1735,                         /* -mips16 */
  OPT_mips3d = 1736,                         /* -mips3d */
  OPT_mllsc = 1737,                          /* -mllsc */
  OPT_mload_store_pairs = 1738,              /* -mload-store-pairs */
  OPT_mlocal_sdata = 1739,                   /* -mlocal-sdata */
  OPT_mlong_calls = 1740,                    /* -mlong-calls */
  OPT_mlong32 = 1741,                        /* -mlong32 */
  OPT_mlong64 = 1742,                        /* -mlong64 */
  OPT_mloongson_ext = 1743,                  /* -mloongson-ext */
  OPT_mloongson_ext2 = 1744,                 /* -mloongson-ext2 */
  OPT_mloongson_mmi = 1745,                  /* -mloongson-mmi */
  OPT_mlra = 1746,                           /* -mlra */
  OPT_mlxc1_sxc1 = 1747,                     /* -mlxc1-sxc1 */
  OPT_mmad = 1748,                           /* -mmad */
  OPT_mmadd4 = 1749,                         /* -mmadd4 */
  OPT_mmcount_ra_address = 1750,             /* -mmcount-ra-address */
  OPT_mmcu = 1751,                           /* -mmcu */
  OPT_mmemcpy = 1752,                        /* -mmemcpy */
  OPT_mmicromips = 1753,                     /* -mmicromips */
  OPT_mmsa = 1754,                           /* -mmsa */
  OPT_mmt = 1755,                            /* -mmt */
  OPT_mmusl = 1756,                          /* -mmusl */
  OPT_mmxu2 = 1757,                          /* -mmxu2 */
  OPT_mnan_ = 1758,                          /* -mnan= */
  OPT_mno_float = 1759,                      /* -mno-float */
  OPT_mno_flush_func = 1760,                 /* -mno-flush-func */
  OPT_mno_mdmx = 1761,                       /* -mno-mdmx */
  OPT_mno_mips16 = 1762,                     /* -mno-mips16 */
  OPT_mno_mips3d = 1763,                     /* -mno-mips3d */
  OPT_modd_spreg = 1764,                     /* -modd-spreg */
  OPT_mpaired_single = 1765,                 /* -mpaired-single */
  OPT_mplt = 1766,                           /* -mplt */
  OPT_mr10k_cache_barrier_ = 1767,           /* -mr10k-cache-barrier= */
  OPT_mrelax_pic_calls = 1768,               /* -mrelax-pic-calls */
  OPT_mshared = 1769,                        /* -mshared */
  OPT_msingle_float = 1770,                  /* -msingle-float */
  OPT_msmartmips = 1771,                     /* -msmartmips */
  OPT_msoft_float = 1772,                    /* -msoft-float */
  OPT_msplit_addresses = 1773,               /* -msplit-addresses */
  OPT_msym32 = 1774,                         /* -msym32 */
  OPT_msynci = 1775,                         /* -msynci */
  OPT_mtune_ = 1776,                         /* -mtune= */
  OPT_muclibc = 1777,                        /* -muclibc */
  OPT_muninit_const_in_rodata = 1778,        /* -muninit-const-in-rodata */
  OPT_mvirt = 1779,                          /* -mvirt */
  OPT_mvr4130_align = 1780,                  /* -mvr4130-align */
  OPT_mxgot = 1781,                          /* -mxgot */
  OPT_mxpa = 1782,                           /* -mxpa */
  OPT_n = 1783,                              /* -n */
  ...
  OPT_time = 1910,                           /* -time */
  OPT_time_ = 1911,                          /* -time= */
  OPT_tno_android_cc = 1912,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1913,                 /* -tno-android-ld */
  OPT_traditional = 1914,                    /* -traditional */
  OPT_traditional_cpp = 1915,                /* -traditional-cpp */
  OPT_tree_stats = 1916,                     /* -tree-stats */
  OPT_trigraphs = 1917,                      /* -trigraphs */
  OPT_type_stats = 1918,                     /* -type-stats */
  OPT_u = 1919,                              /* -u */
  OPT_undef = 1920,                          /* -undef */
  OPT_v = 1921,                              /* -v */
  OPT_version = 1922,                        /* -version */
  OPT_w = 1923,                              /* -w */
  OPT_wrapper = 1924,                        /* -wrapper */
  OPT_x = 1925,                              /* -x */
  OPT_z = 1926,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
