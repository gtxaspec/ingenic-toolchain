...
enum unspec {
  ...
  UNSPEC_MXU2_BNEZ1Q = 338,
  UNSPEC_MXU2_BEQZ1Q = 339,
  UNSPEC_MXU2_BNEZ = 340,
  UNSPEC_MXU2_BEQZ = 341,
  UNSPEC_MXU2_CEQZ = 342,
  UNSPEC_MXU2_CNEZ = 343,
  UNSPEC_MXU2_CLEZ = 344,
  UNSPEC_MXU2_CLTZ = 345,
  UNSPEC_MXU2_AVES = 346,
  UNSPEC_MXU2_AVEU = 347,
  UNSPEC_MXU2_AVERS = 348,
  UNSPEC_MXU2_AVERU = 349,
  UNSPEC_MXU2_SUBUA = 350,
  UNSPEC_MXU2_SUBSS = 351,
  UNSPEC_MXU2_FMAX = 352,
  UNSPEC_MXU2_FMAXA = 353,
  UNSPEC_MXU2_FMIN = 354,
  UNSPEC_MXU2_FMINA = 355,
  UNSPEC_MXU2_FCLASS = 356,
  UNSPEC_MXU2_MAXA = 357,
  UNSPEC_MXU2_MAXS = 358,
  UNSPEC_MXU2_MAXU = 359,
  UNSPEC_MXU2_MINA = 360,
  UNSPEC_MXU2_MINS = 361,
  UNSPEC_MXU2_MINU = 362,
  UNSPEC_MXU2_SATS = 363,
  UNSPEC_MXU2_SATU = 364,
  UNSPEC_MXU2_SLLI = 365,
  UNSPEC_MXU2_SRAI = 366,
  UNSPEC_MXU2_SRLI = 367,
  UNSPEC_MXU2_SRAR = 368,
  UNSPEC_MXU2_SRARI = 369,
  UNSPEC_MXU2_SRLR = 370,
  UNSPEC_MXU2_SRLRI = 371,
  UNSPEC_MXU2_DOTPS = 372,
  UNSPEC_MXU2_DOTPU = 373,
  UNSPEC_MXU2_DADDS = 374,
  UNSPEC_MXU2_DADDU = 375,
  UNSPEC_MXU2_DSUBS = 376,
  UNSPEC_MXU2_DSUBU = 377,
  UNSPEC_MXU2_LOC = 378,
  UNSPEC_MXU2_LZC = 379,
  UNSPEC_MXU2_BCNT = 380,
  UNSPEC_MXU2_ANDIB = 381,
  UNSPEC_MXU2_NORIB = 382,
  UNSPEC_MXU2_ORIB = 383,
  UNSPEC_MXU2_XORIB = 384,
  UNSPEC_MXU2_NORV = 385,
  UNSPEC_MXU2_BSELV = 386,
  UNSPEC_MXU2_VCVTHS = 387,
  UNSPEC_MXU2_VCVTSD = 388,
  UNSPEC_MXU2_VCVTESH = 389,
  UNSPEC_MXU2_VCVTEDS = 390,
  UNSPEC_MXU2_VCVTOSH = 391,
  UNSPEC_MXU2_VCVTODS = 392,
  UNSPEC_MXU2_VCVTS_F = 393,
  UNSPEC_MXU2_VCVTU_F = 394,
  UNSPEC_MXU2_VCVTSWS = 395,
  UNSPEC_MXU2_VCVTSLD = 396,
  UNSPEC_MXU2_VCVTUWS = 397,
  UNSPEC_MXU2_VCVTULD = 398,
  UNSPEC_MXU2_VCVTRWS = 399,
  UNSPEC_MXU2_VCVTRLD = 400,
  UNSPEC_MXU2_VTRUNCS = 401,
  UNSPEC_MXU2_VTRUNCU = 402,
  UNSPEC_MXU2_VCVTQESH = 403,
  UNSPEC_MXU2_VCVTQEDW = 404,
  UNSPEC_MXU2_VCVTQOSH = 405,
  UNSPEC_MXU2_VCVTQODW = 406,
  UNSPEC_MXU2_VCVTQHS = 407,
  UNSPEC_MXU2_VCVTQWD = 408,
  UNSPEC_MXU2_MADDQ = 409,
  UNSPEC_MXU2_MADDQR = 410,
  UNSPEC_MXU2_MSUBQ = 411,
  UNSPEC_MXU2_MSUBQR = 412,
  UNSPEC_MXU2_MULQ = 413,
  UNSPEC_MXU2_MULQR = 414,
  UNSPEC_MXU2_MTFPU = 415,
  UNSPEC_MXU2_MFCPU = 416,
  UNSPEC_MXU2_MFFPU = 417,
  UNSPEC_MXU2_INSFCPU = 418,
  UNSPEC_MXU2_INSFFPU = 419,
  UNSPEC_MXU2_INSFMXU = 420,
  UNSPEC_MXU2_REPX = 421,
  UNSPEC_MXU2_REPI = 422,
  UNSPEC_MXU2_SHUFV = 423,
  UNSPEC_MXU2_SA1QX = 424,
  UNSPEC_MXU2_LA1QX = 425,
  UNSPEC_MXU2_SA1Q = 426,
  UNSPEC_MXU2_LA1Q = 427,
  UNSPEC_MXU2_SU1QX = 428,
  UNSPEC_MXU2_SU1Q = 429,
  UNSPEC_MXU2_LU1QX = 430,
  UNSPEC_MXU2_LU1Q = 431,
  UNSPEC_MXU2_CFCMXU = 432,
  UNSPEC_MXU2_CTCMXU = 433,
  UNSPEC_MSA_FCMUL_W = 434,
  UNSPEC_MSA_FEXUPLC_W = 435,
  UNSPEC_MSA_FEXUPRC_W = 436,
  UNSPEC_MSA_LDINSSU_W = 437,
  UNSPEC_MSA_LDINSS_W = 438,
  UNSPEC_MSA_VSHFR_B = 439,
  UNSPEC_MSA_VSLDI_B = 440,
  UNSPEC_MSA_LDINS = 441,
  UNSPEC_MSA_STEXT = 442,
  UNSPEC_MSA_PCNT_V = 443,
  UNSPEC_MSA_BEXT = 444,
  UNSPEC_MSA_BEXP = 445,
  UNSPEC_MSA_BEXP_2B = 446,
  UNSPEC_MSA_BEXP_4B = 447,
  UNSPEC_MSA_BMU_V = 448,
  UNSPEC_MSA_SLL_V = 449,
  UNSPEC_MSA_SLLI_V = 450,
  UNSPEC_MSA_SRL_V = 451,
  UNSPEC_MSA_SRLI_V = 452,
  UNSPEC_MSA_MOVE_W = 453,
  UNSPEC_MSA_MOVBT_B = 454,
  UNSPEC_MSA_MOVBP_B = 455,
  UNSPEC_MSA_SATSS = 456,
  UNSPEC_MSA_SATUU = 457,
  UNSPEC_MSA_SATUS = 458,
  UNSPEC_MSA_ADDSL = 459,
  UNSPEC_MSA_ADDSR = 460,
  UNSPEC_MSA_ADDUL = 461,
  UNSPEC_MSA_ADDUR = 462,
  UNSPEC_MSA_ACCSL = 463,
  UNSPEC_MSA_ACCSR = 464,
  UNSPEC_MSA_ACCUL = 465,
  UNSPEC_MSA_ACCUR = 466,
  UNSPEC_MSA_SUBSL = 467,
  UNSPEC_MSA_SUBSR = 468,
  UNSPEC_MSA_SUBUL = 469,
  UNSPEC_MSA_SUBUR = 470,
  UNSPEC_MSA_MULSL = 471,
  UNSPEC_MSA_MULSR = 472,
  UNSPEC_MSA_MULUL = 473,
  UNSPEC_MSA_MULUR = 474,
  UNSPEC_ADDRESS_FIRST = 475
};
#define NUM_UNSPEC_VALUES 476
