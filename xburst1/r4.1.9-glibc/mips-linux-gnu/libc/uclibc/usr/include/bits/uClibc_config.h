...
#define __KERNEL_HEADERS__ "/project/Mips-Toolchain/release_4.x.x-gcc7.2.0/install/opt/codesourcery/mips-linux-gnu/libc/uclibc/usr/include"
...
#define __CROSS_COMPILER_PREFIX__ "/project/Mips-Toolchain/release_4.x.x-gcc7.2.0/install/opt/codesourcery/bin/mips-linux-gnu-"
