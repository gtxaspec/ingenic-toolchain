/* Generated automatically by the program 'build/genpreds'
   from the machine description file '/project/Mips-Toolchain/release_4.x.x-gcc7.2.0/src/gcc-7-2017.11/gcc/config/mips/mips.md'.  */
...
extern int const_uimm0_operand (rtx, machine_mode);
extern int const_uimm1_operand (rtx, machine_mode);
extern int const_uimm2_operand (rtx, machine_mode);
...
extern int const_uimm10_operand (rtx, machine_mode);
extern int const_uimm15_operand (rtx, machine_mode);
extern int const_uimm16_operand (rtx, machine_mode);
extern int const_imm5_operand (rtx, machine_mode);
extern int const_imm6_operand (rtx, machine_mode);
extern int const_imm7_operand (rtx, machine_mode);
extern int const_imm8_operand (rtx, machine_mode);
extern int const_imm9_operand (rtx, machine_mode);
...
extern int const_vector_same_uimm0_operand (rtx, machine_mode);
...
extern int const_vector_same_simm16_operand (rtx, machine_mode);
...
extern int const_double_operand_zero (rtx, machine_mode);
