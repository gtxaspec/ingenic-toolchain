...
#define __KERNEL_HEADERS__ "/project/Mips-Toolchain/release_3.x.x-gcc5.4.0/install/opt/codesourcery/mips-linux-uclibc/libc/usr/include"
...
#define __CROSS_COMPILER_PREFIX__ "/project/Mips-Toolchain/release_3.x.x-gcc5.4.0/install/opt/codesourcery/bin/mips-linux-uclibc-"
#define __UCLIBC_EXTRA_CFLAGS__ "-muclibc -Os -g"
#undef __DODEBUG__
#undef __DOSTRIP__
#undef __DOASSERTS__
