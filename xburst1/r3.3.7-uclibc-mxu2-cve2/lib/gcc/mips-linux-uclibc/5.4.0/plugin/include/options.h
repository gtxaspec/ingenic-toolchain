...
enum opt_code
{
  ...
  OPT_Wnull = 314,                           /* -Wnull */
  OPT_Wodr = 315,                            /* -Wodr */
  OPT_Wold_style_cast = 316,                 /* -Wold-style-cast */
  OPT_Wold_style_declaration = 317,          /* -Wold-style-declaration */
  OPT_Wold_style_definition = 318,           /* -Wold-style-definition */
  OPT_Wopenmp_simd = 319,                    /* -Wopenmp-simd */
  OPT_Wout_of_date = 320,                    /* -Wout-of-date */
  OPT_Wover_ann = 321,                       /* -Wover-ann */
  OPT_Woverflow = 322,                       /* -Woverflow */
  OPT_Woverlength_strings = 323,             /* -Woverlength-strings */
  OPT_Woverloaded_virtual = 324,             /* -Woverloaded-virtual */
  OPT_Woverride_init = 325,                  /* -Woverride-init */
  OPT_Wp_ = 326,                             /* -Wp, */
  OPT_Wpacked = 327,                         /* -Wpacked */
  OPT_Wpacked_bitfield_compat = 328,         /* -Wpacked-bitfield-compat */
  OPT_Wpadded = 329,                         /* -Wpadded */
  OPT_Wparam_assign = 330,                   /* -Wparam-assign */
  OPT_Wparentheses = 331,                    /* -Wparentheses */
  OPT_Wpedantic = 332,                       /* -Wpedantic */
  OPT_Wpkg_default_method = 333,             /* -Wpkg-default-method */
  OPT_Wpmf_conversions = 334,                /* -Wpmf-conversions */
  OPT_Wpointer_arith = 335,                  /* -Wpointer-arith */
  OPT_Wpointer_sign = 336,                   /* -Wpointer-sign */
  OPT_Wpointer_to_int_cast = 337,            /* -Wpointer-to-int-cast */
  OPT_Wpragmas = 338,                        /* -Wpragmas */
  OPT_Wproperty_assign_default = 339,        /* -Wproperty-assign-default */
  OPT_Wprotocol = 340,                       /* -Wprotocol */
  OPT_Wpsabi = 341,                          /* -Wpsabi */
  OPT_Wraw = 342,                            /* -Wraw */
  OPT_Wreal_q_constant = 343,                /* -Wreal-q-constant */
  OPT_Wrealloc_lhs = 344,                    /* -Wrealloc-lhs */
  OPT_Wrealloc_lhs_all = 345,                /* -Wrealloc-lhs-all */
  OPT_Wredundant_decls = 346,                /* -Wredundant-decls */
  OPT_Wredundant_modifiers = 347,            /* -Wredundant-modifiers */
  OPT_Wreorder = 348,                        /* -Wreorder */
  OPT_Wreturn_local_addr = 349,              /* -Wreturn-local-addr */
  OPT_Wreturn_type = 350,                    /* -Wreturn-type */
  OPT_Wselector = 351,                       /* -Wselector */
  OPT_Wsequence_point = 352,                 /* -Wsequence-point */
  OPT_Wserial = 353,                         /* -Wserial */
  OPT_Wshadow = 354,                         /* -Wshadow */
  OPT_Wshadow_ivar = 355,                    /* -Wshadow-ivar */
  OPT_Wshift_count_negative = 356,           /* -Wshift-count-negative */
  OPT_Wshift_count_overflow = 357,           /* -Wshift-count-overflow */
  ...
  OPT_Wspecial_param_hiding = 364,           /* -Wspecial-param-hiding */
  OPT_Wstack_protector = 365,                /* -Wstack-protector */
  OPT_Wstack_usage_ = 366,                   /* -Wstack-usage= */
  OPT_Wstatic_access = 367,                  /* -Wstatic-access */
  OPT_Wstatic_receiver = 368,                /* -Wstatic-receiver */
  OPT_Wstrict_aliasing = 369,                /* -Wstrict-aliasing */
  OPT_Wstrict_aliasing_ = 370,               /* -Wstrict-aliasing= */
  OPT_Wstrict_null_sentinel = 371,           /* -Wstrict-null-sentinel */
  OPT_Wstrict_overflow = 372,                /* -Wstrict-overflow */
  OPT_Wstrict_overflow_ = 373,               /* -Wstrict-overflow= */
  OPT_Wstrict_prototypes = 374,              /* -Wstrict-prototypes */
  OPT_Wstrict_selector_match = 375,          /* -Wstrict-selector-match */
  ...
  OPT_Wtype_hiding = 400,                    /* -Wtype-hiding */
  OPT_Wtype_limits = 401,                    /* -Wtype-limits */
  OPT_Wuncheck = 402,                        /* -Wuncheck */
  ...
  OPT_Wunnecessary_else = 408,               /* -Wunnecessary-else */
  OPT_Wunqualified_field = 409,              /* -Wunqualified-field */
  ...
  OPT_Wunused_argument = 414,                /* -Wunused-argument */
  OPT_Wunused_but_set_parameter = 415,       /* -Wunused-but-set-parameter */
  OPT_Wunused_but_set_variable = 416,        /* -Wunused-but-set-variable */
  OPT_Wunused_dummy_argument = 417,          /* -Wunused-dummy-argument */
  OPT_Wunused_function = 418,                /* -Wunused-function */
  OPT_Wunused_import = 419,                  /* -Wunused-import */
  OPT_Wunused_label = 420,                   /* -Wunused-label */
  OPT_Wunused_local = 421,                   /* -Wunused-local */
  OPT_Wunused_local_typedefs = 422,          /* -Wunused-local-typedefs */
  OPT_Wunused_macros = 423,                  /* -Wunused-macros */
  OPT_Wunused_parameter = 424,               /* -Wunused-parameter */
  OPT_Wunused_private = 425,                 /* -Wunused-private */
  OPT_Wunused_result = 426,                  /* -Wunused-result */
  OPT_Wunused_thrown = 427,                  /* -Wunused-thrown */
  ...
  OPT_Wuseless_type_check = 432,             /* -Wuseless-type-check */
  OPT_Wvarargs = 433,                        /* -Wvarargs */
  OPT_Wvarargs_cast = 434,                   /* -Wvarargs-cast */
  OPT_Wvariadic_macros = 435,                /* -Wvariadic-macros */
  OPT_Wvector_operation_performance = 436,   /* -Wvector-operation-performance */
  OPT_Wvirtual_move_assign = 437,            /* -Wvirtual-move-assign */
  OPT_Wvla = 438,                            /* -Wvla */
  OPT_Wvolatile_register_var = 439,          /* -Wvolatile-register-var */
  OPT_Wwarning_token = 440,                  /* -Wwarning-token */
  OPT_Wwrite_strings = 441,                  /* -Wwrite-strings */
  OPT_Wzero_as_null_pointer_constant = 442,  /* -Wzero-as-null-pointer-constant */
  OPT_Wzerotrip = 443,                       /* -Wzerotrip */
  OPT_Xassembler = 444,                      /* -Xassembler */
  OPT_Xlinker = 445,                         /* -Xlinker */
  OPT_Xpreprocessor = 446,                   /* -Xpreprocessor */
  OPT_Z = 447,                               /* -Z */
  OPT_ansi = 448,                            /* -ansi */
  ...
  /* OPT_bootclasspath = 453, */             /* -bootclasspath */
  OPT_c = 454,                               /* -c */
  /* OPT_classpath = 455, */                 /* -classpath */
  OPT_coverage = 456,                        /* -coverage */
  OPT_cpp = 457,                             /* -cpp */
  OPT_cpp_ = 458,                            /* -cpp= */
  OPT_d = 459,                               /* -d */
  ...
  OPT_mabi_ = 1140,                          /* -mabi= */
  OPT_mabicalls = 1141,                      /* -mabicalls */
  OPT_mabs_ = 1142,                          /* -mabs= */
  OPT_mandroid = 1143,                       /* -mandroid */
  OPT_march_ = 1144,                         /* -march= */
  OPT_mbionic = 1145,                        /* -mbionic */
  OPT_mbranch_cost_ = 1146,                  /* -mbranch-cost= */
  OPT_mbranch_likely = 1147,                 /* -mbranch-likely */
  OPT_mcheck_zero_division = 1148,           /* -mcheck-zero-division */
  OPT_mcode_readable_ = 1149,                /* -mcode-readable= */
  OPT_mdebug = 1150,                         /* -mdebug */
  OPT_mdebugd = 1151,                        /* -mdebugd */
  OPT_mdivide_breaks = 1152,                 /* -mdivide-breaks */
  OPT_mdivide_traps = 1153,                  /* -mdivide-traps */
  OPT_mdmx = 1154,                           /* -mdmx */
  OPT_mdouble_float = 1155,                  /* -mdouble-float */
  OPT_mdsp = 1156,                           /* -mdsp */
  OPT_mdspr2 = 1157,                         /* -mdspr2 */
  OPT_meb = 1158,                            /* -meb */
  OPT_mel = 1159,                            /* -mel */
  OPT_membedded_data = 1160,                 /* -membedded-data */
  OPT_meva = 1161,                           /* -meva */
  OPT_mexplicit_relocs = 1162,               /* -mexplicit-relocs */
  OPT_mextern_sdata = 1163,                  /* -mextern-sdata */
  OPT_mfix_24k = 1164,                       /* -mfix-24k */
  OPT_mfix_r10000 = 1165,                    /* -mfix-r10000 */
  OPT_mfix_r4000 = 1166,                     /* -mfix-r4000 */
  OPT_mfix_r4400 = 1167,                     /* -mfix-r4400 */
  OPT_mfix_rm7000 = 1168,                    /* -mfix-rm7000 */
  OPT_mfix_sb1 = 1169,                       /* -mfix-sb1 */
  OPT_mfix_vr4120 = 1170,                    /* -mfix-vr4120 */
  OPT_mfix_vr4130 = 1171,                    /* -mfix-vr4130 */
  OPT_mfix4300 = 1172,                       /* -mfix4300 */
  OPT_mflip_mips16 = 1173,                   /* -mflip-mips16 */
  OPT_mflush_func_ = 1174,                   /* -mflush-func= */
  OPT_mfp_exceptions = 1175,                 /* -mfp-exceptions */
  OPT_mfp32 = 1176,                          /* -mfp32 */
  OPT_mfp64 = 1177,                          /* -mfp64 */
  OPT_mfpxx = 1178,                          /* -mfpxx */
  OPT_mfused_madd = 1179,                    /* -mfused-madd */
  OPT_mfusion = 1180,                        /* -mfusion */
  OPT_mglibc = 1181,                         /* -mglibc */
  OPT_mgp32 = 1182,                          /* -mgp32 */
  OPT_mgp64 = 1183,                          /* -mgp64 */
  OPT_mgpopt = 1184,                         /* -mgpopt */
  OPT_mhard_float = 1185,                    /* -mhard-float */
  OPT_mimadd = 1186,                         /* -mimadd */
  OPT_minterlink_compressed = 1187,          /* -minterlink-compressed */
  OPT_minterlink_mips16 = 1188,              /* -minterlink-mips16 */
  OPT_mips = 1189,                           /* -mips */
  OPT_mips16 = 1190,                         /* -mips16 */
  OPT_mips3d = 1191,                         /* -mips3d */
  OPT_mllsc = 1192,                          /* -mllsc */
  OPT_mlocal_sdata = 1193,                   /* -mlocal-sdata */
  OPT_mlong_calls = 1194,                    /* -mlong-calls */
  OPT_mlong32 = 1195,                        /* -mlong32 */
  OPT_mlong64 = 1196,                        /* -mlong64 */
  OPT_mlra = 1197,                           /* -mlra */
  OPT_mmad = 1198,                           /* -mmad */
  OPT_mmcount_ra_address = 1199,             /* -mmcount-ra-address */
  OPT_mmcu = 1200,                           /* -mmcu */
  OPT_mmemcpy = 1201,                        /* -mmemcpy */
  OPT_mmicromips = 1202,                     /* -mmicromips */
  OPT_mmsa = 1203,                           /* -mmsa */
  OPT_mmt = 1204,                            /* -mmt */
  OPT_mmxu = 1205,                           /* -mmxu */
  OPT_mmxu2 = 1206,                          /* -mmxu2 */
  OPT_mnan_ = 1207,                          /* -mnan= */
  OPT_mno_float = 1208,                      /* -mno-float */
  OPT_mno_flush_func = 1209,                 /* -mno-flush-func */
  OPT_mno_mdmx = 1210,                       /* -mno-mdmx */
  OPT_mno_mips16 = 1211,                     /* -mno-mips16 */
  OPT_mno_mips3d = 1212,                     /* -mno-mips3d */
  OPT_modd_spreg = 1213,                     /* -modd-spreg */
  OPT_mpaired_single = 1214,                 /* -mpaired-single */
  OPT_mplt = 1215,                           /* -mplt */
  OPT_mr10k_cache_barrier_ = 1216,           /* -mr10k-cache-barrier= */
  OPT_mrelax_pic_calls = 1217,               /* -mrelax-pic-calls */
  OPT_mshared = 1218,                        /* -mshared */
  OPT_msingle_float = 1219,                  /* -msingle-float */
  OPT_mslsa = 1220,                          /* -mslsa */
  OPT_msmartmips = 1221,                     /* -msmartmips */
  OPT_msoft_float = 1222,                    /* -msoft-float */
  OPT_msplit_addresses = 1223,               /* -msplit-addresses */
  OPT_msym32 = 1224,                         /* -msym32 */
  OPT_msynci = 1225,                         /* -msynci */
  OPT_mtune_ = 1226,                         /* -mtune= */
  OPT_muclibc = 1227,                        /* -muclibc */
