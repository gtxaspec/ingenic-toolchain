...
#define HAVE_CCmode
  CCV2mode,                /* config/mips/mips-modes.def:62 */
#define HAVE_CCV2mode
  CCV4mode,                /* config/mips/mips-modes.def:66 */
#define HAVE_CCV4mode
  CCDSPmode,               /* config/mips/mips-modes.def:71 */
#define HAVE_CCDSPmode
  CCFmode,                 /* config/mips/mips-modes.def:74 */
#define HAVE_CCFmode
...
#define HAVE_TImode
  OImode,                  /* config/mips/mips-modes.def:40 */
#define HAVE_OImode
  XImode,                  /* config/mips/mips-modes.def:41 */
#define HAVE_XImode
...
#define HAVE_V2HImode
  V1SImode,                /* config/mips/mips-modes.def:59 */
...
#define HAVE_V4DImode
  V2TImode,                /* config/mips/mips-modes.def:44 */
#define HAVE_V2TImode
  V64QImode,               /* config/mips/mips-modes.def:42 */
#define HAVE_V64QImode
  V32HImode,               /* config/mips/mips-modes.def:42 */
#define HAVE_V32HImode
  V16SImode,               /* config/mips/mips-modes.def:42 */
#define HAVE_V16SImode
  V8DImode,                /* config/mips/mips-modes.def:42 */
#define HAVE_V8DImode
  V4TImode,                /* config/mips/mips-modes.def:42 */
#define HAVE_V4TImode
  V2OImode,                /* config/mips/mips-modes.def:42 */
#define HAVE_V2OImode
  V128QImode,              /* config/mips/mips-modes.def:47 */
#define HAVE_V128QImode
  V64HImode,               /* config/mips/mips-modes.def:48 */
#define HAVE_V64HImode
  V32SImode,               /* config/mips/mips-modes.def:49 */
#define HAVE_V32SImode
  V16DImode,               /* config/mips/mips-modes.def:50 */
#define HAVE_V16DImode
  V8TImode,                /* config/mips/mips-modes.def:51 */
#define HAVE_V8TImode
  V4QQmode,                /* config/mips/mips-modes.def:53 */
#define HAVE_V4QQmode
  V2HQmode,                /* config/mips/mips-modes.def:53 */
#define HAVE_V2HQmode
  V4UQQmode,               /* config/mips/mips-modes.def:54 */
#define HAVE_V4UQQmode
  V2UHQmode,               /* config/mips/mips-modes.def:54 */
#define HAVE_V2UHQmode
  V2HAmode,                /* config/mips/mips-modes.def:55 */
#define HAVE_V2HAmode
  V2UHAmode,               /* config/mips/mips-modes.def:56 */
...
#define HAVE_V4DFmode
  V16SFmode,               /* config/mips/mips-modes.def:43 */
#define HAVE_V16SFmode
  V8DFmode,                /* config/mips/mips-modes.def:43 */
#define HAVE_V8DFmode
  V4TFmode,                /* config/mips/mips-modes.def:43 */
