...
extern void mips_split_512bit_move (rtx, rtx);
extern bool mips_split_128bit_move_p (rtx, rtx);
extern bool mips_split_512bit_move_p (rtx, rtx);
extern bool mips_mxu3_fix_bug_for_a1_split_p (rtx_insn *);
extern bool mips_mxu3_1bit_select_p (rtx, machine_mode);
extern bool mips_mxu3_ls_peephole2_p (int *, rtx **, rtx **, rtx **, rtx *, machine_mode, int);
...
extern bool mips_gpr_save_operation_p (rtx op);
