...
#define __KERNEL_HEADERS__ "/project/Mips-Toolchain/release_3.x.x-gcc5.4.0/install/opt/codesourcery/mips-linux-gnu/libc/uclibc/usr/include"
...
#define __CROSS_COMPILER_PREFIX__ "/project/Mips-Toolchain/release_3.x.x-gcc5.4.0/install/opt/codesourcery/bin/mips-linux-gnu-"
