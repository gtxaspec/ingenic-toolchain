...
enum opt_code
{
  ...
  OPT_mbranch_cost_ = 1144,                  /* -mbranch-cost= */
  OPT_mbranch_likely = 1145,                 /* -mbranch-likely */
  OPT_mcheck_zero_division = 1146,           /* -mcheck-zero-division */
  OPT_mcode_readable_ = 1147,                /* -mcode-readable= */
  /* OPT_mcode_xonly = 1148, */              /* -mcode-xonly */
  ...
  OPT_mmt = 1202,                            /* -mmt */
  OPT_mmxu = 1203,                           /* -mmxu */
  OPT_mmxu2 = 1204,                          /* -mmxu2 */
  OPT_mnan_ = 1205,                          /* -mnan= */
  /* OPT_mno_data_in_code = 1206, */         /* -mno-data-in-code */
  ...
  OPT_muninit_const_in_rodata = 1226,        /* -muninit-const-in-rodata */
  OPT_mvirt = 1227,                          /* -mvirt */
  OPT_mvr4130_align = 1228,                  /* -mvr4130-align */
  OPT_mxgot = 1229,                          /* -mxgot */
  OPT_mxpa = 1230,                           /* -mxpa */
  OPT_n = 1231,                              /* -n */
  OPT_nc = 1232,                             /* -nc */
  ...
  OPT_time = 1325,                           /* -time */
  OPT_time_ = 1326,                          /* -time= */
  OPT_traditional = 1327,                    /* -traditional */
  OPT_traditional_cpp = 1328,                /* -traditional-cpp */
  OPT_trigraphs = 1329,                      /* -trigraphs */
  OPT_u = 1330,                              /* -u */
  OPT_undef = 1331,                          /* -undef */
  OPT_v = 1332,                              /* -v */
  OPT_version = 1333,                        /* -version */
  OPT_w = 1334,                              /* -w */
  OPT_wrapper = 1335,                        /* -wrapper */
  OPT_x = 1336,                              /* -x */
  OPT_z = 1337,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
