...
enum opt_code
{
  ...
  OPT_mmxu3 = 1226,                          /* -mmxu3 */
  OPT_mmxu3_ext_abi = 1227,                  /* -mmxu3-ext-abi */
  OPT_mmxu3_1 = 1228,                        /* -mmxu3.1 */
  OPT_mnan_ = 1229,                          /* -mnan= */
  OPT_mno_float = 1230,                      /* -mno-float */
  OPT_mno_flush_func = 1231,                 /* -mno-flush-func */
  OPT_mno_mdmx = 1232,                       /* -mno-mdmx */
  OPT_mno_mips16 = 1233,                     /* -mno-mips16 */
  OPT_mno_mips3d = 1234,                     /* -mno-mips3d */
  OPT_modd_spreg = 1235,                     /* -modd-spreg */
  OPT_mpaired_single = 1236,                 /* -mpaired-single */
  OPT_mplt = 1237,                           /* -mplt */
  OPT_mr10k_cache_barrier_ = 1238,           /* -mr10k-cache-barrier= */
  OPT_mrelax_pic_calls = 1239,               /* -mrelax-pic-calls */
  OPT_msave_restore_ = 1240,                 /* -msave-restore= */
  OPT_mshared = 1241,                        /* -mshared */
  OPT_msingle_float = 1242,                  /* -msingle-float */
  OPT_mslsa = 1243,                          /* -mslsa */
  OPT_msmartmips = 1244,                     /* -msmartmips */
  OPT_msoft_float = 1245,                    /* -msoft-float */
  OPT_msplit_addresses = 1246,               /* -msplit-addresses */
  OPT_msym32 = 1247,                         /* -msym32 */
  OPT_msynci = 1248,                         /* -msynci */
  OPT_mtune_ = 1249,                         /* -mtune= */
  OPT_muclibc = 1250,                        /* -muclibc */
  OPT_muninit_const_in_rodata = 1251,        /* -muninit-const-in-rodata */
  OPT_mvirt = 1252,                          /* -mvirt */
  OPT_mvr4130_align = 1253,                  /* -mvr4130-align */
  OPT_mxgot = 1254,                          /* -mxgot */
  OPT_mxpa = 1255,                           /* -mxpa */
  OPT_n = 1256,                              /* -n */
  OPT_no_canonical_prefixes = 1257,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1258,              /* -no-integrated-cpp */
  OPT_no_pie = 1259,                         /* -no-pie */
  OPT_noasmopt = 1260,                       /* -noasmopt */
  OPT_nocpp = 1261,                          /* -nocpp */
  OPT_nodefaultlibs = 1262,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1263,                   /* -nostartfiles */
  OPT_nostdinc = 1264,                       /* -nostdinc */
  OPT_nostdinc__ = 1265,                     /* -nostdinc++ */
  OPT_nostdlib = 1266,                       /* -nostdlib */
  OPT_o = 1267,                              /* -o */
  OPT_p = 1268,                              /* -p */
  OPT_pass_exit_codes = 1269,                /* -pass-exit-codes */
  /* OPT_pedantic = 1270, */                 /* -pedantic */
  OPT_pedantic_errors = 1271,                /* -pedantic-errors */
  OPT_pg = 1272,                             /* -pg */
  OPT_pie = 1273,                            /* -pie */
  OPT_pipe = 1274,                           /* -pipe */
  OPT_posix = 1275,                          /* -posix */
  OPT_print_file_name_ = 1276,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1277,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1278,          /* -print-multi-directory */
  OPT_print_multi_lib = 1279,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1280,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1281,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1282,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1283,               /* -print-prog-name= */
  OPT_print_search_dirs = 1284,              /* -print-search-dirs */
  OPT_print_sysroot = 1285,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1286,   /* -print-sysroot-headers-suffix */
  OPT_profile = 1287,                        /* -profile */
  OPT_pthread = 1288,                        /* -pthread */
  OPT_quiet = 1289,                          /* -quiet */
  OPT_r = 1290,                              /* -r */
  OPT_rdynamic = 1291,                       /* -rdynamic */
  OPT_remap = 1292,                          /* -remap */
  OPT_s = 1293,                              /* -s */
  OPT_save_temps = 1294,                     /* -save-temps */
  OPT_save_temps_ = 1295,                    /* -save-temps= */
  OPT_shared = 1296,                         /* -shared */
  OPT_shared_libgcc = 1297,                  /* -shared-libgcc */
  /* OPT_specs = 1298, */                    /* -specs */
  OPT_specs_ = 1299,                         /* -specs= */
  OPT_static = 1300,                         /* -static */
  OPT_static_libasan = 1301,                 /* -static-libasan */
  OPT_static_libgcc = 1302,                  /* -static-libgcc */
  OPT_static_libgfortran = 1303,             /* -static-libgfortran */
  OPT_static_libgo = 1304,                   /* -static-libgo */
  OPT_static_liblsan = 1305,                 /* -static-liblsan */
  OPT_static_libmpx = 1306,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1307,          /* -static-libmpxwrappers */
  OPT_static_libstdc__ = 1308,               /* -static-libstdc++ */
  OPT_static_libtsan = 1309,                 /* -static-libtsan */
  OPT_static_libubsan = 1310,                /* -static-libubsan */
  /* OPT_std_c__03 = 1311, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1312, */                /* -std=c++0x */
  OPT_std_c__11 = 1313,                      /* -std=c++11 */
  OPT_std_c__14 = 1314,                      /* -std=c++14 */
  /* OPT_std_c__17 = 1315, */                /* -std=c++17 */
  /* OPT_std_c__1y = 1316, */                /* -std=c++1y */
  OPT_std_c__1z = 1317,                      /* -std=c++1z */
  OPT_std_c__98 = 1318,                      /* -std=c++98 */
  OPT_std_c11 = 1319,                        /* -std=c11 */
  /* OPT_std_c1x = 1320, */                  /* -std=c1x */
  /* OPT_std_c89 = 1321, */                  /* -std=c89 */
  OPT_std_c90 = 1322,                        /* -std=c90 */
  OPT_std_c99 = 1323,                        /* -std=c99 */
  /* OPT_std_c9x = 1324, */                  /* -std=c9x */
  OPT_std_f2003 = 1325,                      /* -std=f2003 */
  OPT_std_f2008 = 1326,                      /* -std=f2008 */
  OPT_std_f2008ts = 1327,                    /* -std=f2008ts */
  OPT_std_f95 = 1328,                        /* -std=f95 */
  OPT_std_gnu = 1329,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1330, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1331, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1332,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1333,                    /* -std=gnu++14 */
  /* OPT_std_gnu__17 = 1334, */              /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1335, */              /* -std=gnu++1y */
  OPT_std_gnu__1z = 1336,                    /* -std=gnu++1z */
  OPT_std_gnu__98 = 1337,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1338,                      /* -std=gnu11 */
  ...
  OPT_std_legacy = 1349,                     /* -std=legacy */
  OPT_symbolic = 1350,                       /* -symbolic */
  OPT_t = 1351,                              /* -t */
  OPT_time = 1352,                           /* -time */
  OPT_time_ = 1353,                          /* -time= */
  OPT_tno_android_cc = 1354,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1355,                 /* -tno-android-ld */
