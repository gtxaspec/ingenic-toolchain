...
OUTPUT_ARCH(mips)
ENTRY(__start)
SEARCH_DIR("=/home/users/ylli/work/mips-gnu-toolchain-v2.0/install_xburst1_linux/mipsel-linux-gnu/lib"); SEARCH_DIR("=/usr/local/lib"); SEARCH_DIR("=/lib"); SEARCH_DIR("=/usr/lib");
SECTIONS
{
