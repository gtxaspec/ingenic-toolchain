...
#define HAVE_vec_initv2dfdf (ISA_HAS_MSA || ISA_HAS_MXU2)
#define HAVE_vec_initv4sfsf (ISA_HAS_MSA || ISA_HAS_MXU2)
#define HAVE_vec_initv2didi (ISA_HAS_MSA || ISA_HAS_MXU2)
#define HAVE_vec_initv4sisi (ISA_HAS_MSA || ISA_HAS_MXU2)
#define HAVE_vec_initv8hihi (ISA_HAS_MSA || ISA_HAS_MXU2)
#define HAVE_vec_initv16qiqi (ISA_HAS_MSA || ISA_HAS_MXU2)
...
#define HAVE_vec_extractv2didi (ISA_HAS_MSA || ISA_HAS_MXU2)
#define HAVE_vec_extractv4sisi (ISA_HAS_MSA || ISA_HAS_MXU2)
#define HAVE_vec_extractv8hihi (ISA_HAS_MSA || ISA_HAS_MXU2)
#define HAVE_vec_extractv16qiqi (ISA_HAS_MSA || ISA_HAS_MXU2)
#define HAVE_vec_extractv2dfdf (ISA_HAS_MSA || ISA_HAS_MXU2 )
#define HAVE_vec_extractv4sfsf (ISA_HAS_MSA || ISA_HAS_MXU2 )
