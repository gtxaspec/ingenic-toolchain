...
#define HAVE_ATTR_lat_type 1
extern enum attr_lat_type get_attr_lat_type (rtx_insn *);

#define HAVE_ATTR_mxu2_execunit 1
extern enum attr_mxu2_execunit get_attr_mxu2_execunit (rtx_insn *);
