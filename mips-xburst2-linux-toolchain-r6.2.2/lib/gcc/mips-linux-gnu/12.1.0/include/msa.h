...
/* mxa */
#define __msa_fcmul_w __builtin_mxa_fcmul_w
#define __msa_fexuplc_w __builtin_mxa_fexuplc_w
#define __msa_fexuprc_w __builtin_mxa_fexuprc_w
#define __msa_ldinss_w __builtin_mxa_ldinss_w
#define __msa_ldins_w __builtin_mxa_ldins_w
#define __msa_ldins_d __builtin_mxa_ldins_d
#define __msa_stext_w __builtin_mxa_stext_w
#define __msa_stext_d __builtin_mxa_stext_d
#define __msa_vshfr_b __builtin_mxa_vshfr_b
#define __msa_vsldi_b __builtin_mxa_vsldi_b
#define __msa_bmr_v __builtin_mxa_bmr_v
#define __msa_pcnt_v __builtin_mxa_pcnt_v
#define __msa_bext_b __builtin_mxa_bext_b
#define __msa_bext_h __builtin_mxa_bext_h
#define __msa_bext_w __builtin_mxa_bext_w
#define __msa_bexp_b __builtin_mxa_bexp_b
#define __msa_bexp_h __builtin_mxa_bexp_h
#define __msa_bexp_w __builtin_mxa_bexp_w
#define __msa_bexp_2b __builtin_mxa_bexp_2b
#define __msa_bexp_4b __builtin_mxa_bexp_4b
#define __msa_bmu_v __builtin_mxa_bmu_v
#define __msa_sll_v __builtin_mxa_sll_v
#define __msa_slli_v __builtin_mxa_slli_v
#define __msa_srl_v __builtin_mxa_srl_v
#define __msa_srli_v __builtin_mxa_srli_v
#define __msa_move_w __builtin_mxa_move_w
#define __msa_movbt_b __builtin_mxa_movbt_b
#define __msa_movbp_b __builtin_mxa_movbp_b
#define __msa_satss_b __builtin_mxa_satss_b
#define __msa_satss_h __builtin_mxa_satss_h
#define __msa_satuu_b __builtin_mxa_satuu_b
#define __msa_satuu_h __builtin_mxa_satuu_h
#define __msa_satus_b __builtin_mxa_satus_b
#define __msa_satus_h __builtin_mxa_satus_h
#define __msa_addsl_h __builtin_mxa_addsl_h
#define __msa_addsl_w __builtin_mxa_addsl_w
#define __msa_addsr_h __builtin_mxa_addsr_h
#define __msa_addsr_w __builtin_mxa_addsr_w
#define __msa_addul_h __builtin_mxa_addul_h
#define __msa_addul_w __builtin_mxa_addul_w
#define __msa_addur_h __builtin_mxa_addur_h
#define __msa_addur_w __builtin_mxa_addur_w
#define __msa_accsl_h __builtin_mxa_accsl_h
#define __msa_accsl_w __builtin_mxa_accsl_w
#define __msa_accsr_h __builtin_mxa_accsr_h
#define __msa_accsr_w __builtin_mxa_accsr_w
#define __msa_accul_h __builtin_mxa_accul_h
#define __msa_accul_w __builtin_mxa_accul_w
#define __msa_accur_h __builtin_mxa_accur_h
#define __msa_accur_w __builtin_mxa_accur_w
#define __msa_subsl_h __builtin_mxa_subsl_h
#define __msa_subsl_w __builtin_mxa_subsl_w
#define __msa_subsr_h __builtin_mxa_subsr_h
#define __msa_subsr_w __builtin_mxa_subsr_w
#define __msa_subul_h __builtin_mxa_subul_h
#define __msa_subul_w __builtin_mxa_subul_w
#define __msa_subur_h __builtin_mxa_subur_h
#define __msa_subur_w __builtin_mxa_subur_w
#define __msa_mulsl_h __builtin_mxa_mulsl_h
#define __msa_mulsl_w __builtin_mxa_mulsl_w
#define __msa_mulsr_h __builtin_mxa_mulsr_h
#define __msa_mulsr_w __builtin_mxa_mulsr_w
#define __msa_mulul_h __builtin_mxa_mulul_h
#define __msa_mulul_w __builtin_mxa_mulul_w
#define __msa_mulur_h __builtin_mxa_mulur_h
#define __msa_mulur_w __builtin_mxa_mulur_w
#define __msa_cast_to_vector_float __builtin_mxa_cast_to_vector_float
#define __msa_cast_to_vector_double __builtin_mxa_cast_to_vector_double
#define __msa_cast_to_scalar_float __builtin_mxa_cast_to_scalar_float
#define __msa_cast_to_scalar_double __builtin_mxa_cast_to_scalar_double

#define __builtin_msa_fcmul_w __builtin_mxa_fcmul_w
#define __builtin_msa_fexuplc_w __builtin_mxa_fexuplc_w
#define __builtin_msa_fexuprc_w __builtin_mxa_fexuprc_w
#define __builtin_msa_ldinss_w __builtin_mxa_ldinss_w
#define __builtin_msa_ldins_w __builtin_mxa_ldins_w
#define __builtin_msa_ldins_d __builtin_mxa_ldins_d
#define __builtin_msa_stext_w __builtin_mxa_stext_w
#define __builtin_msa_stext_d __builtin_mxa_stext_d
#define __builtin_msa_vshfr_b __builtin_mxa_vshfr_b
#define __builtin_msa_vsldi_b __builtin_mxa_vsldi_b
#define __builtin_msa_bmr_v __builtin_mxa_bmr_v
#define __builtin_msa_pcnt_v __builtin_mxa_pcnt_v
#define __builtin_msa_bext_b __builtin_mxa_bext_b
#define __builtin_msa_bext_h __builtin_mxa_bext_h
#define __builtin_msa_bext_w __builtin_mxa_bext_w
#define __builtin_msa_bexp_b __builtin_mxa_bexp_b
#define __builtin_msa_bexp_h __builtin_mxa_bexp_h
#define __builtin_msa_bexp_w __builtin_mxa_bexp_w
#define __builtin_msa_bexp_2b __builtin_mxa_bexp_2b
#define __builtin_msa_bexp_4b __builtin_mxa_bexp_4b
#define __builtin_msa_bmu_v __builtin_mxa_bmu_v
#define __builtin_msa_sll_v __builtin_mxa_sll_v
#define __builtin_msa_slli_v __builtin_mxa_slli_v
#define __builtin_msa_srl_v __builtin_mxa_srl_v
#define __builtin_msa_srli_v __builtin_mxa_srli_v
#define __builtin_msa_move_w __builtin_mxa_move_w
#define __builtin_msa_movbt_b __builtin_mxa_movbt_b
#define __builtin_msa_movbp_b __builtin_mxa_movbp_b
#define __builtin_msa_satss_b __builtin_mxa_satss_b
#define __builtin_msa_satss_h __builtin_mxa_satss_h
#define __builtin_msa_satuu_b __builtin_mxa_satuu_b
#define __builtin_msa_satuu_h __builtin_mxa_satuu_h
#define __builtin_msa_satus_b __builtin_mxa_satus_b
#define __builtin_msa_satus_h __builtin_mxa_satus_h
#define __builtin_msa_addsl_h __builtin_mxa_addsl_h
#define __builtin_msa_addsl_w __builtin_mxa_addsl_w
#define __builtin_msa_addsr_h __builtin_mxa_addsr_h
#define __builtin_msa_addsr_w __builtin_mxa_addsr_w
#define __builtin_msa_addul_h __builtin_mxa_addul_h
#define __builtin_msa_addul_w __builtin_mxa_addul_w
#define __builtin_msa_addur_h __builtin_mxa_addur_h
#define __builtin_msa_addur_w __builtin_mxa_addur_w
#define __builtin_msa_accsl_h __builtin_mxa_accsl_h
#define __builtin_msa_accsl_w __builtin_mxa_accsl_w
#define __builtin_msa_accsr_h __builtin_mxa_accsr_h
#define __builtin_msa_accsr_w __builtin_mxa_accsr_w
#define __builtin_msa_accul_h __builtin_mxa_accul_h
#define __builtin_msa_accul_w __builtin_mxa_accul_w
#define __builtin_msa_accur_h __builtin_mxa_accur_h
#define __builtin_msa_accur_w __builtin_mxa_accur_w
#define __builtin_msa_subsl_h __builtin_mxa_subsl_h
#define __builtin_msa_subsl_w __builtin_mxa_subsl_w
#define __builtin_msa_subsr_h __builtin_mxa_subsr_h
#define __builtin_msa_subsr_w __builtin_mxa_subsr_w
#define __builtin_msa_subul_h __builtin_mxa_subul_h
#define __builtin_msa_subul_w __builtin_mxa_subul_w
#define __builtin_msa_subur_h __builtin_mxa_subur_h
#define __builtin_msa_subur_w __builtin_mxa_subur_w
#define __builtin_msa_mulsl_h __builtin_mxa_mulsl_h
#define __builtin_msa_mulsl_w __builtin_mxa_mulsl_w
#define __builtin_msa_mulsr_h __builtin_mxa_mulsr_h
#define __builtin_msa_mulsr_w __builtin_mxa_mulsr_w
#define __builtin_msa_mulul_h __builtin_mxa_mulul_h
#define __builtin_msa_mulul_w __builtin_mxa_mulul_w
#define __builtin_msa_mulur_h __builtin_mxa_mulur_h
#define __builtin_msa_mulur_w __builtin_mxa_mulur_w
