...
#endif
#ifdef GENERATOR_FILE
extern int TARGET_MXU3;
#else
  int x_TARGET_MXU3;
#define TARGET_MXU3 global_options.x_TARGET_MXU3
#endif
#ifdef GENERATOR_FILE
extern int TARGET_MXU3_EXT_ABI;
#else
  int x_TARGET_MXU3_EXT_ABI;
#define TARGET_MXU3_EXT_ABI global_options.x_TARGET_MXU3_EXT_ABI
#endif
#ifdef GENERATOR_FILE
extern int TARGET_MXU3_1;
#else
  int x_TARGET_MXU3_1;
#define TARGET_MXU3_1 global_options.x_TARGET_MXU3_1
#endif
#ifdef GENERATOR_FILE
extern int mips_nan;
#else
...
#define MASK_MXA (1U << 24)
#define MASK_ODD_SPREG (1U << 25)
#define MASK_PAIRED_SINGLE_FLOAT (1U << 26)
#define MASK_RELAX_PIC_CALLS (1U << 27)
#define MASK_SMARTMIPS (1U << 28)
#define MASK_SPLIT_ADDRESSES (1U << 29)
#define MASK_SYNCI (1U << 30)
#define MASK_VR4130_ALIGN (1U << 31)
...
/* MXA mask */
#define TARGET_MXA ((target_flags & MASK_MXA) != 0)
#define TARGET_MXA_P(target_flags) (((target_flags) & MASK_MXA) != 0)
#define TARGET_EXPLICIT_MXA_P(opts) ((opts->x_target_flags_explicit & MASK_MXA) != 0)
#define SET_TARGET_MXA(opts) opts->x_target_flags |= MASK_MXA
/* ODD_SPREG mask */
...
enum opt_code
{
  ...
  OPT_mabs_ = 1769,                          /* -mabs= */
  OPT_mandroid = 1770,                       /* -mandroid */
  OPT_march_ = 1771,                         /* -march= */
  OPT_mbionic = 1772,                        /* -mbionic */
  OPT_mbranch_cost_ = 1773,                  /* -mbranch-cost= */
  OPT_mbranch_likely = 1774,                 /* -mbranch-likely */
  OPT_mcheck_zero_division = 1775,           /* -mcheck-zero-division */
  OPT_mcode_readable_ = 1776,                /* -mcode-readable= */
  OPT_mcompact_branches_ = 1777,             /* -mcompact-branches= */
  OPT_mcrc = 1778,                           /* -mcrc */
  OPT_mdebug = 1779,                         /* -mdebug */
  OPT_mdebugd = 1780,                        /* -mdebugd */
  OPT_mdivide_breaks = 1781,                 /* -mdivide-breaks */
  OPT_mdivide_traps = 1782,                  /* -mdivide-traps */
  OPT_mdmx = 1783,                           /* -mdmx */
  OPT_mdouble_float = 1784,                  /* -mdouble-float */
  OPT_mdsp = 1785,                           /* -mdsp */
  OPT_mdspr2 = 1786,                         /* -mdspr2 */
  OPT_meb = 1787,                            /* -meb */
  OPT_mel = 1788,                            /* -mel */
  OPT_membedded_data = 1789,                 /* -membedded-data */
  OPT_meva = 1790,                           /* -meva */
  OPT_mexplicit_relocs = 1791,               /* -mexplicit-relocs */
  OPT_mextern_sdata = 1792,                  /* -mextern-sdata */
  OPT_mfix_24k = 1793,                       /* -mfix-24k */
  OPT_mfix_r10000 = 1794,                    /* -mfix-r10000 */
  OPT_mfix_r4000 = 1795,                     /* -mfix-r4000 */
  OPT_mfix_r4400 = 1796,                     /* -mfix-r4400 */
  OPT_mfix_r5900 = 1797,                     /* -mfix-r5900 */
  OPT_mfix_rm7000 = 1798,                    /* -mfix-rm7000 */
  OPT_mfix_sb1 = 1799,                       /* -mfix-sb1 */
  OPT_mfix_vr4120 = 1800,                    /* -mfix-vr4120 */
  OPT_mfix_vr4130 = 1801,                    /* -mfix-vr4130 */
  OPT_mfix4300 = 1802,                       /* -mfix4300 */
  OPT_mflip_mips16 = 1803,                   /* -mflip-mips16 */
  OPT_mflush_func_ = 1804,                   /* -mflush-func= */
  OPT_mfp_exceptions = 1805,                 /* -mfp-exceptions */
  OPT_mfp32 = 1806,                          /* -mfp32 */
  OPT_mfp64 = 1807,                          /* -mfp64 */
  OPT_mfpxx = 1808,                          /* -mfpxx */
  OPT_mframe_header_opt = 1809,              /* -mframe-header-opt */
  /* OPT_mfused_madd = 1810, */              /* -mfused-madd */
  OPT_mginv = 1811,                          /* -mginv */
  OPT_mglibc = 1812,                         /* -mglibc */
  OPT_mgp32 = 1813,                          /* -mgp32 */
  OPT_mgp64 = 1814,                          /* -mgp64 */
  OPT_mgpopt = 1815,                         /* -mgpopt */
  OPT_mhard_float = 1816,                    /* -mhard-float */
  OPT_mimadd = 1817,                         /* -mimadd */
  OPT_minterlink_compressed = 1818,          /* -minterlink-compressed */
  OPT_minterlink_mips16 = 1819,              /* -minterlink-mips16 */
  OPT_mips = 1820,                           /* -mips */
  OPT_mips16 = 1821,                         /* -mips16 */
  OPT_mips3d = 1822,                         /* -mips3d */
  OPT_mllsc = 1823,                          /* -mllsc */
  OPT_mload_store_pairs = 1824,              /* -mload-store-pairs */
  OPT_mlocal_sdata = 1825,                   /* -mlocal-sdata */
  OPT_mlong_calls = 1826,                    /* -mlong-calls */
  OPT_mlong32 = 1827,                        /* -mlong32 */
  OPT_mlong64 = 1828,                        /* -mlong64 */
  OPT_mloongson_ext = 1829,                  /* -mloongson-ext */
  OPT_mloongson_ext2 = 1830,                 /* -mloongson-ext2 */
  OPT_mloongson_mmi = 1831,                  /* -mloongson-mmi */
  OPT_mlra = 1832,                           /* -mlra */
  OPT_mlxc1_sxc1 = 1833,                     /* -mlxc1-sxc1 */
  OPT_mmad = 1834,                           /* -mmad */
  OPT_mmadd4 = 1835,                         /* -mmadd4 */
  OPT_mmcount_ra_address = 1836,             /* -mmcount-ra-address */
  OPT_mmcu = 1837,                           /* -mmcu */
  OPT_mmemcpy = 1838,                        /* -mmemcpy */
  OPT_mmicromips = 1839,                     /* -mmicromips */
  OPT_mmsa = 1840,                           /* -mmsa */
  OPT_mmt = 1841,                            /* -mmt */
  OPT_mmusl = 1842,                          /* -mmusl */
  OPT_mmxa = 1843,                           /* -mmxa */
  OPT_mmxu3 = 1844,                          /* -mmxu3 */
  OPT_mmxu3_ext_abi = 1845,                  /* -mmxu3-ext-abi */
  OPT_mmxu3_1 = 1846,                        /* -mmxu3.1 */
  OPT_mnan_ = 1847,                          /* -mnan= */
  OPT_mno_float = 1848,                      /* -mno-float */
  OPT_mno_flush_func = 1849,                 /* -mno-flush-func */
  OPT_mno_mdmx = 1850,                       /* -mno-mdmx */
  OPT_mno_mips16 = 1851,                     /* -mno-mips16 */
  OPT_mno_mips3d = 1852,                     /* -mno-mips3d */
  OPT_modd_spreg = 1853,                     /* -modd-spreg */
  OPT_mpaired_single = 1854,                 /* -mpaired-single */
  OPT_mplt = 1855,                           /* -mplt */
  OPT_mr10k_cache_barrier_ = 1856,           /* -mr10k-cache-barrier= */
  OPT_mrelax_pic_calls = 1857,               /* -mrelax-pic-calls */
  OPT_mshared = 1858,                        /* -mshared */
  OPT_msingle_float = 1859,                  /* -msingle-float */
  OPT_msmartmips = 1860,                     /* -msmartmips */
  OPT_msoft_float = 1861,                    /* -msoft-float */
  OPT_msplit_addresses = 1862,               /* -msplit-addresses */
  OPT_msym32 = 1863,                         /* -msym32 */
  OPT_msynci = 1864,                         /* -msynci */
  OPT_mtune_ = 1865,                         /* -mtune= */
  OPT_muclibc = 1866,                        /* -muclibc */
  OPT_munaligned_access = 1867,              /* -munaligned-access */
  OPT_muninit_const_in_rodata = 1868,        /* -muninit-const-in-rodata */
  OPT_mvirt = 1869,                          /* -mvirt */
  OPT_mvr4130_align = 1870,                  /* -mvr4130-align */
  OPT_mxgot = 1871,                          /* -mxgot */
  OPT_mxpa = 1872,                           /* -mxpa */
  OPT_n = 1873,                              /* -n */
  ...
  OPT_noasmopt = 1878,                       /* -noasmopt */
  OPT_nocpp = 1879,                          /* -nocpp */
  OPT_nodefaultlibs = 1880,                  /* -nodefaultlibs */
  OPT_nolibc = 1881,                         /* -nolibc */
  OPT_nophoboslib = 1882,                    /* -nophoboslib */
  OPT_nostartfiles = 1883,                   /* -nostartfiles */
  OPT_nostdinc = 1884,                       /* -nostdinc */
  OPT_nostdinc__ = 1885,                     /* -nostdinc++ */
  OPT_nostdlib = 1886,                       /* -nostdlib */
  OPT_o = 1887,                              /* -o */
  OPT_objects = 1888,                        /* -objects */
  OPT_p = 1889,                              /* -p */
  OPT_pass_exit_codes = 1890,                /* -pass-exit-codes */
  /* OPT_pedantic = 1891, */                 /* -pedantic */
  OPT_pedantic_errors = 1892,                /* -pedantic-errors */
  OPT_pg = 1893,                             /* -pg */
  OPT_pie = 1894,                            /* -pie */
  OPT_pipe = 1895,                           /* -pipe */
  OPT_posix = 1896,                          /* -posix */
  OPT_print_file_name_ = 1897,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1898,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1899,          /* -print-multi-directory */
  OPT_print_multi_lib = 1900,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1901,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1902,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1903,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1904,               /* -print-prog-name= */
  OPT_print_search_dirs = 1905,              /* -print-search-dirs */
  OPT_print_sysroot = 1906,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1907,   /* -print-sysroot-headers-suffix */
  OPT_print_value = 1908,                    /* -print-value */
  OPT_profile = 1909,                        /* -profile */
  OPT_pthread = 1910,                        /* -pthread */
  OPT_quiet = 1911,                          /* -quiet */
  OPT_r = 1912,                              /* -r */
  OPT_rdynamic = 1913,                       /* -rdynamic */
  ...
  OPT_static_libstdc__ = 1935,               /* -static-libstdc++ */
  OPT_static_libtsan = 1936,                 /* -static-libtsan */
  OPT_static_libubsan = 1937,                /* -static-libubsan */
  OPT_static_pie = 1938,                     /* -static-pie */
  /* OPT_std_c__03 = 1939, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1940, */                /* -std=c++0x */
  OPT_std_c__11 = 1941,                      /* -std=c++11 */
  OPT_std_c__14 = 1942,                      /* -std=c++14 */
  OPT_std_c__17 = 1943,                      /* -std=c++17 */
  /* OPT_std_c__1y = 1944, */                /* -std=c++1y */
  /* OPT_std_c__1z = 1945, */                /* -std=c++1z */
  OPT_std_c__20 = 1946,                      /* -std=c++20 */
  OPT_std_c__23 = 1947,                      /* -std=c++23 */
  /* OPT_std_c__2a = 1948, */                /* -std=c++2a */
  /* OPT_std_c__2b = 1949, */                /* -std=c++2b */
  OPT_std_c__98 = 1950,                      /* -std=c++98 */
  OPT_std_c11 = 1951,                        /* -std=c11 */
  OPT_std_c17 = 1952,                        /* -std=c17 */
  /* OPT_std_c18 = 1953, */                  /* -std=c18 */
  /* OPT_std_c1x = 1954, */                  /* -std=c1x */
  OPT_std_c2x = 1955,                        /* -std=c2x */
  /* OPT_std_c89 = 1956, */                  /* -std=c89 */
  OPT_std_c90 = 1957,                        /* -std=c90 */
  OPT_std_c99 = 1958,                        /* -std=c99 */
  /* OPT_std_c9x = 1959, */                  /* -std=c9x */
  OPT_std_f2003 = 1960,                      /* -std=f2003 */
  OPT_std_f2008 = 1961,                      /* -std=f2008 */
  OPT_std_f2008ts = 1962,                    /* -std=f2008ts */
  OPT_std_f2018 = 1963,                      /* -std=f2018 */
  OPT_std_f95 = 1964,                        /* -std=f95 */
  OPT_std_gnu = 1965,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1966, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1967, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1968,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1969,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 1970,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1971, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 1972, */              /* -std=gnu++1z */
  OPT_std_gnu__20 = 1973,                    /* -std=gnu++20 */
  OPT_std_gnu__23 = 1974,                    /* -std=gnu++23 */
  /* OPT_std_gnu__2a = 1975, */              /* -std=gnu++2a */
  /* OPT_std_gnu__2b = 1976, */              /* -std=gnu++2b */
  OPT_std_gnu__98 = 1977,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1978,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1979,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1980, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 1981, */                /* -std=gnu1x */
  OPT_std_gnu2x = 1982,                      /* -std=gnu2x */
  /* OPT_std_gnu89 = 1983, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1984,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1985,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1986, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1987, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1988,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1989, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1990, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1991, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 1992, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 1993, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 1994,                     /* -std=legacy */
  OPT_stdlib_ = 1995,                        /* -stdlib= */
  OPT_symbol_ = 1996,                        /* -symbol= */
  OPT_symbolic = 1997,                       /* -symbolic */
  OPT_t = 1998,                              /* -t */
  OPT_time = 1999,                           /* -time */
  OPT_time_ = 2000,                          /* -time= */
  OPT_tno_android_cc = 2001,                 /* -tno-android-cc */
  OPT_tno_android_ld = 2002,                 /* -tno-android-ld */
  OPT_traditional = 2003,                    /* -traditional */
  OPT_traditional_cpp = 2004,                /* -traditional-cpp */
  OPT_tree_stats = 2005,                     /* -tree-stats */
  OPT_trigraphs = 2006,                      /* -trigraphs */
  OPT_type_stats = 2007,                     /* -type-stats */
  OPT_u = 2008,                              /* -u */
  OPT_undef = 2009,                          /* -undef */
  OPT_v = 2010,                              /* -v */
  OPT_version = 2011,                        /* -version */
  OPT_w = 2012,                              /* -w */
  OPT_wrapper = 2013,                        /* -wrapper */
  OPT_x = 2014,                              /* -x */
  OPT_z = 2015,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
